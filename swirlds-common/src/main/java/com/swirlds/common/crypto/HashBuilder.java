...
public class HashBuilder {
     ...
     * hash the given long
     *
     * @param n the long value to be hashed
     ...
     * hash the given int
     *
     * @param n the int value to be hashed
     ...
     *
     * @param i the Instant object to be hashed
     ...
     *
     * @param t the array of byte arrays to be hashed
     ...
     *
     * @param t the byte arrays to be hashed
     * @return the HashBuilder object after digesting this array
     */
    public HashBuilder update(byte[] t) {
        if (t == null) {
     ...
     *
     * @param hash the Hash object to be hashed
     ...
     *
     * @param data the byte arrays to be hashed
     * @return the HashBuilder object after digesting this array
     */

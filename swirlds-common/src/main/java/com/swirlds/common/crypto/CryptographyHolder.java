 ...
 *
 * @deprecated This class will be removed once the {@link
 *     com.swirlds.common.context.PlatformContext} is used.
 */
...
public final class CryptographyHolder {
    ...
    /**
     * By calling the method the interal {@link Cryptography} instance will be removed and a new
     * instance will be created when {@link #get()} is called the next time.
     */

...
/**
 * Encapsulates an array of bytes to be hashed using a cryptographic message digest. Overloaded
 * constructors are provided to allow a given range of the array to be hashed instead of the entire
 * array.
 */
public class Message implements Comparable<Message> {
     ...
     * @throws NullPointerException if the {@code payload} parameter is null
     */
     ...
     *
     * @param payload the data to be hashed
     * @param digestType the digest algorithm to be used
     * @throws NullPointerException if the {@code payload} parameter is null
     */
     ...
     *
     * @param payload the data to be hashed
     * @param offset the offset in the array from which to begin hashing
     * @throws NullPointerException if the {@code payload} parameter is null
     * @throws ArrayIndexOutOfBoundsException if the {@code offset} parameter is outside the bounds
     *     of the array
     */
     ...
     * @param payload the data to be hashed
     * @param offset the offset in the array from which to begin hashing
     * @param length the length in bytes starting from offset
     * @throws NullPointerException if the {@code payload} parameter is null
     * @throws ArrayIndexOutOfBoundsException if the {@code offset} parameter is outside the bounds
     *     of the array
     * @throws IllegalArgumentException if the {@code length} parameter is less than zero or greater
     *     than {@code payload.length}
     */
     ...
     */
    public Message(
            final byte[] payload, final int offset, final int length, final DigestType digestType) {
        if (payload == null) {
    ...
    /**
     * Internal use accessor that returns a direct (mutable) reference to the message payload. Care
     * must be taken to never modify the array returned by this accessor. Modifying the array will
     * result in undefined behaviors and will result in a violation of the immutability contract
     * provided by the {@link Message} object.
     *
     ...
     * @throws NullPointerException if the {@code future} parameter is null
     */

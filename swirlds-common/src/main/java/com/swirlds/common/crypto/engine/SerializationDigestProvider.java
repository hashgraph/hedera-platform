...
/**
 * A {@link CachingOperationProvider} capable of computing hashes for {@link SelfSerializable}
 * objects by hashing the serialized bytes of the object.
 */
public class SerializationDigestProvider
        extends CachingOperationProvider<
                SelfSerializable, Void, Hash, HashingOutputStream, DigestType> {
    /** {@inheritDoc} */
    @Override

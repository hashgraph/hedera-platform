...
public class Hash implements Comparable<Hash>, SelfSerializable, Serializable {
    ...
    /**
     * Zero arg constructor. Creates a hash without any data using the default digest type ({@link
     * DigestType#SHA_384}).
     */
    public Hash() {
    ...
    /**
     * Instantiate a hash with data from a byte array. Uses the default digest type ({@link
     * DigestType#SHA_384}).
     *
     ...
     *
     * @param byteBuffer a buffer that contains the data for this hash
     * @param digestType the digest type of this hash
     */

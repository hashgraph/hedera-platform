...
/**
 * Provides a generic way to process cryptographic transformations for a given {@link List} of work
 * items in a asynchronous manner on a background thread. This object also serves as the {@link
 ...
 * @param <Provider> the type of the {@link OperationProvider} implementation to be used
 */
public abstract class AsyncOperationHandler<Element, Provider extends OperationProvider>
    ...
    public AsyncOperationHandler(
            final List<Element> workItems, final boolean shouldCopy, final Provider provider) {
        super();
     ...
     *     located or loaded
     */
    protected abstract void handleWorkItem(final Provider provider, final Element item)

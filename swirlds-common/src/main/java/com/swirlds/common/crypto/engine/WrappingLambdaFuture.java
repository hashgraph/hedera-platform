...
/**
 * A lightweight wrapping future implementation that delegates to the inner future. This
 * implementation uses {@link Supplier} to provide the inner future and the final value to be
 * returned.
 *
 * @param <InnerReturnType> the type of object returned by the inner {@link Future}
 * @param <ReturnType> the type of object returned by the {@link #get()} methods
 */
public class WrappingLambdaFuture<ReturnType, InnerReturnType> implements Future<ReturnType> {
     ...
     *
     * @param innerFutureSupplier the supplier of the inner future
     * @param returnTypeSupplier the supplier of the ReturnType
     */
    ...
    /**
     * Populates the {@code innerFuture} field with the minimal amount of synchronization required

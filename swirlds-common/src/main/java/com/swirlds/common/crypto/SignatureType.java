...
public enum SignatureType {
    ...
    /**
     * An Elliptical Curve based signature using the secp256k1 curve (which is not FIPS 186-4
     * compliant)
     */
    ...
    /**
     * The elliptical curve to be used. Only applies to EC algorithms and may be null or an empty
     ...
     *
     * @param id the unique identifier for this algorithm
     * @param signingAlgorithm the JCE signing algorithm name
     * @param keyAlgorithm the JCE key generation algorithm name
     ...
     *
     * @param id the unique identifier to be translated into an enumeration value.
     * @param defaultValue the default enumeration value to return if the {@code ordinal} cannot be
     *     found.
     * @return the enumeration value related to the given ordinal or the default value if the
     *     ordinal is not found.
     */
     ...
     *
     * @return the elliptical curve spec name as required by the {@link
     *     java.security.spec.ECParameterSpec} implementation.
     */

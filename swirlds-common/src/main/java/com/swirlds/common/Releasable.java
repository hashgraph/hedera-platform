...
/**
 * A Releasable object is an object that expects to be deleted when it is done being used. This
 * paradigm is needed when objects manage resources that are not automatically cleaned by the java
 * garbage collector.
 */
public interface Releasable {
     ...
     *
     * @throws ReferenceCountException if this object is destroyed
     */

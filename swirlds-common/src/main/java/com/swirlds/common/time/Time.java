...
/**
 * An API for getting the time. All platform code should utilize this API instead of the raw
 * standard java time APIs. This makes it much easier to simulate time in test environments.
 */
public interface Time {

    /**
     * A method that returns the time in nanoseconds. May not start at the epoch. Equivalent to

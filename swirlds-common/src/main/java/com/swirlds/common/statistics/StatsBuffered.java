 ...
 * contain a {@link StatsBuffer} for recent history and another for all of history. The user can
 * then retrieve them from {@link com.swirlds.common.metrics.Metrics}.
 */

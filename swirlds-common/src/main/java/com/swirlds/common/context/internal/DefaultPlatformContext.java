...
/**
 * Default implementation of the platform context. Warning: this class is private API and will be
 * changed in the future. The {@link PlatformContext} interface should be used all the time to
 * interact with basic services.
 */
public final class DefaultPlatformContext implements PlatformContext {
    ...
    public DefaultPlatformContext(
        ...
        this.metrics =
                CommonUtils.throwArgNull(metricsProvider, "metricsProvider")

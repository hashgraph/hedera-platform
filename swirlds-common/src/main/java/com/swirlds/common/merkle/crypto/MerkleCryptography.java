...
public interface MerkleCryptography {
    ...
    /**
     * Computes a cryptographic hash for the {@link MerkleInternal} instance. The hash is passed to
     * the object by calling {@link Hashable#setHash(Hash)}. Convenience method that defaults to
    ...
    /**
     * Same as {@link Cryptography#digestSync(SerializableHashable, DigestType, boolean)} with
     * setHash set to true
     */
    ...
    /**
     * Computes a cryptographic hash for the {@link MerkleInternal} instance. The hash is passed to
     * the object by calling {@link Hashable#setHash(Hash)} if setHash is true.
     *
     * @param node the MerkleInternal to hash
    ...
    /**
     * Computes a cryptographic hash for the {@link MerkleInternal} instance. Requires a list of
     * child hashes, as it is possible that the MerkleInternal has not yet been given its children.
     * The hash is passed to the object by calling {@link Hashable#setHash(Hash)} if setHash is
     * true.
     *
     * @param node the MerkleInternal to hash
    ...
    /**
     * Computes a cryptographic hash for the {@link MerkleLeaf} instance. The hash is passed to the
     * object by calling {@link Hashable#setHash(Hash)}.
     *
    ...
    /**
     * Computes a cryptographic hash for the {@link MerkleNode} instance. The hash is passed to the
     * object by calling {@link Hashable#setHash(Hash)}.
     *
     ...
     * @param root the root of the tree to hash
     * @param digestType the type of digest used to compute the hash
     * @return the {@link com.swirlds.common.merkle.hash.FutureMerkleHash} for the {@link
     *     MerkleNode} object
     */

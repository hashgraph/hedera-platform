...
/**
 * When the teacher submits a query of "do you have this node", the learner replies with a
 * QueryResponse.
 */
public class QueryResponse implements SelfSerializable {
     ...
     *
     * @param learnerHasTheNode true if this node (the learner) has the given response
     */

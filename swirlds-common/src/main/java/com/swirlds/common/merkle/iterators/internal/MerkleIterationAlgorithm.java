...
public interface MerkleIterationAlgorithm {
     ...
     *
     * @param parent the parent with children to push
     * @param pushNode a method to be used to push children. First argument is the parent, second
     *     argument is the child index.
     */

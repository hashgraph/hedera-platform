...
public interface MaybeCustomReconnectRoot {
    ...
    /**
     * Return true if this node is the root of a subtree that has a custom view for reconnect. Nodes
     * that return true must implement the interface {@link CustomReconnectRoot}.
     *

...
public interface MerkleLeaf extends MerkleNode, SerializableHashable, ExternalSelfSerializable {
    ...
    /** {@inheritDoc} */
    @Override
    default void serialize(final SerializableDataOutputStream out, final Path outputDirectory)
            throws IOException {
        // Default implementation ignores the provided directory. Override this method to utilize
        // the directory.
        serialize(out);
    }

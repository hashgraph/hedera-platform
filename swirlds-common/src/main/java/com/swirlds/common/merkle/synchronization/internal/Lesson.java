...
public class Lesson<T> implements Releasable, SelfSerializable {
     ...
     * @param subLesson the payload of the lesson
     */
     ...
     *
     * @param learnerTreeView the learner's view
     */
    ...
    /**
     * Check if this lesson is about an internal node or a leaf node. Unset if {@link
     * #isCurrentNodeUpToDate()} returns true.
     *
    ...
    /**
     * Get the queries contained within this lesson (i.e. the hashes of the children of an internal
     * node). Will be unset and throw an exception if {@link #hasQueries()} returns false.
     *
    ...
    /**
     * Get the leaf node. Will be unset and throw an exception if {@link #isCurrentNodeUpToDate()}
     * is true or if {@link #isCustomViewRoot()} is true.
     *
    ...
    /**
     * If {@link #isCustomViewRoot()} returns true, this method returns the class ID for the root of
     * the subtree with the custom view.
     *

...
/**
 * Implementing this interface allows for a class to implement the {@link MerkleLeaf} interface
 * using inheritance by composition with minimal boilerplate.
 */
public interface ComposedMerkleLeaf extends MerkleLeaf {

    /**
     * Get an object that implements the {@link PartialMerkleLeaf} interface. This object will be

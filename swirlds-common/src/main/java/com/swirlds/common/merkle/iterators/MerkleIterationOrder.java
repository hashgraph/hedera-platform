...
public enum MerkleIterationOrder {
    /**
     * A depth first traversal where parents are visited after their children (i.e. standard depth
     * first). This is the default iteration order for a {@link MerkleIterator}.
     */
    POST_ORDERED_DEPTH_FIRST,
    /**
     * Similar to {@link #POST_ORDERED_DEPTH_FIRST}, but with order between sibling subtrees
     * randomized.
     */

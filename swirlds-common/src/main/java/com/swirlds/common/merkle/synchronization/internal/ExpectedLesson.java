...
public class ExpectedLesson<T> {
     ...
     *
     * @param parent the eventual parent of the node
     * @param positionInParent the eventual position of the node within its parent
     * @param originalNode the node that was originally in this location in the tree
     * @param nodeAlreadyPresent does the learner already have the node being sent by the teacher?
     */

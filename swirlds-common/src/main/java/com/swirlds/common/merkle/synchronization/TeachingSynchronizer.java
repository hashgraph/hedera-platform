...
public class TeachingSynchronizer {
     ...
     *
     * <p>Although multiple threads may modify this queue, it is still thread safe. This is because
     * only one thread will attempt to read/write this data structure at any time, and when the
     * thread touching the queue changes there is a synchronization point that establishes a happens
     * before relationship.
     */

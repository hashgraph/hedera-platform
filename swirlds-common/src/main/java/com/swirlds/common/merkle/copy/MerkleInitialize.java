...
public final class MerkleInitialize {
     ...
     * @return the root of the tree, possibly different than original root if the root has been
     *     migrated
     */
    public static MerkleNode initializeAndMigrateTreeAfterDeserialization(
        ...
        // If a node should not be initialized, then neither should any of its descendants be
        // initialized.
                ...
                .forEachRemaining(
                        (final MerkleNode node) -> {
                            ...
                            for (int childIndex = 0;
                                ...
                                final int deserializationVersion =
                                        Objects.requireNonNull(
                                                deserializationVersions.get(child.getClassId()),
                                                "class not discovered during deserialization");

                                final MerkleNode migratedChild =
                                        child.migrate(deserializationVersion);

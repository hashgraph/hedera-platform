 ...
 *
 * @param <T> the type used by the view to represent a node
 */
public class LeafDataLesson<T> implements SelfSerializable {
     ...
     *
     * @param learnerTreeView the view for the learner
     */
     ...
     *
     * @param teacherView the view for the teacher
     * @param leaf the leaf to send in the lesson
     */

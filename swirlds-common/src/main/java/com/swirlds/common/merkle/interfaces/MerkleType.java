...
public interface MerkleType {
    ...
    /**
     * Blindly cast this merkle node into a leaf node, will fail if node is not actually a leaf
     * node.
     */
    ...
    /**
     * Blindly cast this merkle node into an internal node, will fail if node is not actually an
     * internal node.
     */
    ...
    /**
     * Blindly cast this merkle node into the given type, will fail if node is not actually that
     * type.
     *
     * @param <T> this node will be cast into this type
     */

...
/**
 * Implementing this interface allows for a class to implement the {@link MerkleInternal} interface
 * using inheritance by composition with minimal boilerplate.
 */
@ConstructableIgnored
public interface ComposedMerkleInternal extends MerkleInternal {

    /**
     * Get an object that implements the {@link PartialMerkleInternal} interface. This object will
     * be inherited by composition.
     *

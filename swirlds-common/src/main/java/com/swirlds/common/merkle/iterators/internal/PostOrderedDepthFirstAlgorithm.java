...
/**
 * Iteration algorithm for {@link
 * com.swirlds.common.merkle.iterators.MerkleIterationOrder#POST_ORDERED_DEPTH_FIRST
 * POST_ORDER_DEPTH_FIRST}.
 */
public class PostOrderedDepthFirstAlgorithm implements MerkleIterationAlgorithm {

    /**
     * The initial capacity for the array implementing the stack. It's much better to choose
     * something a bit larger than to pay the penalty of resizing the array list.
     */
    ...
    public void pushChildren(
            final MerkleInternal parent, final ObjIntConsumer<MerkleInternal> pushNode) {

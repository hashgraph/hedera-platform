 ...
 *
 * @param <T> the type used by the view to represent a merkle node
 */
public class InternalDataLesson<T> implements SelfSerializable {
     ...
     *
     * @param teacherTreeView the teacher's view
     * @param internal the internal node to include in the lesson
     */
    ...
    /**
     * Get the queries contained by this lesson (i.e. the hashes of the children of the internal
     * node).
     *

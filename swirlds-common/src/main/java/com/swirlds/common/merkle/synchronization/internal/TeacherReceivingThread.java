...
public class TeacherReceivingThread<T> {
     ...
     *
     * @param workGroup the work group that will manage this thread
     * @param in the input stream, this object is responsible for closing this when finished
     * @param view the view to be used when touching the merkle tree
     * @param senderIsFinished becomes true once the sending thread has finished
     */

...
/**
 * This abstract implements boilerplate functionality for a {@link MerkleLeaf}. Classes that
 * implement {@link MerkleLeaf} are not required to extend this class, but absent a reason it is
 * recommended to avoid re-implementation of this code.
 */

 ...
 * size/location recommended by the browser, and contains scrolling white text on a black
 * background. If {@code cons} is a {@link Console}, then it can be written to with {@code
 * cons.out.print()} and <code>cons.out.println()</code> in the same way as the System <code>print()
 * </code> and <code>println()</code> write to the Java console.
 */
public class Console {
    ...
    /**
     * Use {@link #out} to write to this console window in the same way that {@link System#out} is
     * used to write to Java's console window.
     */
    ...
    public Console(
            final String name, final Rectangle winRect, final int fontSize, final boolean visible) {
     ...
     *
     * @param headingText the text to display at the top
     */
     ...
     *
     * @param visible whether the window holding console is visible
     */

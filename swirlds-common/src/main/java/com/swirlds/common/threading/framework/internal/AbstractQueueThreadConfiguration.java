...
public abstract class AbstractQueueThreadConfiguration<
    ...
    /**
     * Set the runnable to execute when there is nothing in the queue to handle. The default is to
     * poll the queue, waiting a certain amount of time for it to return an item.
     *
    ...
    /**
     * Get the queue. If it doesn't exist then initialize with a default queue, and return that new
     * queue.
     *

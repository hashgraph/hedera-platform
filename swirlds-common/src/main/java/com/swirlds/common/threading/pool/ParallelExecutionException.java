...
/**
 * An exception thrown by @{@link ParallelExecutor} when one or both of the tasks fails. Since these
 * tasks can fail at different times, a timestamp is added to this exception.
 */
public class ParallelExecutionException extends Exception {
    /**
     * @param cause the original exception
     * @param time the time to attach to the message
     */

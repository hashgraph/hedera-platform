...
public interface Locks {
     ...
     *
     * @param parallelism the number of unique locks. Higher parallelism reduces chances of
     *     collision for non-identical * indexes at the cost of additional memory overhead.
    ...
    /**
     * Provides an implementation of {@link AutoClosableLock} which holds a resource that needs to
     * be locked before it can be used
     *

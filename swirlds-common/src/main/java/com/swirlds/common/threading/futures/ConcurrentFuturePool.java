...
public class ConcurrentFuturePool<V> extends ConcurrentLinkedQueue<Future<V>> {
     ...
     * Constructs an empty list.
     *
     * @param exceptionHandler an handler which handles exceptions thrown during the computation
     */
     ...
     */
    public ConcurrentFuturePool(
            final Collection<? extends Future<V>> c, final Consumer<Exception> exceptionHandler) {
        super(c);
        this.exceptionHandler = exceptionHandler;
    }

    /**
     * Constructs a list containing the elements of the specified {@link SortedSet}, in the order
     * they are returned by the collection's iterator.
     *
     * @param s the {@link SortedSet} whose elements are to be placed into this list
     * @throws NullPointerException if the specified collection is null
     */
     ...
     */
    public ConcurrentFuturePool(
            final SortedSet<Future<V>> s, final Consumer<Exception> exceptionHandler) {
        super(s);
        this.exceptionHandler = exceptionHandler;
    }
     ...
     *
     * @return an ordered {@link List} containing all values (or {@code null} if cancelled) returned
     *     by the futures contained in this {@link FuturePool}.
     */

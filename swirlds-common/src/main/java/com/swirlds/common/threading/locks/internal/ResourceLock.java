...
/**
 * An implementation of {@link AutoClosableLock} which holds a resource that needs to be locked
...
public class ResourceLock<T> implements AutoClosableResourceLock<T> {
    ...
    /** {@inheritDoc} */
    @Override
    public MaybeLockedResource<T> tryLock(final long time, final TimeUnit unit)

...
public interface StoppableThread extends Stoppable {
     ...
     * calling thread, regardless of configuration.
     *
     * <p>Should only be called once. Should not be called if {@link #start()} has been called.
     *
     ...
     *
     * <p>If called before the thread/seed is started, then this method blocks until the thread/seed
     * is started.
     */
    boolean interrupt();

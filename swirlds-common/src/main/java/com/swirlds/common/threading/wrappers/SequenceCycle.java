 ...
 */
package com.swirlds.common.threading.wrappers;

import com.swirlds.common.threading.ThreadSleep;
import com.swirlds.common.threading.interrupt.InterruptableConsumer;
import java.time.Duration;
import java.util.concurrent.atomic.AtomicLong;

/**
 * Used to wrap an {@link InterruptableConsumer} in order to track when the consumer started
 * executing and when it finished. This object can be used to detect when a {@link
 * com.swirlds.common.threading.framework.QueueThread QueueThread} is currently handling any object,
 * and to wait until that object has been fully handled.
 *
...
public class SequenceCycle<T> implements InterruptableConsumer<T> {
     ...
     * @param sleep the method that executed the sleep
     * @param sleepTime the amount of time to sleep while waiting for a cycle to end
     */
    public SequenceCycle(
            final InterruptableConsumer<T> consumer,
            final ThreadSleep sleep,

...
/**
 * A simple resource manager. The goal of this implementation is to create threads without
 * complaining about lifecycle. Eventually, this implementation should not be used in production
 * code.
 */
public final class AdHocThreadManager implements ThreadManager {
    ...
    /**
     * Get the static ad hoc thread manager. This manager does not complain about lifecycle
     * violations.
     *

...
public abstract class PlatformMetric implements Metric {
    ...
    /**
     * Take snapshots of the current values and return them. If the functionality of this {@code
     * PlatformMetric} requires it to be reset in regular intervals, it is done automatically after
     * the snapshot was generated. The list of {@code ValueTypes} will always be in the same order.
     *

...
/**
 * An instance of {@code MetricConfig} contains all configuration parameters needed to create a
 * {@link Metric}.
 *
 * <p>This class is abstract and contains only common parameters. If you want to define the
 * configuration for a specific {@code Metric}, there are special purpose configuration objects
 * (e.g. {@link Counter.Config}).
 *
 * <p>A {@code MetricConfig} should be used with {@link Metrics#getOrCreate(MetricConfig)} to create
 * a new {@code Metric}
 *
 * <p>This class is immutable, changing a parameter creates a new instance.
 *
...
public abstract sealed class MetricConfig<T extends Metric, C extends MetricConfig<T, C>>
     ...
     * @throws IllegalArgumentException if one of the parameters is {@code null} or consists only of
     *     whitespaces
     */
    MetricConfig(
     ...
     * @throws IllegalArgumentException if {@code description} is {@code null}, too long or consists
     *     only of whitespaces
     */
     ...
     *
     * <p>Implementation note: we use the double-dispatch pattern when creating a {@link Metric}.
     * More details can be found at {@link Metrics#getOrCreate(MetricConfig)}.
     *

 ...
 *
 * <p>This implementation is inspired by the {@code AtomicDouble} implementations in JSR 166 extra
 * and Guava.
 *
 * <p>Note: In CAS-operations, this class does not compare the {@code double}-values directly, but
 * the bits one gets by calling {@link Double#doubleToRawLongBits(double)}.
 */
public class AtomicDouble {
     ...
     * java.lang.invoke.VarHandle#getVolatile(Object...)}.
     *
    ...
    /**
     * Sets the value to newValue, with memory effects as specified by {@link
     * java.lang.invoke.VarHandle#setVolatile(Object...)}.
     *
    ...
    /**
     * Atomically sets the value to the given updated value if the current value is bitwise equal,
     * that is, if {@link Double#doubleToRawLongBits(double)} returns the same value.
     *

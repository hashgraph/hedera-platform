...
public interface MetricAdapter {
     ...
     *
     * @param snapshot The snapshot, which value should be used for the update.
     * @param nodeId The {@link NodeId} in which context the metric is used. May be {@code null}, if
     *     it is a global metric.

...
public interface IntegerPairAccumulator<T> extends Metric {
	 ...
	 * <p>
	 * The function is applied with the current values as their first argument, and the provided {@code leftValue}
	 * and {@code rightValue }as the second arguments.
	 *
	 * @param leftValue
	 * 		the value combined with the left {@code int}
	 * @param rightValue
	 * 		the value combined with the right {@code int}
	 */
	...
	final class Config<T> extends MetricConfig<IntegerPairAccumulator<T>, IntegerPairAccumulator.Config<T>> {
		 ...
		 * 		the function that is used to calculate the {@code IntegerAccumulator}'s value.
		 * @throws IllegalArgumentException
		 * 		if one of the parameters is {@code null} or consists only of whitespaces
		 */
		public Config(final String category, final String name, final BiFunction<Integer, Integer, T> resultFunction) {

...
/**
 * Adapter that synchronizes {@link com.swirlds.common.metrics.RunningAverageMetric} and {@link
...
public class DistributionAdapter extends AbstractMetricAdapter {
     ...
     * @param metric The {@link Metric} which value should be reported to Prometheus

...
/**
 * Maintains a list of updaters, that will be updated in regular intervals. The length of the
...
class MetricsUpdateService implements Startable {
    ...
    MetricsUpdateService(
            final ScheduledExecutorService executor, final long period, final TimeUnit unit) {
    ...
    /**
     * Add an updater that will be called periodically. An updater should only be used to update
     * metrics regularly.
     *

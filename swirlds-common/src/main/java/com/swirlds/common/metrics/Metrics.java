 ...
 *
 * <p>The interface {@code Metrics} provides functionality to add and delete metrics. There are also
...
public interface Metrics extends Startable {
    ...
    /**
     * Returns the {@link NodeId} which metrics this {@code Metrics} manages. If this {@code
     * Metrics} manages the global metrics, this method returns {@code null}.
     *
     ...
     *
     * @return {@code true} if this {@code Metrics} manages platform metrics, {@code false}
     *     otherwise
     */
     ...
     * @param name the name of the wanted category

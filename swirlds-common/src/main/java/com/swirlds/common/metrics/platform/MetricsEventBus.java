...
/**
 * The {@code MetricsEventBus} is an intermediate solution to organize the communication and
 * decouple components until we have defined a more general, final solution.
 *
...
public class MetricsEventBus<T> {
     ...
     *
     * @param executor An {@link Executor} that is used to notify subscribers
     ...
     *
     * <p>The new subscriber will receive the given previous events after subscription.
     *
     * @param subscriber The new {@code subscriber}
     * @param previousEvents A {@link Supplier} of previous events. To ensure, that we do not miss
     *     events, this will be evaluated after the subscriber was added.
    ...
    public Runnable subscribe(
            final Consumer<? super T> subscriber, final Supplier<Stream<T>> previousEvents) {
     ...
     * Submit a new event.
     *
     * <p>This method will return immediately. The subscribers using the {@link Executor} of this
     * class
     *
     * @param event The Event that will be sent to all subscribers
     */

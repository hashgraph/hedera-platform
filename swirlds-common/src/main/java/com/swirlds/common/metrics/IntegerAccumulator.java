 ...
 *
 * <p>An {@code IntegerAccumulator} is reset to the {@link #getInitialValue() initialValue}. If no
 * {@code initialValue} was specified, the {@code IntegerAccumulator} is reset to {@code 0}.
 */
public interface IntegerAccumulator extends BaseIntegerMetric {
     ...
     * accumulator}-function of this {@code IntegerAccumulator} to the current and given value.
     *
    ...
    final class Config extends MetricConfig<IntegerAccumulator, IntegerAccumulator.Config> {
         ...
         *
         * <p>By default, the {@link #getAccumulator() accumulator} is set to {@code Integer::max},
         * the {@link #getInitialValue() initialValue} is set to {@code 0}, and {@link #getFormat()
        ...
        /** {@inheritDoc} */
        @Override
        Class<IntegerAccumulator> getResultClass() {

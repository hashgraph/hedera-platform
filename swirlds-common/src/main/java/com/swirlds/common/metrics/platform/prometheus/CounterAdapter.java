...
public class CounterAdapter implements MetricAdapter {
     ...
     *
     * @param registry The {@link CollectorRegistry} with which the Prometheus {@link Collector}
     *     should be registered
     * @param metric The {@link com.swirlds.common.metrics.Counter} which value should be reported
     *     to Prometheus
     * @param adapterType Scope of the {@link com.swirlds.common.metrics.Counter}, either {@link
     *     AdapterType#GLOBAL} or {@link AdapterType#PLATFORM}

...
public class MaxSizeStreamExtension extends AbstractStreamExtension {
     ...
     *
     * @param maxByteCount the maximum number of bytes that are allowed to pass through the stream
     */
     ...
     *
     * @param maxByteCount the maximum number of bytes that are tolerated
     * @param threadSafe if true then this extension is safe to use with multiple streams, otherwise
     *     it should only be used by a single thread at a time
     */

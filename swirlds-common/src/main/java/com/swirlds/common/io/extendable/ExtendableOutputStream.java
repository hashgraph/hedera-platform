...
/**
 * An {@link OutputStream} where data passes through it and provides methods to do extra work with
 * that data.
 */
public class ExtendableOutputStream extends OutputStream {
     ...
     */
    public ExtendableOutputStream(
            final OutputStream stream, final OutputStreamExtension extension) {

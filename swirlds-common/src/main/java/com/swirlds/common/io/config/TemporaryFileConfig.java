 ...
 *
 * @param temporaryFilePath The directory where temporary files are created.
 */
...
public record TemporaryFileConfig(
    ...
    /**
     * Returns the real path to the temporary files that depends on the {@link
     * StateConfig#savedStateDirectory()} property.
     *

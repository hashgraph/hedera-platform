...
public enum SerializationOperation {
    ...
    /**
     * {@link AugmentedDataInputStream#readByteArray(int)} and {@link
     * AugmentedDataInputStream#readByteArray(int, boolean)}
     */
    READ_BYTE_ARRAY,

    /**
     * {@link AugmentedDataInputStream#readIntList(int)} and {@link
     * AugmentedDataInputStream#readIntArray(int)}
     */
    READ_INT_LIST,

    /**
     * {@link AugmentedDataInputStream#readLongList(int)} and {@link
     * AugmentedDataInputStream#readLongArray(int)}
     */
    READ_LONG_LIST,
    ...
    /**
     * {@link AugmentedDataInputStream#readFloatList(int)} and {@link
     * AugmentedDataInputStream#readFloatArray(int)}
     */
    READ_FLOAT_LIST,

    /**
     * {@link AugmentedDataInputStream#readDoubleList(int)} and {@link
     * AugmentedDataInputStream#readDoubleArray(int)}
     */
    READ_DOUBLE_LIST,

    /**
     * {@link AugmentedDataInputStream#readStringList(int, int)} and {@link
     * AugmentedDataInputStream#readStringArray(int, int)}
     */
    READ_STRING_LIST,
    ...
    /**
     * All variants of {@link SerializableDataInputStream#readSerializableList(int, boolean,
     * Supplier)} and {@link SerializableDataInputStream#readSerializableArray(IntFunction, int,
     * boolean, Supplier)}
     */
    ...
    /**
     * Called every time {@link MerkleDataInputStream#readMerkleTree(Path, int)} deserializes a
     * merkle node.
     */
    READ_MERKLE_NODE
}

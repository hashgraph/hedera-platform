...
public class SerializationStackElement {
     ...
     */
    public SerializationStackElement(
            final SerializationOperation operation, final StackTraceElement callLocation) {
     ...
     *
     * @param child the child operation
     */
     ...
     *
     * @param classId the class ID of the element
     */
    ...
    public void setStringRepresentation(final String stringRepresentation) {
        if (stringRepresentation.length() > MAX_STRING_REPRESENTATION_LENGTH) {
            this.stringRepresentation =
                    stringRepresentation.substring(0, MAX_STRING_REPRESENTATION_LENGTH) + "...";
        } else {
    ...
    /**
     * Reduce the child count by dropping children. Earlier children are dropped before later
     * children.
     */
     ...
     *
     * @param sb a string builder where the stack trace is being written
     * @param indent the indentation level of this element
     */
    public void writeStackTrace(final StringBuilder sb, final int indent) {
        ...
        sb.append(" @ ")
                .append(callLocation.getFileName())
                .append(":")
                .append(callLocation.getLineNumber());
        sb.append("\n");
    ...
    /**
     * Get the class ID of this object, if it is known. Some elements (e.g. primitives) will not
     * have a class ID.
     */
    ...
    /**
     * Get the class of this object, if it is knwon. Some elements (e.g. primitives) will not have a
     * class set.
     */
    ...
    /**
     * Get the string representation of this object. Not all objects will have a string
     * representation.
     */

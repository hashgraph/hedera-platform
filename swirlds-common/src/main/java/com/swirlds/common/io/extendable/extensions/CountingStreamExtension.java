...
public class CountingStreamExtension extends AbstractStreamExtension {
     ...
     *
     * @param threadSafe if true then the extension will be thread safe, if false then it will not
     *     be thread safe (and perhaps it will be slightly more performant)
     */

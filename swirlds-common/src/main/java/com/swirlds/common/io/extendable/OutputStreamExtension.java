...
public interface OutputStreamExtension extends Closeable {
    ...
    /**
     * This method is called when the {@link OutputStream#write(int)} is invoked on the underlying
     * stream. This method is required to eventually call {@link OutputStream#write(int)} on the
     * base stream.
     *
    ...
    /**
     * This method is called when the {@link OutputStream#write(byte[], int, int)} is invoked on the
     * underlying stream. This method is required to eventually call {@link
     * OutputStream#write(byte[], int, int)} on the base stream.
     *

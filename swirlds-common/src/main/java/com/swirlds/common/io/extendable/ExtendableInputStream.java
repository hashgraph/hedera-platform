...
/**
 * An {@link InputStream} where data passes through it and provides methods to do extra work with
 * that data
 */
public class ExtendableInputStream extends InputStream {
     ...
     *
     * @param stream a stream to extend
     * @param extensions zero or more extensions
     * @return an extended stream
     */
    public static InputStream extendInputStream(
            final InputStream stream, final InputStreamExtension... extensions) {
        if (extensions == null) {
            return stream;
        }

...
public final class StreamDebugUtils {
    ...
    /**
     * Attempt to perform deserialization. If the deserialization fails then retry with debug
     * enabled, log the debug info, and call the failure callback. Rethrows any exceptions

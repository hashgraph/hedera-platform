...
/**
 * Records information for recently deserialized objects. Used to print diagnostics when a
 * serialization problem is encountered.
 */
public class SerializationStack {
    ...
    public SerializationStack(final StackTraceElement callLocation) {
        stack.addLast(
                new SerializationStackElement(SerializationOperation.STREAM_OPENED, callLocation));
    }
     ...
     * @param callLocation describes where this serialization operation was initiated
     */
    ...
    public void finishOperation() {
        ...
        final SerializationStackElement parent =
                Objects.requireNonNull(stack.getLast(), "stack should never be empty");
        parent.addChild(finished);
    }

    /**
     * Set the class ID of the current serializable object being deserialized, once it becomes
     * known.
     *
     ...
     *
     * @param string a string representing the object read
     */
    ...
    public String generateSerializationStackTrace() {
        ...
        final SerializationStackElement root =
                Objects.requireNonNull(stack.getLast(), "stack should never be empty");

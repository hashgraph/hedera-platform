...
public final class MerkleSerializationProtocol {
    ...
    /**
     * Added an object that is serialized to the stream that contains various stream configuration
     * options.
     */
    public static final int VERSION_2_ADDED_OPTIONS = 2;

    /**
     * Removed serialization options, as they were no longer needed after serialization
     * simplifications.
     */

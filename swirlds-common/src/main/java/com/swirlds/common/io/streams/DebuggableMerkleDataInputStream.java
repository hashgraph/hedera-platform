...
public class DebuggableMerkleDataInputStream extends MerkleDataInputStream {
	 ...
	 */
	@Override
	public <T extends SelfSerializable> T readSerializable(final boolean readClassId,
	 ...
	 */
	@Override
	public <T extends SelfSerializable> void readSerializableIterableWithSize(final int maxSize,

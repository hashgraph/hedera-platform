 ...
 *
 * <p>This class provides a large number of methods with different signatures, the goal being to
 * avoid the creation of arrays to pass a variable number of arguments. Hashing happens a lot and
 * needs to be fast, so if we can avoid lots of extra allocations it is worthwhile.
 */
public final class NonCryptographicHashing {
     ...
     *
     * <p>Leemon wrote this, it's magic and does magic things. Like holy molly does this algorithm

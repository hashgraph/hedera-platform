 ...
 * number of transactions per second for the union of a set of throttles.
 *
 * <p>For each transaction all throttles will be sorted by capacity before allowing for each
 * throttle contained in the MultiThrottle
 *
 * <p>and then when a transaction is received, do this:
 *
 * <p>assemble either a List of throttles or individually add throttles related to the current
 * transaction
 *
 * <pre>{@code
...
public class MultiThrottle {
     ...
     * Create a new set of ANDed throttles that must allow and increment all throttles synchronously
     *
     * @param throttles a list of throttles including that need to all allow additional traffic to
     *     be incremented
     */
     ...
     *
     * @param throttle a throttles to be added to the list of Throttles
     */

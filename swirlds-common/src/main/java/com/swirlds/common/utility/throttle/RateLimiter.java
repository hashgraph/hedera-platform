...
/**
 * A simple utility designed to limit the frequency of an event, e.g. making sure a particular log
 * message isn't written too often.
 *
 * <p>This object is not thread safe. This object was designed for simplicity and ease of use. This
 * object may not be suitable for code pathways with extremely high performance requirements.
 */
public class RateLimiter {
    ...
    /**
     * Request permission to perform an operation. Returns true if it is ok to perform the
     * operation, returns false if the operation has been performed too recently in the past.
     *
    ...
    /**
     * Get the number of times {@link #request()} has returned false since the last time it returned
     * true. Immediately after {@link #request()} returns true, this method will always return 0.
     *

...
/**
 * Combine a list of {@link Clearable} instances into a single one with logging. The combined
 * instance will execute clear on each of the provided instances sequentially, while logging before
 * each clear
 */
public class LoggingClearables implements Clearable {
    ...
    /**
     * @param logMarker the log marker to use for logging
     * @param pairs a list of pairs, each clearable is paired up with a string name used for logging
     */

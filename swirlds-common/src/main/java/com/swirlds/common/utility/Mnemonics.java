...
public final class Mnemonics {
    ...
    /**
     * In-order BIP-39 words. <a
     * href="https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt">Source</a>
     */
    ...
    /**
     * Maps all long values to a BIP-39 word. Get the BIP-39 world at the given index. If the index
     * is negative then take its absolute value. If the index exceeds the number of words then get
     * the word at the index modulo the number of words.
     *
     ...
     *
     * <p>Mnemonic words are generated from data near the beginning of the data array, so arrays
     * with similar data near the beginning will have similar word choices. In scenarios like that,
     * it is better to generate mnemonic words from the hash of the data.
     *
    ...
    public static String generateMnemonic(
            final byte[] data, final int wordCount, final String separator) {

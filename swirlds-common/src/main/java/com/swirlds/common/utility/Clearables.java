...
public final class Clearables implements Clearable {
    ...
    /**
     * Combine a list of {@link Clearable} instances into a single one. The combined instance will
     * execute clear on each of the provided instances sequentially
     *
     * @param clearables the instances to combine

...
/**
 * Keeps track of a {@link com.swirlds.common.constructable.RuntimeConstructable} object. When the
 * object is released, this record will also be released.
 */
public class RuntimeObjectRecord implements Releasable {
     ...
     *
     * @param creationTime the creation time of the object
     * @param cleanupAction an operation that will be performed when {@link #release()} is called
     */
    public RuntimeObjectRecord(
            final Instant creationTime, final Consumer<RuntimeObjectRecord> cleanupAction) {
     ...
     * @param creationTime the creation time of the object
     * @param cleanupAction an operation that will be performed when {@link #release()} is called
     * @param metadata optional arbitrary metadata for debugging purposes, can be null
     */
    public RuntimeObjectRecord(
            final Instant creationTime,
            final Consumer<RuntimeObjectRecord> cleanupAction,
     ...
     * @throws ClassCastException if the metadata is not of the expected type
     */

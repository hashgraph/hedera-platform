...
public class LegacyFileConfigSource extends AbstractConfigSource {
    ...
    public static LegacyFileConfigSource ofSettingsFile() throws IOException {
        final Path path =
                FileSystems.getDefault().getPath("settings.txt").toAbsolutePath().normalize();
        return new LegacyFileConfigSource(
                path, ConfigSourceOrdinalConstants.LEGACY_PROPERTY_FILE_ORDINAL_FOR_SETTINGS);
    }
     ...
     * @throws IOException if config.txt can not be loaded
     */
    public static LegacyFileConfigSource ofConfigFile() throws IOException {
        ...
        return new LegacyFileConfigSource(
                path, ConfigSourceOrdinalConstants.LEGACY_PROPERTY_FILE_ORDINAL_FOR_CONFIG);
    }

 ...
 * values of properties programmatically by calling {@link #withValue(String, Long)} (String,
 * String)}.
 */
public final class SimpleConfigSource extends AbstractConfigSource {
    ...
    private <T> void setValue(
            final String propertyName, final T value, Function<T, String> converter) {
     ...
     */
    public SimpleConfigSource withBooleanValues(
            final String propertyName, final List<Boolean> values) {
     ...
     * @param values default values list
     */
    public SimpleConfigSource withIntegerValues(
            final String propertyName, final List<Integer> values) {
     ...
     * @param values default values list
     */
    public SimpleConfigSource withDoubleValues(
            final String propertyName, final List<Double> values) {
     ...
     * @param values default values list
     */
    public SimpleConfigSource withStringValues(
    ...
    private <T> void setValues(
            final String propertyName, final List<T> values, Function<T, String> converter) {
        CommonUtils.throwArgBlank(propertyName, "propertyName");
        CommonUtils.throwArgNull(converter, "converter");
        if (values == null) {
            ...
            String rawValues =
                    values.stream().map(converter::apply).collect(Collectors.joining(","));

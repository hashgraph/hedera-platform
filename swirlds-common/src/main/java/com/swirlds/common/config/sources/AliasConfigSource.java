...
/**
 * A {@link ConfigSource} that can be used a wrapper for other config sources and provides the
 * functionality to define aliases for given properties. By doing so the same property value that is
 * defined for 1 name in the wrapped {@link ConfigSource} can be accessed by multiple names.
 */

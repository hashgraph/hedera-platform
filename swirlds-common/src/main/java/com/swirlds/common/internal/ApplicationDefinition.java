...
/**
 * Temporary internal only class to facilitate an incremental refactor of the {@code
 * com.swirlds.platform.Browser} class. Will not be providing javadoc on class members due to
 * ephemeral nature of this temporary class.
 */

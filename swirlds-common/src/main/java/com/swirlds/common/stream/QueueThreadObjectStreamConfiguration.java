...
public class QueueThreadObjectStreamConfiguration<T extends RunningHashable> {
     ...
     * @return this object
     */
    public QueueThreadObjectStreamConfiguration<T> setForwardTo(
            final LinkedObjectStream<T> forwardTo) {
    ...
    /**
     * Get the maximum buffer size for created threads. Buffer size is not the same as queue
     * capacity, it has to do with the buffer that is used when draining the queue.
     */
    ...
    /**
     * Set the maximum buffer size for created threads. Buffer size is not the same as queue
     * capacity, it has to do with the buffer that is used when draining the queue.
     *
     * @return this object
     */
     ...
     * @return this object
     */
    public QueueThreadObjectStreamConfiguration<T> setContextClassLoader(

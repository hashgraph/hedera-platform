...
/**
 * A MultiStream instance might have multiple nextStreams. It accepts a SerializableRunningHashable
 * object each time, and sends it to each of its nextStreams
 *
...
public class MultiStream<T extends RunningHashable> implements LinkedObjectStream<T> {
    ...
    public static final String NOT_ENOUGH_NEXT_STREAMS =
            String.format(
                    "MultiStream should have at least %d " + "nextStreams", NEXT_STREAMS_MIN_SIZE);

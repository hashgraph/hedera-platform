...
/**
 * Factory that provides access to the default implementation of the {@link NotificationEngine}
 * interface using a static singleton pattern.
 */
public final class NotificationFactory {
    ...
    /**
     * Getter that provides access to a singleton instance of the {@link NotificationEngine}
     * interface.
     *

...
/**
 * Provides information and errors as the result of a given {@link
 * NotificationEngine#dispatch(Class, Notification)} call.
 *
...
public class NotificationResult<N extends Notification> {
     ...
     *
     * @param notification the original notification that was sent to each listener
     * @param totalListeners the total number of registered listeners
     */
    ...
    /**
     * Creates a new instance with the provided list of exceptions and the given number of
     * registered listeners.
     *
     * @param notification the original notification that was sent to each listener
     * @param totalListeners the total number of registered listeners
     * @param exceptions the list of exceptions that occurred during listener invocation
     */
    public NotificationResult(
            final N notification, final int totalListeners, final List<Throwable> exceptions) {
    ...
    /**
     * Getter that returns a list of {@link Throwable} instances that were thrown during listener
     * invocation.
     *
     ...
     *
     * @param ex the exception to be added
     */

...
public final class ConstructableRegistryFactory {
    ...
    /**
     * @param constructorType a class that represents the constructor type
     * @param <T> the type of constructor used
     * @return a new instance of {@link ConstructorRegistry}
     */
    public static <T> ConstructorRegistry<T> createConstructorRegistry(
            final Class<T> constructorType) {

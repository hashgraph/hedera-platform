 ...
 *
 * @param constructable a {@link RuntimeConstructable} class
 * @param constructor its constructor
 * @param <T> the type of constructor
 */
public record GenericClassConstructorPair<T>(
        Class<? extends RuntimeConstructable> constructable, T constructor) {

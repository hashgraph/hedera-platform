 ...
 * been created as a result of the event recovery process.
 *
 * <p>This notification is sent once during event recovery for the resulting recovered state.
 */
public class NewRecoveredStateNotification extends AbstractNotification {
    ...
    /**
     * Get the swirld state from the recovered state. Guaranteed to hold a strong reservation in the

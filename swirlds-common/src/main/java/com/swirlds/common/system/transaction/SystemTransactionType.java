...
public enum SystemTransactionType {
    ...
    /**
     * first byte of a system transaction giving all avgPingMilliseconds stats (sent as ping time in
     * microseconds)
     */
    SYS_TRANS_PING_MICROSECONDS,

    /**
     * first byte of a system transaction giving all avgBytePerSecSent stats (sent as bits per
     * second)
     */

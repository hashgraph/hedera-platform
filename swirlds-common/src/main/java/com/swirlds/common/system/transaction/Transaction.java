...
public sealed interface Transaction extends SerializableWithKnownLength permits ConsensusTransaction {
	 ...
	 */
	void extractSignature(final int signatureOffset, final int signatureLength, final int publicKeyOffset,
	 ...
	 * 		if the internal payload of this transaction is null or a zero length array
	 */
	void extractSignature(final int signatureOffset, final int signatureLength, final byte[] expandedPublicKey,

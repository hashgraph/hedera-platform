...
/**
 * @deprecated This interface will be removed at a later date. Use {@link Event} or {@link
 *     ConsensusEvent} instead.
 */
@Deprecated
public interface PlatformEvent extends ConsensusEvent {
    ...
    /**
     * The community's consensus timestamp for this event if a consensus is reached. Otherwise. it
     * will be an estimate.
     *
    ...
    /**
     * The created round of this event, which is the max of parents' created around, plus either 0
     * or 1.
     *

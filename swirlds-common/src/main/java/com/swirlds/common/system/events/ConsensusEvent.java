...
public interface ConsensusEvent extends Event, ReachedConsensus {
    ...
    /**
     * Returns an iterator over the application events in this transaction, which have all reached
     * consensus. Each invocation returns a new iterator over the same transactions. This method is
     * thread safe.
     *

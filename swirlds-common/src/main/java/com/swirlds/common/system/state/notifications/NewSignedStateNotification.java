...
/**
 * A {@link com.swirlds.common.notification.Notification Notification} that a new signed state has been completed.
 * Not guaranteed to be called for every round, and not guaranteed to be called in order. State is guaranteed to hold
 * a strong reservation until callback completes.
 */
public class NewSignedStateNotification extends AbstractNotification {
	 ...
	 *
	 * @param swirldState
	 * 		the swirld state from the round that is now fully signed
	 * @param dualState
	 * 		the dual state from the round that is now fully signed
	 * @param round
	 * 		the round that is now fully signed
	 * @param consensusTimestamp
	 * 		the consensus timestamp of the round that is now fully signed
	 */
	...
	/**
	 * Get the swirld state from the round that is now fully signed. Guaranteed to hold a strong reservation
	 * in the scope of this notification.
	 */

 ...
 *
 * <p>This data is available for an event only after consensus has been determined for it. When an
 * event is initially created, there is no consensus data for it.
 */
public class ConsensusData implements SelfSerializable {
    ...
    /**
     * the created round of this event (max of parents', plus either 0 or 1. 0 if not parents. -1 if
     * neg infinity)
     */

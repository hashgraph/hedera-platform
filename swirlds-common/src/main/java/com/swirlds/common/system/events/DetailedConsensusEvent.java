...
public class DetailedConsensusEvent extends AbstractSerializableHashable
	 ...
	 */
	public DetailedConsensusEvent(final BaseEventHashedData baseEventHashedData,
			final BaseEventUnhashedData baseEventUnhashedData, final ConsensusData consensusData) {
	...
	public static void serialize(final SerializableDataOutputStream out,

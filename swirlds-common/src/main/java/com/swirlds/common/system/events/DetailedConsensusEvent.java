...
/**
 * An event that may or may not have reached consensus. If it has reached consensus, provides
...
public class DetailedConsensusEvent extends AbstractSerializableHashable
     ...
     *
     * @param baseEventHashedData event data that is part of the event's hash
     * @param baseEventUnhashedData event data that is not part of the event's hash
    ...
    public void serialize(final SerializableDataOutputStream out) throws IOException {
        serialize(
                ...
                consensusData,
                EventSerializationOptions.FULL);
    }

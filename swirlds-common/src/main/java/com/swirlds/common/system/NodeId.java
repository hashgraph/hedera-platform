...
public class NodeId implements EventCreationRule {
     ...
     *
     * @param isMirror is it a mirror node or main node
     ...
     *
     * @param nodeId the NodeId to compare to
     ...
     * @return true if this is a main network ID and its ID value is equal to the supplied value,
     *     false if either of these conditions are not true
     */
     ...
     *
     * @param id the ID value to compare
     * @return true if this is a mirror network ID and its ID value is equal to the supplied value,
     *     false if either of these conditions are not true
     */

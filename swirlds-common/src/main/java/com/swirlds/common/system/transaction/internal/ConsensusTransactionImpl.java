...
public abstract non-sealed class ConsensusTransactionImpl implements ConsensusTransaction {
    ...
    /**
     * The consensus order of the event that contains this transaction, or -1 if consensus has not
     * yet been reached. NOT serialized and not part of object equality or hash code
     */

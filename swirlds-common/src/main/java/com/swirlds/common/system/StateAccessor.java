...
public interface StateAccessor {
    ...
    /**
     * Get the most recent immutable state. This state may or may not be hashed when it is returned.
     * Wrapper must be closed when use of the state is no longer needed else resources may be
     * leaked.
     *

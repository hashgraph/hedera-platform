...
class SimpleConfigSourceTest {
    ...
    void testValueForAllTypes() {
        ...
        Assertions.assertEquals(
                "a", configuration.getValue("string"), "the defined value must be returned");
        Assertions.assertEquals(
                7,
                configuration.getValue("int", Integer.TYPE),
                "the defined value must be returned");
        Assertions.assertEquals(
                7,
                configuration.getValue("int", Integer.class),
                "the defined value must be returned");
        Assertions.assertEquals(
                7L,
                configuration.getValue("long", Long.TYPE),
                "the defined value must be returned");
        Assertions.assertEquals(
                7L,
                configuration.getValue("long", Long.class),
                "the defined value must be returned");
        Assertions.assertEquals(
                1.0D,
                configuration.getValue("double", Double.TYPE),
                "the defined value must be returned");
        Assertions.assertEquals(
                1.0D,
                configuration.getValue("double", Double.class),
                "the defined value must be returned");
        Assertions.assertTrue(
                configuration.getValue("boolean", Boolean.TYPE),
                "the defined value must be returned");
        Assertions.assertTrue(
                configuration.getValue("boolean", Boolean.class),
                "the defined value must be returned");
    }
    ...
    void testNullValueForAlltypes() {
        ...
        Assertions.assertNull(
                configuration.getValue("string"), "the defined value (null) must be returned");
        Assertions.assertNull(
                configuration.getValue("int", Integer.TYPE),
                "the defined value (null) must be returned");
        Assertions.assertNull(
                configuration.getValue("int", Integer.class),
                "the defined value (null) must be " + "returned");
        Assertions.assertNull(
    ...
    void testValueEmptyListsForAllTypes() {
        ...
        final SimpleConfigSource configSource1 =
                new SimpleConfigSource().withStringValues("string", List.of());
        final SimpleConfigSource configSource2 =
                new SimpleConfigSource().withIntegerValues("int", List.of());
        final SimpleConfigSource configSource3 =
                new SimpleConfigSource().withLongValues("long", List.of());
        final SimpleConfigSource configSource4 =
                new SimpleConfigSource().withDoubleValues("double", List.of());
        final SimpleConfigSource configSource5 =
                new SimpleConfigSource().withBooleanValues("boolean", List.of());
    ...
    void testValueListsForAllTypes() {
        ...
        final SimpleConfigSource configSource2 =
                new SimpleConfigSource()
                        .withIntegerValues("int", List.of(Integer.MIN_VALUE, 0, Integer.MAX_VALUE));
        final SimpleConfigSource configSource3 =
                new SimpleConfigSource()
                        .withLongValues("long", List.of(Long.MIN_VALUE, 0L, Long.MAX_VALUE));
        final SimpleConfigSource configSource4 =
                new SimpleConfigSource()
                        .withDoubleValues(
                                "double", List.of(Double.MIN_VALUE, 0D, Double.MAX_VALUE));
        final SimpleConfigSource configSource5 =
    ...
    void testNullValueListsForAllTypes() {
        // given
        final SimpleConfigSource configSource1 =
                new SimpleConfigSource().withStringValues("string", null);
        final SimpleConfigSource configSource2 =
                new SimpleConfigSource().withIntegerValues("int", null);
        final SimpleConfigSource configSource3 =
                new SimpleConfigSource().withLongValues("long", null);
        final SimpleConfigSource configSource4 =
                new SimpleConfigSource().withDoubleValues("double", null);
        final SimpleConfigSource configSource5 =
                new SimpleConfigSource().withBooleanValues("boolean", null);
        ...
        // then
        Assertions.assertNull(
                configuration.getValues("string"), "the defined value (null) must be returned");
        Assertions.assertNull(
                configuration.getValues("int", Integer.TYPE),
                "the defined value (null) must be " + "returned");
        Assertions.assertNull(

...
class ConstructorRegistryTest {
    ...
    void customConstructorTest() throws ConstructableRegistryException {
        ...
        cr.registerConstructable(
                StringConstructable.class, s -> new StringConstructable(overridden));
        final StringConstructor constructor = cr.getConstructor(StringConstructable.CLASS_ID);
    ...
    void noArgsConstructorTest() throws ConstructableRegistryException {
        ...
        final NoArgsConstructor constructorAnnotated =
                cr.getConstructor(NoArgsConstructableWithAnnotation.CLASS_ID);
        final RuntimeConstructable constructableAnnotated = constructorAnnotated.get();
        // then
        Assertions.assertEquals(
                NoArgsConstructableWithAnnotation.class, constructableAnnotated.getClass());
        Assertions.assertEquals(
                NoArgsConstructableWithAnnotation.CLASS_ID, constructableAnnotated.getClassId());
    ...
    void primitiveArgsConstructorTest() throws ConstructableRegistryException {
        ...
        final ConstructorRegistry<PrimitiveAndObjectConstructor> cr =
                ConstructableRegistryFactory.createConstructorRegistry(
                        PrimitiveAndObjectConstructor.class);
    ...
    void badConstructorType() {
        Assertions.assertThrows(
                ...
                () ->
                        ConstructableRegistryFactory.createConstructorRegistry(
                                NotInterfaceConstructor.class));
        Assertions.assertThrows(
                IllegalArgumentException.class,
                () ->
                        ConstructableRegistryFactory.createConstructorRegistry(
                                MultipleMethodsConstructor.class));
        Assertions.assertThrows(
                IllegalArgumentException.class,
                () ->
                        ConstructableRegistryFactory.createConstructorRegistry(
                                BadReturnTypeConstructor.class));
    }
    ...
    void badConstructable() {
        ...
        Assertions.assertThrows(
                ...
                () -> cr.registerConstructable(NoConstructorConstructable.class));
    }
}

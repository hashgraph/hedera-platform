...
import static com.swirlds.jasperdb.files.DataFileCommon.roundTwoDecimals;
...
class DataFileCommonTest {
    ...
    void roundsAsExpected(final double in, final double out) {
        assertEquals(
                ...
                roundTwoDecimals(in),
                0.01,
                "Should have rounded off more than two digits of precision");
    }
    ...
    void formatsAsExpected(final long size, final String desc) {
        assertEquals(
                ...
                "Should recognize the largest size denomination relevant");
    }
}

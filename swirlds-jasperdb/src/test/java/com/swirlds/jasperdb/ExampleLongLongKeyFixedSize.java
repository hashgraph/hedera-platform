...
public class ExampleLongLongKeyFixedSize implements VirtualLongKey, FastCopyable {
    ...
    public static class Serializer implements KeySerializer<ExampleLongLongKeyFixedSize> {
        ...
        private static final long CLASS_ID = 0xee6fa2534c50d632L;
         ...
         */
        @Override
        public ExampleLongLongKeyFixedSize deserialize(
        ...
        public int serialize(
                final ExampleLongLongKeyFixedSize data,
        ...
        public boolean equals(
                ByteBuffer buffer, int dataVersion, ExampleLongLongKeyFixedSize keyToCompare)
                throws IOException {
            assert dataVersion == getCurrentDataVersion()
                    : "dataVersion="
                            + dataVersion

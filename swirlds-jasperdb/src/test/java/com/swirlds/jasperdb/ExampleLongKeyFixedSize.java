...
public class ExampleLongKeyFixedSize implements VirtualLongKey, FastCopyable {
    ...
    private static final long CLASS_ID = 0x6ec21ff5ab56811eL;
    ...
    public void deserialize(final SerializableDataInputStream in, final int dataVersion)
            throws IOException {
        assert dataVersion == getVersion()
                : "dataVersion=" + dataVersion + " != getVersion()=" + getVersion();
    ...
    public static class Serializer implements KeySerializer<ExampleLongKeyFixedSize> {
        ...
        private static final long CLASS_ID = 0x58a0db3356d8ec68L;
         ...
         */
        @Override
        public ExampleLongKeyFixedSize deserialize(
                final ByteBuffer buffer, final long dataVersion) {
        ...
        /**
         * Serialize a data item including header to the output stream returning the size of the
         * data written
         *
        ...
        public int serialize(
                final ExampleLongKeyFixedSize data, final SerializableDataOutputStream outputStream)
                throws IOException {
        ...
        public boolean equals(
                ByteBuffer buffer, int dataVersion, ExampleLongKeyFixedSize keyToCompare)
                throws IOException {
            assert dataVersion == getCurrentDataVersion()
                    : "dataVersion="
                            + dataVersion
    ...
    /** A self serializable supplier for a {@link ExampleLongKeyFixedSize} object. */
    public static class Builder implements SelfSerializableSupplier<ExampleLongKeyFixedSize> {

        private static final long CLASS_ID = 0xfb94a6dec01564d0L;

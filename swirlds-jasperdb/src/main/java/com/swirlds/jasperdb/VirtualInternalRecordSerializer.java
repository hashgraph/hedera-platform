...
public class VirtualInternalRecordSerializer
        implements DataItemSerializer<VirtualInternalRecord>, SelfSerializable {
     ...
     * @throws IllegalArgumentException if used with version other than current
     */
    @Override

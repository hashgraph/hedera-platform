 ...
 *
 * These hashes are based on a permutation (invertible function) on 64 bits
 * defined by {@link NonCryptographicHashing#perm64(long)}, chosen via
 * automated search to optimize avalanche.
 */
...
public final class NonCryptographicHashing {
	...
	public static int hash32(final long x0, final long x1) {
		return (int) perm64(perm64(x0) ^ x1);
	}
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 1 int.
	 *
	 * @param x0
	 * 		an int
	 * @return a non-cryptographic integer hash
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 2 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 3 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 4 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 5 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 6 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 7 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 8 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 9 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1
	...
	/**
	 * Generates a non-cryptographic 32 bit hash for 10 ints.
	 *
	 * @param x0
	 * 		an int
	 * @param x1

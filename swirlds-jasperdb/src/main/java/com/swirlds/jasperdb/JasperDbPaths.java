...
/**
 * Simple class for building and holding the set of sub-paths for data in a JasperDB datasource
 * directory
 */
public class JasperDbPaths {
    ...
    public JasperDbPaths(final Path storageDir) {
        ...
        pathToDiskLocationInternalNodesFile =
                storageDir.resolve("pathToDiskLocationInternalNodes.ll");

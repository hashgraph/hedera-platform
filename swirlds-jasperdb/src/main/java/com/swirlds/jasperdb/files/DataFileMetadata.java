...
public final class DataFileMetadata {
    ...
    /**
     * True if this file was created as part of a merge, false if it was fresh data. This can be
     * used during merging to select if we want to include previously merged files in a merging
     * round or not.
     */
     ...
     * @param isMergeFile True if this file was created as part of a merge, false if it was fresh
     *     data. This can be used during merging to select if we want to include previously merged
     *     files in a merging round or not.
    ...
    /**
     * Get if the file is a merge file. True if this is a merge file, false if it is a new data file

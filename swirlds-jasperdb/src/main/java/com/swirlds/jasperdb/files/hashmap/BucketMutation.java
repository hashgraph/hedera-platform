...
class BucketMutation<K extends VirtualKey<? super K>> {
    ...
    /**
     * To be called on the "head" of the list, updates an existing mutation with the same key or
     * creates a new mutation at the end of the list.
     *
     ...
     *
     * @return The number of mutations, including this one, from here to the end.
     */
    int size() {
        int size = 1;
     ...
     *
     * @param consumer The callback. Cannot be null.
     */

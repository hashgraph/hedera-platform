...
/**
 * A special version of SerializableDataOutputStream that writes into a byte[] buffer and measures
 * the size written.
 */
public class DataFileOutputStream extends SerializableDataOutputStream {
     ...
     * stream argument, as if by calling the output stream's write method using {@code
    ...
    /**
     * Writes the complete contents of this {@code ByteArrayOutputStream} to the specified
     * ByteBuffer.
     *
    ...
    /**
     * Resets the {@code count} field of this {@code ByteArrayOutputStream} to zero, so that all
    ...
    /**
     * Extended version of ByteArrayOutputStream that allows copy free writing of bytes into a
     * ByteBuffer. This is needed because the byte array "buf" in ByteArrayOutputStream is protected
     * access.
     */
    private static class ExtendedByteArrayOutputStream extends ByteArrayOutputStream {
        /**
         * Creates a new {@code ByteArrayOutputStream}, with a buffer capacity of the specified
         * size, in bytes.
         *

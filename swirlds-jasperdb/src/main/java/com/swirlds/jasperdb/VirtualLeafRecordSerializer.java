...
/**
 * VirtualLeafRecordSerializer serializer responsible for serializing and deserializing virtual leaf
 * records. It depends on the serialization implementations of the VirtualKey and VirtualValue.
 *
...
public class VirtualLeafRecordSerializer<K extends VirtualKey<? super K>, V extends VirtualValue>
     ...
     *
     * @param hashSerializationVersion The serialization version for hash, less than 65,536
     ...
     * @param keySizeBytes The number of bytes used by a serialized keu, can be
     ...
     * @param valueSizeBytes The number of bytes used by a serialized value, can be
     *     DataFileCommon.VARIABLE_DATA_SIZE
     * @param valueConstructor Constructor for creating new value instances during deserialization
     * @param maxKeyValueSizeLessThan198 Is max size of serialized key and value is less than
     *     (255-(1+8+48)) = 198
     */
    public VirtualLeafRecordSerializer(
        ...
        this.currentVersion =
                (0x000000000000FFFFL & hashSerializationVersion)
        ...
        this.hasVariableDataSize =
                keySizeBytes == VARIABLE_DATA_SIZE || valueSizeBytes == VARIABLE_DATA_SIZE;
     ...
     *
     * @return Either for fixed size same as getSerializedSize() or a estimated typical size for
     *     data items
     */
    @Override
     ...
     */
    @Override
    public VirtualLeafRecord<K, V> deserialize(final ByteBuffer buffer, final long dataVersion)
            throws IOException {

...
public class VirtualKeySetSerializer implements KeySerializer<VirtualKey<VirtualLongKey>> {
    ...
    /** {@inheritDoc} */
    @Override
    public int serialize(final VirtualKey<VirtualLongKey> data, final ByteBuffer buffer)
            throws IOException {
    ...
    public int serialize(
            final VirtualKey<VirtualLongKey> data, final SerializableDataOutputStream outputStream)
            throws IOException {
    ...
    /** {@inheritDoc} */
    @Override
    public VirtualKey<VirtualLongKey> deserialize(final ByteBuffer buffer, final long dataVersion)
            throws IOException {
    ...
    public boolean equals(
            ...
            final VirtualKey<VirtualLongKey> keyToCompare)
            throws IOException {

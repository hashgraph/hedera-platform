...
public final class HashTools {
    ...
    /**
     * Gets the version for all hashes written. May represent both the storage format and the
     * digest.
     *
     ...
     *
     * @param hash the hash with the digest to put in a byte buffer
     ...
     *
     * @param hash the hash with the digest to copy
     * @param buf the byte buffer to receive the digest of the hash
     */
     ...
     *
     * @param buffer the byte buffer whose contents are the desired digest
     * @param serializationVersion the version of serialization used to create the byte buffer

 ...
 *
 * <p>This means lookups by self-reported index are extremely fast, but the array may waste some
...
public class ImmutableIndexedObjectListUsingArray<T extends IndexedObject>
    ...
    /** {@inheritDoc} */
    public ImmutableIndexedObjectListUsingArray<T> withDeletedObjects(
            final Set<T> objectsToDelete) {

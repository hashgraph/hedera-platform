 ...
 */
public abstract class AbstractFixedSizeKeySerializer<K extends VirtualKey<? super K>>
    ...
    /** {@inheritDoc} */
    @Override
    public int serialize(final K data, final SerializableDataOutputStream outputStream)
            throws IOException {

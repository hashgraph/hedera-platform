...
/**
 * Each data item needs a header containing at least a numeric key. The key can be any size from
 * byte to long. The size can be stored for variable size data or this can be constructed with a
 * fixed size.
 */

...
class VirtualMapSettingsImplTest {
    ...
    void defaultsAreAsExpected() {
        final int expectedDefaultNumHashThreads =
        ...
        assertEquals(
                50.0,
                subject.getPercentHashThreads(),
                "Default percent hash threads should be 50%");
        assertEquals(
    ...
    void overridingPercentHashThreadsWorksAsExpected() {
        ...
        assertEquals(
                customPer,
                subject.getPercentHashThreads(),
                "Should be able to override percentHashThreads");
    }
    ...
    void overridingNumHashThreadsWorksAsExpected() {
        ...
        assertEquals(
                customNum,
                subject.getNumHashThreads(),
                "Should be able to override numHashThreads");
    }
    ...
    void overridingMaximumVirtualMapSizeWorksAsExpected() {
        ...
        assertEquals(
                customMax,
                subject.getMaximumVirtualMapSize(),
                "Should be able to override maximumVirtualMapSize");
    }

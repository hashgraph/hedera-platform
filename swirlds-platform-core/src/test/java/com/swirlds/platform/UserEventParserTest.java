...
/**
 * Parse the event file layer by layer from user perspective follows the event stream format
 * documentation. First parse the stream object, then parse consensus event, then transactions, etc
 */
class UserEventParserTest {
    ...
    public Hash RunningHashDeserialize(SerializableDataInputStream in, boolean classIDAlreadyRead)
            throws IOException {

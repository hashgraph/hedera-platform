    ...
    void prePaint() {
        ...
        s +=
                Utilities.wrap(
                        70,
                        "\n\n"
                            + "Each swirld (shared world, shared ledger, shared database) has a"
                            + " unique identifier. The identifier of the current swirld is shown"
                            + " above in two forms. The first is a base-62 encoding between <angled"
                            + " brackets>. The second is a sequence of words. \n\n"
                            ...
                            + " the same identifier as the original. So that version of the swirld"
                            + " is the 'official' or 'true' successor, and the rest are new"
                            + " swirlds.");

...
/**
 * A message sent periodically that informs peers how long it takes for this node to process an
 * event, from the time an event is first received to the time it is validated.
 */

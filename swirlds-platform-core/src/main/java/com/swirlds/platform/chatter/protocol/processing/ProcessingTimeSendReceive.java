...
/**
 * Sends and receives {@link ProcessingTimeMessage}s, recording the values received from peers
 * locally
 */
public class ProcessingTimeSendReceive
        implements MessageProvider, MessageHandler<ProcessingTimeMessage> {
     ...
     * @param selfProcessingNanos provides the current value of this node's event processing time in
     *     nanoseconds.
     */
    ...
    /**
     * @return the processing time received from the peer in nanoseconds, or null if nothing has
     *     been received yet
     */

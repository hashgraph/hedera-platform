...
public final class InputDelegateBuilder {
    private final List<MessageTypeHandler<? extends SelfSerializable>> messageTypeHandlers =
            new ArrayList<>();
     ...
     */
    public InputDelegateBuilder addHandler(
            final MessageTypeHandler<? extends SelfSerializable> handler) {

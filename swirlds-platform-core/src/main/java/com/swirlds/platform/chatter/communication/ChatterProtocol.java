...
public class ChatterProtocol implements Protocol {
    ...
    public ChatterProtocol(
            final PeerInstance peerInstance, final ParallelExecutor parallelExecutor) {
    ...
    /**
     * Reads {@link SelfSerializable} messages from a stream and passes them on to chatter for
     * handling
     */
        ...
        while (connection.connected()) {
            ...
            switch (b) {
                ...
                default -> throw new NetworkProtocolException(
                        String.format("Unexpected byte received: %02X", b));
            }
        }
    }

...
public class OtherEventDelay {
    ...
    /**
     * @param heartbeatRoundTrip latest round trip time in nanos, or null if no value is available
     * @param peerProcessingTime the event processing time of the peer in nanoseconds, or null if it
     *     is not available yet
     * @param constantDelay a constant delay to add on top of all calculation
     */

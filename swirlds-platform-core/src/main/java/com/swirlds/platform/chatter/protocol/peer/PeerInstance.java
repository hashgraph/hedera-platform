 ...
 *
 * @param communicationState the state of chatter communication with the peer
 * @param inputHandler handles input messages
 * @param outputAggregator provides messages to be sent to the peer
 * @param state the state of this chatter connection
 */

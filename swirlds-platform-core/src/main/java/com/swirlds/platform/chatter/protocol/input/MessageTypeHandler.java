...
public class MessageTypeHandler<T extends SelfSerializable> {
    ...
    /**
     * If the message is the appropriate type, cast it and pass it on to handlers for the message
     * type
     *
     * @param message the message to cast and handle
     * @return true if the message is the appropriate type and is handled by this instance, false
     *     otherwise
     */

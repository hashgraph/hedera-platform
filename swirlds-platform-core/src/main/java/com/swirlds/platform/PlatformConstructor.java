...
final class PlatformConstructor {
     ...
     * @param signedStateConsumer consumer of signed states that hashes the state and collects
     *     signatures
     */
     ...
     * @param roundAppliedToStateConsumer the consumer to invoke when a round has just been applied
     *     to the state

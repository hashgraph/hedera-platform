...
public class EventFileParser {
     ...
     *
     * @param path event stream file
     * @param eventConsumer a consumer of parsed events
    ...
    private static boolean parseEventStreamV5(final Path path, final EventConsumer eventConsumer) {
        final Iterator<SelfSerializable> iterator =
                parseStreamFile(path.toFile(), EventStreamType.getInstance());

...
public final class OSHealthChecker {
    ...
    /**
     * Performs the provided OS health checks and logs a report. If any checks fail, the report is
     * logged at a warning. If all checks pass, the report is logged at info.
     *
     * @param osHealthConfig configuration containing values for OS health checks
     */
    public static void performOSHealthChecks(
        ...
        addLine(
                sb,
                String.format(
                        "OS Health Check Report - Complete (took %d ms)",

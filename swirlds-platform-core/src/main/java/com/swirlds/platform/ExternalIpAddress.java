...
public class ExternalIpAddress {
    ...
    public static final ExternalIpAddress NO_IP =
            new ExternalIpAddress(IpAddressStatus.NO_IP_FOUND, "");
    ...
    /**
     * If External IP address is found, then the address will be returned in ipv4 or ipv6 format.
    ...
    /**
     * If External IP address is found, it is returned in ipv4/ipv6 format. Otherwise, a string

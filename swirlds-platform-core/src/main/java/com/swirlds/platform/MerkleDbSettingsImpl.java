...
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_KEY_SET_HALF_DISK_HASH_MAP_BUFFER;
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_KEY_SET_HALF_DISK_HASH_MAP_SIZE;
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_LEAF_RECORD_CACHE_SIZE;
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_MAX_FILE_SIZE_BYTES;
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_MAX_GB_RAM_FOR_MERGING;
import static com.swirlds.merkledb.settings.DefaultMerkleDbSettings.DEFAULT_MAX_NUMBER_OF_FILES_IN_MERGE;
...
public class MerkleDbSettingsImpl extends SubSetting implements MerkleDbSettings {
    ...
    public boolean reconnectKeyLeakMitigationEnabled =
    ...
    public void setInternalHashesRamToDiskThreshold(final int internalHashesRamToDiskThreshold) {
        if (internalHashesRamToDiskThreshold < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure internalHashesRamToDiskThreshold="
    ...
    public void setFullMergePeriod(final long fullMergePeriod) {
        if (fullMergePeriod < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure fullMergePeriod=" + fullMergePeriod);
        }
    ...
    public void setMediumMergePeriod(final long mediumMergePeriod) {
        if (mediumMergePeriod < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure mediumMergePeriod=" + mediumMergePeriod);
        }
    ...
    public void setMergeActivatedPeriod(final long mergeActivatedPeriod) {
        if (mergeActivatedPeriod < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure smallMergePeriod=" + mergeActivatedPeriod);
        }
    ...
    public void setMaxDataFileBytes(final long maxDataFileBytes) {
        if (maxDataFileBytes < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure maxDataFileBytes=" + maxDataFileBytes);
        }
    ...
    public void setMoveListChunkSize(final int moveListChunkSize) {
        if (moveListChunkSize <= 0) {
            throw new IllegalArgumentException(
                    "Cannot configure moveListChunkSize=" + moveListChunkSize);
        }
    ...
    public void setMaxRamUsedForMergingGb(final int maxRamUsedForMergingGb) {
        if (maxRamUsedForMergingGb < 0) {
            throw new IllegalArgumentException(
                    "Cannot configure maxRamUsedForMergingGb=" + maxRamUsedForMergingGb);
        }
    ...
    public void setIteratorInputBufferBytes(final int iteratorInputBufferBytes) {
        if (iteratorInputBufferBytes <= 0) {
            throw new IllegalArgumentException(
                    "Cannot configure iteratorInputBufferBytes=" + iteratorInputBufferBytes);
        }
    ...
    public void setWriterOutputBufferBytes(final int writerOutputBufferBytes) {
        if (writerOutputBufferBytes <= 0) {
            throw new IllegalArgumentException(
                    "Cannot configure writerOutputBufferBytes=" + writerOutputBufferBytes);
        }

...
/**
 * Pauses a thread while a {@link Clearable} is cleared. This is useful for externally clearing
 * instances that are not thread-safe
 */
public class PauseAndClear implements Clearable {
     ...
     * @param clearable the {@link Clearable} to clear
     */

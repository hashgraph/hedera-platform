...
/**
 * Manage a single connection with another member, which can be initiated by self or by them. Once
 * the connection is established, it can be used for syncing, and will have heartbeats that keep it
 * alive.
 */
    ...
    public static SocketConnection create(
        ...
        final SocketConnection c =
                new SocketConnection(
                        selfId, otherId, connectionTracker, outbound, socket, dis, dos);

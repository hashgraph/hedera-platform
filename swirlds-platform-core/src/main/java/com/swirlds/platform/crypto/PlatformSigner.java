...
/**
 * An instance capable of signing data with the platforms private signing key. This class is not
 * thread safe.
 */
public class PlatformSigner implements Signer, HashSigner {
    ...
    public com.swirlds.common.crypto.Signature sign(final byte[] data) {
        try {
            ...
            // this can only occur if this signature object is not initialized properly, which we
            // ensure is done in the

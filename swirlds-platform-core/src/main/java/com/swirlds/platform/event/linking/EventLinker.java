...
public interface EventLinker extends Clearable, LoadableFromSignedState {
     ...
     *
     * @param event the event that needs linking
     */
     ...
     *
     * @param generations the new generations
     */
    ...
    /**
     * Returns a previously submitted {@link GossipEvent} as a linked event. Should only be called
     * if {@link #hasLinkedEvents()} returns true.
     *

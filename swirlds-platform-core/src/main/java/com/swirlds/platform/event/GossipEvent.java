...
public class GossipEvent implements EventIntakeTask, BaseEvent, ChatterEvent {
    ...
    /**
     * Build the descriptor of this event. This cannot be done when the event is first instantiated,
     * it needs to be hashed before the descriptor can be built.
     */
    public void buildDescriptor() {
        this.descriptor =
                new ChatterEventDescriptor(
                        hashedData.getHash(),

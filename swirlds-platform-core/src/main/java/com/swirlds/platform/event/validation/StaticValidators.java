...
public final class StaticValidators {
     ...
     * @return true iff the creation time of the event is strictly after the creation time of its
     *     self-parent
     */
        ...
        if (event.getSelfParent() != null) {
            ...
            if (selfParent != null
                ...
                logger.debug(
                        ...
                        () ->
                                String.format(
                                        "Event timeCreated ERROR event %s created:%s, parent"
                                                + " created:%s",

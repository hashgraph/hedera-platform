...
public class EventValidator {
    ...
    /**
     * Hashes the event if it hasn't been hashed already, then checks the event's validity. If the
     * event is invalid, it is discarded. If it's valid, it is passed on.
     *

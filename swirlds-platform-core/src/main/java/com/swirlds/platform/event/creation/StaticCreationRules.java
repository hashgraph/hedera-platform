...
public final class StaticCreationRules {
     ...
     *
     * @param selfParent a potential self-parent
     * @param otherParent a potential other-parent
     * @return DONT_CREATE if the otherParent is null, PASS otherwise
     */
    @SuppressWarnings(
            "unused") // selfParent is needed to conform to the ParentBasedCreationRule interface
    public static EventCreationRuleResponse nullOtherParent(

...
public class ChatteringRule implements EventCreationRule {
	 ...
	 */
	public ChatteringRule(final double chatteringThreshold,
	...
	public EventCreationRuleResponse shouldCreateEvent() {
		...
		final long numChattering = chatterCommunicationStates.stream().filter(CommunicationState::isChattering).count();

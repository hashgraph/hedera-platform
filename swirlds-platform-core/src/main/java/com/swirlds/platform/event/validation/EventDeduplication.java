...
/**
 * A {@link GossipEventValidator} that checks a list of predicates to see if this event is a
 * duplicate
 */
public class EventDeduplication implements GossipEventValidator {
    ...
    public EventDeduplication(
            final Predicate<ChatterEventDescriptor> isDuplicateCheck,
            final EventIntakeMetrics stats) {

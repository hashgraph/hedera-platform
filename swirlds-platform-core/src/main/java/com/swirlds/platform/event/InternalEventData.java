...
public class InternalEventData {
    ...
    /**
     * is roundCreated frozen (won't change with address book changes)? True if an ancestor of a
     * famous witness
     */
    ...
    /**
     * the Election associated with the earliest round involved in the election for this event's
     * fame
     */
    ...
    /**
     * only used for event streaming this is the last event to be written to event stream before
     * restart
     */
    ...
    public InternalEventData() {
        ...
        this.estimatedTime =
                this.timeReceived; // until a better estimate is found, just guess the time it
        // was received
        this.mark = 0; // ConsensusImpl.currMark starts at 1 and counts up, so all events initially
        // count as unmarked
    }
    ...
    public String toString() {
        return "InternalEventData{"
                ...
                + hasUserTransactions
                + ", lastSee="
                + EventUtils.toShortStrings(lastSee)
                + ", stronglySeeP="
                + EventUtils.toShortStrings(stronglySeeP)
                + ", firstSelfWitnessS="
                + EventUtils.toShortString(firstSelfWitnessS)
                + ", firstWitnessS="
                + EventUtils.toShortString(firstWitnessS)
                + ", mark="
                + mark
                + ", recTimes="
                + recTimes
    ...
    /**
     * @param cleared has this event been cleared (because it was old and should be discarded)?
     */
    ...
    /**
     * @param hasUserTransactions does this event contains user transactions (not just system
     *     transactions)
     */

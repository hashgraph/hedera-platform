...
public final class EventConstants {
    ...
    /**
     * the generation number used to represent that the generation is not defined. an event's
     * computed generation number is always non-negative. in case it is used as a parent generation,
     * it means there is no parent event
     */

...
public interface FallenBehindManager {
    /**
     * Notify the fallen behind manager that a node has reported that they don't have events we
     * need. This means we have probably fallen behind and will need to reconnect
     *
    ...
    /**
     * We have determined that we have not fallen behind, or we have reconnected, so reset
    ...
    /**
     * Have enough nodes reported that they don't have events we need, and that we have fallen
     * behind?
     *

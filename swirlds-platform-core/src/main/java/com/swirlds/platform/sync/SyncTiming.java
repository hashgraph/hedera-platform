...
/**
 * A type to record the points for gossip steps. At the end of a gossip session, the results are
 * reported to the relevant statistics accumulators which quantify gossip performance.
 */

 ...
 *
 * <p>The shadow event type is the vertex type of the shadow graph. This is the elemental type of
 * {@link ShadowGraph}. It provides a reference to a hashgraph event instance and the following
 * operations:
 *
 * <ul>
 *   <li>linking of a parent shadow event
 *   <li>unlinking of a parent shadow event
 *   <li>querying for parent events
 * </ul>
 *
 * All linking and unlinking of a shadow event is implemented by this type.
 *
 * <p>A shadow event never modifies the fields in a hashgraph event.
 */
public class ShadowEvent {
     ...
     * @param otherParent the other-parent event's shadow
     */
    public ShadowEvent(
            final EventImpl event, final ShadowEvent selfParent, final ShadowEvent otherParent) {
        this.event = event;
    ...
    /**
     * The hash code of a shadow event is the Swirlds cryptographic base hash of the hashgraph event
     * which this shadow event references.
     *

...
/**
 * A trigger that accepts nine arguments.
 *
 ...
 */
@FunctionalInterface
public non-sealed interface TriggerNine<A, B, C, D, E, F, G, H, I>
        extends Trigger<TriggerNine<A, B, C, D, E, F, G, H, I>> {
     ...
     */
    void dispatch(A a, B b, C c, D d, E e, F f, G g, H h, I i);
}

...
/**
 * A trigger that accepts eight arguments.
 *
 ...
 */
@FunctionalInterface
public non-sealed interface TriggerEight<A, B, C, D, E, F, G, H>
        extends Trigger<TriggerEight<A, B, C, D, E, F, G, H>> {
     ...
     */
    void dispatch(A a, B b, C c, D d, E e, F f, G g, H h);
}

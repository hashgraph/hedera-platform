...
/** Sends dispatches for state signatures that have reached consensus. */
@FunctionalInterface
public interface PostConsensusStateSignatureTrigger
        extends TriggerFour<Long, Long, Hash, Signature> {

    /**
     * Signal that a tate signature transaction has reached consensus and is ready to be handled.
     *

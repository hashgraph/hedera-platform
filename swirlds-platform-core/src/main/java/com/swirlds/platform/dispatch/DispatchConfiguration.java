 ...
 *
 * @param flowchartEnabled if true then generate a visual flowchart showing the dispatch
 *     configuration of platform components
 * @param flowchartTriggerWhitelist a whitelist of trigger types when building the dispatch
 *     flowchart, ":" separated
 * @param flowchartTriggerBlacklist a blacklist of trigger types when building the dispatch
 *     flowchart, ":" separated
 * @param flowchartObjectWhitelist a whitelist of observer/dispatcher types when building the
 *     dispatch flowchart, ":" separated
 * @param flowchartObjectBlacklist a blacklist of observer/dispatcher types when building the
 *     dispatch flowchart, ":" separated
 */
@ConfigData("dispatch")

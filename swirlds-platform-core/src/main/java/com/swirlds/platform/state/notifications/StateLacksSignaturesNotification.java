...
/**
 * A {@link com.swirlds.common.notification.Notification Notification} that a signed state fails to
 * collect sufficient signatures before being ejected from memory. State is guaranteed to hold a
 * weak reservation until callback is finished.
 */

...
/**
 * A group of nodes in agreement about the hash for a particular round. If the network is ISS free
 * then there should be exactly one hash partition per round. If there has been an ISS then there
 * will be multiple hash partitions.
 */
public class HashPartition {
     ...
     *
     * @param hash the agreed upon hash
     */
     ...
     * @param stake the stake held by the node
     */
    ...
    /**
     * Get a set of nodes that are in agreement with this hash. This set should not be modified
     * externally.
     */

...
/**
 * A {@link com.swirlds.common.notification.Notification Notification} that a new {@link SignedState} is being
 * tracked by the {@link com.swirlds.platform.state.signed.SignedStateManager SignedStateManager}.
 */
public class NewSignedStateBeingTrackedNotification extends AbstractNotification {
	 ...
	 *
	 * @param signedState
	 * 		the state that was just signed by this node
	 * @param sourceOfSignedState
	 * 		the location where the signed state was obtained
	 * @param selfId
	 * 		the ID of this node
	 */

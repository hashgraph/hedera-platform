...
public final class AddressBookUtils {
    ...
    /**
     * Get the number of addresses currently in the address book that are running on this computer.
     * When the browser is run with a config.txt file, it can launch multiple copies of the app
     * simultaneously, each with its own TCP/IP port. This method returns how many there are.
     *

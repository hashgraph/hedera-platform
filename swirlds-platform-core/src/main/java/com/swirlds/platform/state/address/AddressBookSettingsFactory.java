...
public final class AddressBookSettingsFactory {
    ...
    /**
     * The default settings for address books. These defaults will only end up being used during
     * unit tests.
     */
    ...
    /**
     * Hook that {@code Browser#populateSettingsCommon()} will use to attach the instance of {@link
     * AddressBookSettings} obtained by parsing <i>settings.txt</i>.
     */

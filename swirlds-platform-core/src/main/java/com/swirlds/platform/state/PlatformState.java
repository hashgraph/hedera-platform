...
public class PlatformState extends PartialBinaryMerkleInternal implements MerkleInternal {
    ...
    /**
     * Generates a one-line summary of important fields from the <code>PlatformState</code>, meant
     * to be logged at the same time as a call to <code>MerkleHashChecker.generateHashDebugString()
     * </code>.
     */

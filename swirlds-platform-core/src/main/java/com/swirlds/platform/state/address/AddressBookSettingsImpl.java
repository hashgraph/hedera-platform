...
public class AddressBookSettingsImpl extends SubSetting implements AddressBookSettings {
    ...
    /**
     * If true, then don't change the working address book unless the network restarts with a higher
     * software version. Intermediate workaround until the platform is capable of handling an
     * address book that changes at runtime. This feature will be removed in a future version.
     */

...
/**
 * A {@link com.swirlds.common.notification.Notification Notification} that a signed state been self
 * signed. State is guaranteed to hold a weak reservation until callback is finished.
 */

...
public class PlatformData extends PartialMerkleLeaf implements MerkleLeaf {
     ...
     * modifications from all transactions that have reached consensus in a round less than or equal
     * to this value.
     */
    private long round;
    ...
    public void serialize(final SerializableDataOutputStream out) throws IOException {
        ...
        for (EventImpl event : events) {
            out.writeOptionalSerializable(
                    event, false, EventSerializationOptions.OMIT_TRANSACTIONS);
    ...
    /**
     * Get the number of consensus events that have been applied to this state since the beginning
     * of time.
     *
    ...
    /**
     * Set the number of consensus events that have been applied to this state since the beginning
     * of time.
     *
    ...
    /**
     * Get the running hash of all events that have been applied to this state since the begining of
     * time.
     *
    ...
    /**
     * Set the running hash of all events that have been applied to this state since the begining of
     * time.
     *
    ...
    /**
     * Get the consensus timestamp for this state, defined as the timestamp of the first transaction
     * that was applied in the round that created the state.
     *
    ...
    /**
     * Set the consensus timestamp for this state, defined as the timestamp of the first transaction
     * that was applied in the round that created the state.
     *

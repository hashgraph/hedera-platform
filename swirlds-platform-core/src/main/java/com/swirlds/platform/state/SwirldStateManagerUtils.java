...
public final class SwirldStateManagerUtils {
    ...
    /**
     * Performs a fast copy on a {@link State}. The {@code state} must not be modified during
     ...
     */
    public static TransThrottleSyncAndCreateRuleResponse shouldSyncAndCreate(
            final State consensusState) {

...
class APIUtils {
	 ...
	 */
	public static int writeVarint(long n, DataOutputStream dos)
			throws IOException {
			...
			if ((b & 0x80) == 0) { // if this is the last byte in the varint (msb is 0)
				if (count == 10 && b > 1) {
					throw new IOException(
							"the varint read has illegal format (more than 64 bits)");
				}
				break;
			}
			if (count == 10) {
				throw new IOException(
						"the varint read has illegal format (more than 10 bytes)");
			}
		}
	 ...
	 * 		if the stream throws this exception while writing to it
	 */
	public static int writeDurationSec(Duration duration, DataOutputStream dos)
			throws IOException {
	 ...
	 * 		if the stream throws this exception while writing to it
	 */
	public static int writeTimeSecRelative(Instant time, Instant reference,
	 ...
	 * 		if the stream throws this exception while writing to it
	 */
	public static int writeTimeNanoRelative(Instant time, Instant reference,
			DataOutputStream dos) throws IOException {
	 ...
	 * 		if the stream throws this exception while writing to it
	 */
	public static int writeTimeSec(Instant time, DataOutputStream dos)
			throws IOException {
	 ...
	 * 		if the stream throws this exception while writing to it
	 */
	public static int writeTimeNano(Instant time, DataOutputStream dos)
			throws IOException {
	 ...
	 */
	public static Duration readDurationSec(DataInputStream dis)
			throws IOException {
	 ...
	 * 		if the stream throws this exception while reading from it
	 */
	public static Duration readDurationNano(DataInputStream dis)
			throws IOException {
	 ...
	 * 		if the stream throws this exception while reading from it
	 */
	public static Instant readTimeSecRelative(Instant reference,
	 ...
	 * 		if the stream throws this exception while reading from it
	 */
	public static Instant readTimeNanoRelative(Instant reference,
			DataInputStream dis) throws IOException {

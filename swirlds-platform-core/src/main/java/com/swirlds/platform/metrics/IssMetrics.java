...
public class IssMetrics {
        ...
        issCountGauge =
                metrics.getOrCreate(
                        new IntegerGauge.Config(INTERNAL_CATEGORY, "issCount")
                                .withDescription(
                                        "the number of nodes that currently disagree with the"
                                                + " consensus hash"));

        issStakeGage =
                metrics.getOrCreate(
                        new LongGauge.Config(INTERNAL_CATEGORY, "issStake")
     ...
     * @param nodeId the ID of the node that submitted the hash

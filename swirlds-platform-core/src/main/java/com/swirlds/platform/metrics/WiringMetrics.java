...
public class WiringMetrics {
    ...
    /**
     * The size of the queue holding tasks for {@link
     * com.swirlds.platform.components.state.output.NewLatestCompleteStateConsumer}s
     */
    ...
    public WiringMetrics(final Metrics metrics) {
        asyncLatestCompleteStateQueueSize =
                new AverageAndMax(
                        ...
                        INTERNAL_CATEGORY,
                        "asyncLatestCompleteStateQueueSize",
                        "average number of new latest complete state occurrences waiting to be sent"
                                + " to consumers",
                        FORMAT_10_3,
    ...
    /**
     * Update the size of the task queue for {@link
     * com.swirlds.platform.components.state.output.NewLatestCompleteStateConsumer}s
     *
     * @param value the current size of the queue
     */

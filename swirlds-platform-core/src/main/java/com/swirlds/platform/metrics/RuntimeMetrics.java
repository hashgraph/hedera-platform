...
public final class RuntimeMetrics {
	...
	private static final FunctionGauge.Config<String> TIMESTAMP_CONFIG =
			new FunctionGauge.Config<>(INFO_CATEGORY,
					"time",
	...
	private static final FunctionGauge.Config<Long> DISKSPACE_FREE_CONFIG =
			new FunctionGauge.Config<>(INTERNAL_CATEGORY, "DiskspaceFree", ROOT_DIRECTORY::getFreeSpace)
					.withDescription("disk space being used right now")
					.withFormat("%d");
	private static final FunctionGauge.Config<Long> DISKSPACE_WHOLE_CONFIG =
			new FunctionGauge.Config<>(INTERNAL_CATEGORY, "DiskspaceWhole", ROOT_DIRECTORY::getTotalSpace)

...
public class SwirldStateSingleTransactionPool extends EventTransactionPool {
    ...
    /**
     * Creates a new transaction pool for tracking all transactions waiting to be put into an event
     * or to be applied to a state.
     *
     * @param settings settings to use
     * @param inFreeze Indicates if the system is currently in a freeze
     */
    public SwirldStateSingleTransactionPool(
            final SettingsProvider settings, final BooleanSupplier inFreeze) {
    ...
    public synchronized boolean submitTransaction(
        ...
        // In order to be submitted, the transaction must be a system transaction, or all the queues
        // must have room.
        ...
        final boolean ans =
                super.submitTransaction(transaction, priority)

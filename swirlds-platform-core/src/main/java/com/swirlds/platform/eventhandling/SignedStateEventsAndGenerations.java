 ...
 *
 * <p>NOTE: This class duplicates some logic that is contained within EventFlow. The plan is for
...
public class SignedStateEventsAndGenerations {
    ...
    public void expire() {
        ...
        // sometimes we will have events that have a round created lower than oldestNonAncientRound,
        // so we need to keep
        // more than the specified number of rounds. At other times, we might have round generation
        ...
        final long expireRoundsBelow =
                Math.min(oldestNonAncientRound, events.getMinRoundCreatedInQueue());

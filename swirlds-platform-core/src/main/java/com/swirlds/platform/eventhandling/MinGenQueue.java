...
public class MinGenQueue {
     ...
     * @param minGeneration the minimum generation of all famous witnesses for that round
     */
     ...
     *
     * @param pair a round/generation pair
     */
     ...
     *
     * @param maxRound the maximum round included in the list
     ...
     *
     * @param round the round queried
     * @return the round generation
     * @throws NoSuchElementException if the round is not in the queue
     */
     ...
     *
     * @param round the highest round to keep
     */

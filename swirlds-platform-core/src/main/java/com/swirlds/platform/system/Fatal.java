...
/**
 * Use the methods in this class to tear down the system. To be used in situations where things have
 * gone off the rails and automated recovery is not possible.
 *
 * @deprecated we are moving away from the static utility design pattern, use dispatches instead
 */

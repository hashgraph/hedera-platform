...
public class CryptoSettings extends SubSetting implements CryptographySettings {
    ...
    /**
     * Returns the password to be used to protected the PKCS12 key store containing the nodes RSA
     * key pairs. This method safely falls back on default values if no password was provided.
     *
    ...
    public String getKeystorePassword() {
        return (keystorePassword == null)
                ? CryptographySettings.DEFAULT_KEYSTORE_PASSWORD
                : keystorePassword;
    }
}

 ...
 */
public class DatabaseBackupSettings extends SubSetting {

	public boolean active = true;

	public String program = "/bin/bash";

	public String arguments = "${dataDir}/backup/pg_backup.sh ${dbConnection.host} ${dbConnection.port} " +
			"${dbConnection" +
			".userName} ${dbConnection.password} ${dbConnection.schema} ${snapshot.id} ${state.application} ${state" +
			".world} ${state.node} ${state.round}";

...
public final class RoundCalculationUtils {
     ...
     */
    public static long getOldestNonAncientRound(
            final int roundsNonAncient, final long lastRoundDecided) {
    ...
    public static long getMinGenNonAncient(
            ...
            final long lastRoundDecided,
            final LongUnaryOperator roundGenerationProvider) {
        ...
        return Math.max(
                roundGenerationProvider.applyAsLong(
                        getOldestNonAncientRound(roundsNonAncient, lastRoundDecided)),
     ...
     */
    public static long getMinGenNonAncient(
            final int roundsNonAncient, final SignedState signedState) {
        return getMinGenNonAncient(
                roundsNonAncient, signedState.getRound(), signedState::getMinGen);
    }
}

...
/**
 * Continuously runs protocol negotiation and protocols over connections supplied by the connection
 * manager
 */
public class NegotiatorThread implements InterruptableRunnable {
     ...
     * @param handshakeProtocols the list of protocols to execute when a new connection is
     *     established

...
public class TlsFactory implements SocketFactory {
    ...
    /**
     * Construct this object to create and receive TLS connections. This is done using the
     * trustStore whose reference was passed in as an argument. That trustStore must contain certs
     * for all the members before calling this constructor. This method will then create the
    ...
    @Override
    public ServerSocket createServerSocket(final byte[] ipAddress, final int port)
            throws IOException {

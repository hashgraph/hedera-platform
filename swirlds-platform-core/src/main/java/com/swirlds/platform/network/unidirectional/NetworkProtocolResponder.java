...
public interface NetworkProtocolResponder {
     ...
     *
     * @param initialByte the initial byte signifying the protocol type
     * @param connection the connection over which the protocol was initiated
     * @throws IOException if any connection issues occur
     * @throws NetworkProtocolException if any protocol execution issues occur

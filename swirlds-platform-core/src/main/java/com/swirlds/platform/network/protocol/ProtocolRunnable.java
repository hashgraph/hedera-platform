...
public interface ProtocolRunnable {
    /**
     * Run the protocol over the provided connection. Once the protocol is done running, it should
     * not leave any unread bytes in the input stream unless an exception is thrown. This is
     * important since the connection will be reused.
     *
     * @param connection the connection to run the protocol on

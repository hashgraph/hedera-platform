 ...
 *
 * @param initialByte the byte that start the protocol
 * @param protocolHandler the handler responsible for this protocol
 */
public record ProtocolMapping(byte initialByte, NetworkProtocolResponder protocolHandler) {
     ...
     *
     * @param initialByte the byte to map
     * @param protocolHandler the handler to map
     * @return the new mapping
     */
    public static ProtocolMapping map(
            final byte initialByte, final NetworkProtocolResponder protocolHandler) {

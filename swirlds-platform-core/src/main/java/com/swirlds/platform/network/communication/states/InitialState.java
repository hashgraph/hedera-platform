...
public class InitialState extends NegotiationStateWithDescription {
     ...
     * @param byteOutput the stream to write to
     * @param stateSentKeepalive the state to transition to if we send a keepalive
     * @param stateSentInitiate the state to transition to if we initiate a protocol
     */
    public InitialState(

...
/**
 * Manages a connection that is initiated by this node. If the connection in use is broken, it will
...
public class OutboundConnectionManager implements ConnectionManager {
    ...
    public OutboundConnectionManager(
            final NodeId peerId, final OutboundConnectionCreator connectionCreator) {
        this.peerId = peerId;

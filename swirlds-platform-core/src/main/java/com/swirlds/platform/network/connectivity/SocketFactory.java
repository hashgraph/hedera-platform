...
public interface SocketFactory {
     ...
     * @param settings the settings for configuration
    ...
    static void configureAndBind(
        ...
        if (isIpTopInRange(settings.getSocketIpTos())) {
            ...
            serverSocket.setOption(
                    java.net.StandardSocketOptions.IP_TOS, settings.getSocketIpTos());
        }
    ...
    static void configureAndConnect(
        ...
        clientSocket.connect(
                new InetSocketAddress(ipAddress, port), settings.getTimeoutSyncClientConnect());
    }

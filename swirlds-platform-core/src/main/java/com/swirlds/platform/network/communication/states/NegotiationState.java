...
public interface NegotiationState {
     ...
     * @throws NegotiationException if an issue occurs during negotiation
     * @throws NetworkProtocolException if a protocol is negotiated and issue occurs while running
     *     it
     * @throws InterruptedException if the thread running this is interrupted
     * @throws IOException if an IO error occurs with the connection used
     */

...
/**
 * Listen for incoming network protocol requests then calls the handler. If it does not have a
 * connection, or the connection is closed, it will block waiting for a new connection.
 */
public class Listener implements InterruptableRunnable {
    ...
    public Listener(
            final NetworkProtocolResponder protocolHandler,

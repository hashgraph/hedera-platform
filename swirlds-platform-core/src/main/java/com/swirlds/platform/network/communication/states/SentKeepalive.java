...
public class SentKeepalive extends NegotiationStateWithDescription {
     ...
     * @param sleep the sleep state to transition to if the peers also sends a keepalive
     * @param receivedInitiate the state to transition to if the peer sends an initiate
     */

...
public class OutboundConnectionCreator {
     ...
     * @return the new connection, or a connection that is not connected if it couldn't connect on
     *     the first try
     */
    public Connection createConnection(final NodeId otherId) {
        ...
        try {
            ...
            dos =
                    SyncOutputStream.createSyncOutputStream(
            ...
            LOG.debug(
                    ...
                    otherId,
                    e);
            // ConnectException (which is a subclass of SocketException) happens when calling
            // someone
            // who isn't running yet. So don't worry about it.
            // Also ignore the other socket-related errors (SocketException) in case it times out
            // while
            // connecting.

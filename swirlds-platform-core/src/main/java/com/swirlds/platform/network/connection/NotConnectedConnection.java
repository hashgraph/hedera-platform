...
/**
 * An implementation of {@link Connection} that is used to avoid returning null if there is no
 * connection. This connection will never be connected and will do nothing on disconnect. All other

...
public interface CycleMetrics {
     ...
     *
     * @param interval the index of the interval that ended
     * @param durationNanos the number of nanoseconds the interval took to complete
     */
     ...
     *
     * @param intervalNanoTime the time in nanoseconds spent on each interval
     */
     ...
     *
     * @param nanoTime the time in nanoseconds spent idle
     */

...
public class AtomicAverage {
    ...
    /**
     * @param weight the weight that the latest value has on the average. 0 &lt; weight &lt; 1
     * @param uninitializedValue the value to return before any values are added to the average
     * @throws IllegalArgumentException if the weight constraints are not met
     */
    ...
    /**
     * Same as {@link #AtomicAverage(double, double)} with uninitializedValue set to {@link
    ...
    /**
     * Returns the average stored. If no values were provided, it will return the uninitializedValue
     * provided in the constructor. If the average is updated only once, it will return the value it
     * was updated with.
     *

        ...
        instructions.setText(
                wrap(
                        ...
                        "\n\n"
                            ...
                            + " shared ledgers, shared databases). Under each swirld is all of the"
                            + " known members using this local machine. Each one that is currently"
                            + " active is marked as \"running\". Click on a member to show their"
                            + " information in all the tabs here. Minimize this window to hide it."
                            + " Close it to quit the entire program."));
        freeze(instructions);
    }

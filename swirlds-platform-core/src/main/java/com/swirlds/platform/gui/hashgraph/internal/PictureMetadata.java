...
public class PictureMetadata {
    /**
     * the gap between left side of screen and leftmost column is marginFraction times the gap
     * between columns (and similarly for right side)
     */
    ...
    public PictureMetadata(
        ...
        final int height2 =
                (int) (pictureDimension.getHeight() - height1); // the main display, below the text
    ...
    public int xpos(final PlatformEvent e1, final PlatformEvent e2) {
        ...
        // gap between columns
        final int betweenGap =
                (int) (width / (addressBookMetadata.getNumColumns() - 1 + 2 * marginFraction));

...
public interface HashgraphPictureOptions {
    ...
    /**
     * When {@link #displayLatestEvents()} is true, this method will be called to notify which is
     * the current starting generation
     *
     * @param startGeneration the first generation being displayed
     */

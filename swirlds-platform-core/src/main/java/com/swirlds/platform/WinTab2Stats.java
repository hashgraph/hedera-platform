    ...
    void prePaint() {
        ...
        instructions.setText(
                Utilities.wrap(
                        50,
                        "" //
                                + "The table shows various statistics about how the sytem is"
                                + " running. " //
                                + "Click on a white square to plot the history of the statistic."
                                + " " //
                                + "Click on a highlighted square to hide that plot. \n\n" //
                                + "Each plot shows history divided into periods. Within one period,"
                                + " the blue line goes through " //
                                + "the average value during that period. The light gray box shows"
                                + " the min and max value during " //
                                + "that period. The dark gray box shows one standard deviation"

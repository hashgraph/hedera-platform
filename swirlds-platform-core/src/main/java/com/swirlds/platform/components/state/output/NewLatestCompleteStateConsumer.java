 ...
 *
 * <p>The state within the {@link SignedStateWrapper} holds a strong reservation. The wiring layer
 * releases the {@link SignedStateWrapper} after all consumers have completed.
 */
@FunctionalInterface

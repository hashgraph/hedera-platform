 ...
 *
 * <ul>
 *   <li>Managing signed states in memory
 *   <li>Writing signed states to disk
 *   <li>Producing signed state signatures
 *   <li>Collecting signed state signatures
 *   <li>Making certain signed states available for queries
 *   <li>Finding signed states compatible with an emergency state
 * </ul>
 */
public interface StateManagementComponent
    ...
    /**
     * Get the latest signed states stored by this component. This method creates a copy, so no

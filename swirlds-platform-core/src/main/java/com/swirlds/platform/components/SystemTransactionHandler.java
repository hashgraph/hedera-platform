...
public interface SystemTransactionHandler {
     ...
     *
     * @param event the pre-consensus event with 0 or more system transactions to handle
     */
     ...
     *
     * @param round the round of events with 0 or more system transactions to handle
     */

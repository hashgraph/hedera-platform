...
public class DefaultStateManagementComponentFactory implements StateManagementComponentFactory {
    ...
    @Override
    public StateManagementComponentFactory stateToDiskConsumer(
            final StateToDiskAttemptConsumer consumer) {
    ...
    @Override
    public StateManagementComponentFactory stateLacksSignaturesConsumer(
            final StateLacksSignaturesConsumer consumer) {
        this.stateLacksSignaturesEventConsumer = consumer;
        return this;
    }

    @Override
    public StateManagementComponentFactory newCompleteStateConsumer(
    ...
    @Override
    public StateManagementComponentFactory haltRequestedConsumer(
            final HaltRequestedConsumer consumer) {

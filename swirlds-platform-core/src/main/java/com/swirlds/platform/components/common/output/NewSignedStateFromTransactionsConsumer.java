...
public interface NewSignedStateFromTransactionsConsumer {
    ...
    /**
     * A new signed state has been created. The state holds a single strong reservation. It is the
     * responsibility of the consumer to release the reservation when appropriate.
     *

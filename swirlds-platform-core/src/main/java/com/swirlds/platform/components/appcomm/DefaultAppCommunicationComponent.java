...
public class DefaultAppCommunicationComponent implements AppCommunicationComponent {
    ...
    public void stateToDiskAttempt(
            final SignedStateWrapper signedStateWrapper,
    ...
    public void newLatestCompleteStateEvent(final SignedStateWrapper signedStateWrapper) {
        ...
        notificationEngine.dispatch(
                NewSignedStateListener.class, notification, r -> signedState.releaseState());
    }

    @Override
    public void iss(
            final long round, final IssNotification.IssType issType, final Long otherNodeId) {

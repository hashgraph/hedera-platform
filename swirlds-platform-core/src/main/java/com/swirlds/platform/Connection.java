...
public interface Connection {
    ...
    /**
     * Is there currently a valid connection from me to the member at the given index in the address
     * book?
     *
     * <p>If this method returns {@code true}, the underlying socket is guaranteed to be non-null.
     *
     ...
     *
     * @param timeoutMillis The timeout value to set in milliseconds. A value of zero is treated as
     *     an infinite timeout.
     * @throws SocketException if there is an error in the underlying protocol, such as a TCP error.
     */
    ...
    /**
     * Is this an outbound or an inbound connection. For outbound connections, we initiate the
     * creation of the connection, as well as all communication (sync, heartbeat, reconnect). The
     * reverse is true for inbound connections.
     *

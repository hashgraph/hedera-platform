...
public final class EventStrings {
    ...
    /**
     * A string representation of an event in the following format: {@code (creatorID, generation,
     * shortHash)}
     *
    ...
    /**
     * A string representation of an event in the following format: {@code (creatorID, generation,
     * shortHash) sp(creatorID, selfParentGeneration, selfParentShortHash) op(otherParentID,
     * otherParentGeneration, otherParentShortHash)}
     *
     * @param event the event to convert to a string

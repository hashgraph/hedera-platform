...
/**
 * A wrapper for an iterator that allows the exposed type to be a super type of the iterator
 * provided.
 *
 * <p>Support for {@link #remove()} is the same as the iterator provided.
 *
 * @param <T> the type to expose to callers
 */

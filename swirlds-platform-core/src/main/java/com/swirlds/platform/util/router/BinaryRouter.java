...
public class BinaryRouter<T> {
	...
	/**
	 * @param test
	 * 		determines which consumer each object is routed to
	 * @param trueConsumer
	 * 		consumer of objects that pass the {@code test}
	 * @param falseConsumer
	 * 		consumer of objects that fail the {@code test}
	 * @param continueSupplier
	 * 		determines if more objects should be retrieved and routed
	 * @param nextSupplier
	 * 		supplied the next object to be routed
	 */
	public BinaryRouter(
	...
	/**
	 * Read all objects from the supplier and route them to the appropriate consumer. Null objects are discarded.
	 */
	public void route() {

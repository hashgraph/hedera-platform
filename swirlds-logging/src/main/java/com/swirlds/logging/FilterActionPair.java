...
public class FilterActionPair<T> {
     ...
     * Create a new pair.
     *
     * @param filter the filter to be checked. If the predicate returns true then the entry is
     *     allowed to pass, otherwise it is rejected. If null then all entries are considered to
     *     pass the filter.
     * @param action the action to perform if an event passes the filter.
     */
     ...
     *
     * @param entry the entry that is being handled
     */

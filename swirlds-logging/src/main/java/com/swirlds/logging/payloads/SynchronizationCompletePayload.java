...
public class SynchronizationCompletePayload extends AbstractLogPayload {
     ...
     *
     * @param timeInSeconds the time required to transmit the state
     * @return this object
     */
     ...
     *
     * @param hashTimeInSeconds the time required to hash the state
     * @return this object
     */
     ...
     *
     * @param initializationTimeInSeconds the time required to initialize the state
     * @return this object
     */
    public SynchronizationCompletePayload setInitializationTimeInSeconds(
            double initializationTimeInSeconds) {
     ...
     *
     * @param totalNodes the number of nodes sent during synchronization
     * @return this object
     */
     ...
     *
     * @param leafNodes the number of leaf nodes sent during synchronization
     * @return this object
     */
    ...
    /**
     * Get the total number of merkel leaf nodes that were sent unnecessarily during
     * synchronization.
     */
    ...
    /**
     * Set the total number of merkel leaf nodes that were sent unnecessarily during
     * synchronization.
     *
     * @param redundantLeafNodes the number of redundant leaf nodes sent
     * @return this object
     */
     ...
     *
     * @param internalNodes the number of internal nodes sent
     * @return this object
     */
    ...
    /**
     * Get the total number of internal merkle nodes that were sent unnecessarily during
     * synchronization.
     */
    ...
    /**
     * Set the total number of internal merkle nodes that were sent unnecessarily during
     * synchronization.
     *
     * @param redundantInternalNodes the number of redundant internal nodes
     * @return this object
     */

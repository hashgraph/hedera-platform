...
public class PlatformStatusPayload extends AbstractLogPayload {
    ...
    /**
     * @param message the message in this payload
     * @param oldStatus the original status of the platform
     * @param newStatus the new status of the platform
     */
    public PlatformStatusPayload(
            final String message, final String oldStatus, final String newStatus) {
        super(message);

...
public class ReconnectStartPayload extends AbstractLogPayload {
     ...
     * @param receiving if true then this node is the receiver, i.e. it is the one attempting to
     *     reconnect. If false then this node is the sender and is helping another node to
     *     reconnect.
     * @param nodeId this node's ID
     * @param otherNodeId the other node's ID
     * @param round the latest signed round known by this node
     */
    public ReconnectStartPayload(

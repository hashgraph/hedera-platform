...
public class ActiveStateThresholdPayload extends AbstractLogPayload {
     ...
     * @param thresholdCategory a string describing the threshold that was violated
     * @param currentValue the value of the metric that exceeded its threshold
     * @param maximumAllowable the value of the threshold that was violated
     */
    public ActiveStateThresholdPayload(

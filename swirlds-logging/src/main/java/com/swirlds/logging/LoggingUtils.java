...
public final class LoggingUtils {
     ...
     * @param singular the singular version of the word, e.g. "goose"
     * @param plural the plural version of the word, e.g. "geese"
    ...
    /**
     * Choose between a singular and plural word depending on the count. For words that can be made
     * plural by adding an "s" to the end.
     *
     * @param count the count of objects
     * @param singular the singular version of the word, e.g. "dog"
     * @return the correct form of the word given the count
     */

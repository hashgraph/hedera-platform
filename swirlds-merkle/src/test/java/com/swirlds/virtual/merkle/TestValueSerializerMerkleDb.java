...
public class TestValueSerializerMerkleDb implements ValueSerializer<TestValue> {
    ...
    @Override
    public int serialize(final TestValue data, final SerializableDataOutputStream outputStream)
            throws IOException {
    ...
    @Override
    public TestValue deserialize(final ByteBuffer buffer, final long dataVersion)
            throws IOException {

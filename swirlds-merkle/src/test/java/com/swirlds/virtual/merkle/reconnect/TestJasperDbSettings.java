...
public class TestJasperDbSettings implements JasperDbSettings {

    private final JasperDbSettings defaultSettings;

    /** Create settings that use another as default. Individual settings can be overridden. */
    public TestJasperDbSettings(final JasperDbSettings defaultSettings) {

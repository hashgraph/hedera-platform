 ...
 */
public class MerkleMapEntrySetIterator<K, V extends MerkleNode & Keyed<K>>
     ...
     * Constructor
     *
     * @param hashMapIterator the iterator from the FCHashMap which belongs to the MerkleMap
     */
    ...
    /**
     * The remove() operation is unsupported, due to the complexity of removing elements from the
     * MerkleMap while iterating over the FCHashMap
     *

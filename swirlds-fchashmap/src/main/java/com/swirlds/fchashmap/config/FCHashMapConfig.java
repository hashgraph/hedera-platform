 ...
 *
 * @param maximumGCQueueSize the maximum expected size of the FCHashMapGarbageCollector's queue.
 * @param gCQueueThresholdPeriod the amount of time that must pass between error logs about the
 *     FCHashMapGarbageCollector's queue size.
 * @param archiveEnabled is the archival of FCHashMap enabled?
 */

...
public class FCOneToManyRelationIterator<K, V> implements Iterator<V> {
     ...
     *
     * @param associationMap the map containing all associations
     * @param key the key whose values will be iterated
     * @param startIndex the index where iteration starts (inclusive)
     * @param endIndex the index where iteration ends (exclusive)
     */

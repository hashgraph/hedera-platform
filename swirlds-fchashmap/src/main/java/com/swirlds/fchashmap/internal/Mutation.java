...
public class Mutation<V> {
    ...
    /**
     * The previous mutation in the linked list, or null if this mutation is the oldest unreleased
     * mutation.
     */
     ...
     *
     * @param value the value of the mutation, or null if this mutation should signify a deletion
     */
    ...
    /**
     * Get the version of the {@link com.swirlds.fchashmap.FCHashMap FCHashMap} when this mutation
     * was created.
     *

...
public class BenchmarkKeySerializer implements KeySerializer<BenchmarkKey> {
    ...
    public boolean equals(
            final ByteBuffer buffer, final int dataVersion, final BenchmarkKey keyToCompare)
            throws IOException {
    ...
    @Override
    public int serialize(final BenchmarkKey key, final SerializableDataOutputStream outputStream)
            throws IOException {
    ...
    public void deserialize(
            SerializableDataInputStream serializableDataInputStream, int dataVersion)
            throws IOException {}

...
public final class BenchmarkSettings {
    ...
    private static final Logger LOG = LogManager.getLogger(BenchmarkSettings.class);
    ...
    private static void loadSettings() {
        ...
        try {
            ...
            LOG.error("Can't read {}: {} ", settingsPath, e);
            return;
        }

        LOG.info("Reading settings from file:        {}", settingsPath);
    ...
    private static boolean handleSetting(final String[] pars) {
        ...
        if (field != null && !Modifier.isFinal(field.getModifiers())) {
            try {
                ...
                LOG.error("illegal line in {}: {}, {}  {}", settingsPath, pars[0], pars[1], e);
            }
        }

        if (!good) {
            LOG.warn("{} is not a valid setting name", pars[0]);
            return false;
        }
        return true;
    }

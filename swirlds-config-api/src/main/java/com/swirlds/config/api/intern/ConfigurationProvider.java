...
/**
 * This class is the only private API of the config API that is used to load an implementation of
 * the config API by using the Java SPI (see {@link ServiceLoader}).
 */
public final class ConfigurationProvider {
    ...
    /**
     * This method is the facade against an implementation of the config API. The method returns a
     * new {@link ConfigurationBuilder} instance that is created by a concrete implementation.
     *

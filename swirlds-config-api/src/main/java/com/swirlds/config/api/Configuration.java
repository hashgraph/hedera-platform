...
/**
 * Central interface to provide configuration properties. The API provides different methods how
...
public interface Configuration {
    ...
    /**
     * Returns the {@link String} value of the property with the given name or the given default
     ...
     * @return the value of the property
     * @throws NoSuchElementException if the property does not exist.
     * @throws IllegalArgumentException if the raw {@code String} value of the property can not be
    ...
    /**
     * Returns the value of the property with the given name or the given default value if the
    ...
    /**
     * Returns a {@link List} of elements of the property with the given name or the given default
     * {@link List}
     *
     * @param propertyName the name of the property
     * @param propertyType the type of the elements
     * @param defaultValue the default {@link List}
     * @param <T> the generic type of the elements
     * @return a {@link List} of elements of the property with the given name or the given default
     *     list
     * @throws IllegalArgumentException if the raw {@link String} value of the property can not be
     *     converted to a list or the given type
     */
    ...
    /**
     * Returns a config data object of the given type. This is used to provide an object-oriented
     * construct for accessing config properties for a specific usecase. By doing so all
     * configuration values for a specific service can for example be stored in an immutable record
     * instance that is used to access the values.
     *
     * <p>The given type defines the {@link Record} that defines the config properties. The
     * annotations {@link ConfigData} and {@link ConfigProperty} can be used in the record
     * definition to specify the names and default values of properties.The result of this method is
     * an instance of the given {@link Record} that provides the values for all properties that are
     * specified in the record definition.
     *
     * @param type type of the record
     * @param <T> type of the record
     * @return instance of the record that contains the config values for all config properties that
     *     are defined in the record definition.
     */
    <T extends Record> T getConfigData(Class<T> type);

    /**
     * Returns all types that are registered as config data types (see {@link
     * #getConfigData(Class)}).
     *

...
/**
 * Base class for all event emitters. Contains a {@link GraphGenerator} from which events are
 * emitted according to subclass implementations.
 *
 * @param <T> the type of class extending this class
 */
public abstract class AbstractEventEmitter<T extends AbstractEventEmitter<T>>

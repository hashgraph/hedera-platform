...
/**
 * This event emitter wraps another event emitter. It emits the exact same events as the inner
 * emitter, but also keeps a list of all emitted events that can be retrieved later.
 */

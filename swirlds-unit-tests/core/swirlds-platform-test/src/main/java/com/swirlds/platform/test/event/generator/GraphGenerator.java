 ...
 *
 * @param <T> the concrete type of this {@link GraphGenerator}
 */
public interface GraphGenerator<T extends GraphGenerator<T>> {
     ...
     *
     * <p>Note: if this generator has emitted a large number of events, this method may be
     * expensive. The copied generator needs to skip all events already emitted.
     */
    default T copy() {
    ...
    /**
     * Reset this generator to its original state. Does not undo settings changes, just the events
     ...
     *
     * @param creatorId the event creator

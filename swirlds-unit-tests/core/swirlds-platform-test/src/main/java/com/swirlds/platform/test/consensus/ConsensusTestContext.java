...
/**
 * A type which defines the contextual data for a single consensus test. This is the type that runs
 * a test sequence. It encapsulates an {@link GraphGenerator}, a list of {@link NodeContext}s, and a
 * system PRNG.
 */
public class ConsensusTestContext {
     ...
     *
     * @param sequence a specification for sequence of tests to run
     */
     ...
     */
    public void restartAllNodes(final Path stateDir)

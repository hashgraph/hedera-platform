...
public class TestIntake
        implements ConsensusRoundObserver, StaleEventObserver, LoadableFromSignedState {
    ...
    public TestIntake(final AddressBook ab, final BiConsumer<Long, Long> minGenConsumer) {
        ...
        consensus = new ConsensusImpl(ConsensusUtils.NOOP_CONSENSUS_METRICS, minGenConsumer, ab);
        shadowGraph = new ShadowGraph(mock(SyncMetrics.class));
        final ParentFinder parentFinder = new ParentFinder(shadowGraph::hashgraphEvent);
        final EventLinker linker = new InOrderLinker(parentFinder, l -> null);
    ...
    public void loadFromSignedState(final SignedState signedState) {
        consensus =
                new ConsensusImpl(
                        ConsensusUtils.NOOP_CONSENSUS_METRICS, minGenConsumer, ab, signedState);
        shadowGraph.clear();

...
public class ForkingEventSource extends AbstractEventSource<ForkingEventSource> {
    ...
    /**
     * For any particular event, the probability (out of 1.0) that the event will start a new forked
     * branch.
     */
     ...
     *
     * <p>Undefined behavior if set after events have already been generated.
     *
     * @return this
     */
    ...
    /**
     * Fork. This creates a new branch, replacing a random branch if the maximum number of branches
     * is exceeded.
     */

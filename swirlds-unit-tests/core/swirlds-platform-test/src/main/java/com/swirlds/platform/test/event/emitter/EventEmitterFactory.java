...
public class EventEmitterFactory {
    ...
    /**
     * Seed used for the standard generator. Must be same for all instances to ensure the same
     * events are generated for different instances. Differences in the graphs are managed in other
     * ways and are defined in each test.
     */
    ...
    /**
     * Creates a new {@link ShuffledEventEmitter} with a {@link StandardGraphGenerator} using {@link
     * StandardEventSource} that uses real hashes.
     *
    ...
    /**
     * Creates a new {@link ShuffledEventEmitter} with a {@link StandardGraphGenerator} using {@link
     * ForkingEventSource} that uses real hashes.
     *
    ...
    public ShuffledEventEmitter newForkingShuffledGenerator() {
        ...
        sourceFactory.addCustomSource(
                index -> index < maxNumForkingSources, EventSourceFactory::newForkingEventSource);
    ...
    private StandardGraphGenerator newStandardGraphGenerator(

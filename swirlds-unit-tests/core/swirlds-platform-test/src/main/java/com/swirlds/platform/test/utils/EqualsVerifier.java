...
public final class EqualsVerifier {
    ...
    public static GossipEvent randomGossipEvent(final RandomGenerator r) {
        final GossipEvent data =
                new GossipEvent(randomBaseEventHashedData(r), randomBaseEventUnhashedData(r));
    ...
    public static BaseEventHashedData randomBaseEventHashedData(final RandomGenerator r) {
        ...
        final BaseEventHashedData data =
    ...
    private static <R> List<R> generateObjects(
            final Function<RandomGenerator, R> supplier, final long[] seeds) {
     ...
     *
     * @param original an instance of type R
     * @param copy an equal instance of type R
     * @param other a different instance of type R
     * @param <R> arbitrary type
     * @return true if all checks pass
     */
    private static <R> boolean verifyEqualsHashCode(
     ...
     *
     * @param supplier predefined supplier of random instances of type R
     * @param <R> arbitrary type
     * @return true if all checks pass
     */
     ...
     * @param copy an equal instance of type R
     * @param other a different instance of type R
     * @param <R> arbitrary type implementing Comparable
     * @return true if all checks pass
     */
     ...
     * @return true if all checks pass
     */
    public static <R extends Comparable<R>> boolean verifyComparable(
            final Function<RandomGenerator, R> supplier) {
        final List<R> list = generateObjects(supplier, new long[] {1, 1, 2}); // NOSONAR
        return verifyEqualsHashCode(list.get(0), list.get(1), list.get(2)) // NOSONAR

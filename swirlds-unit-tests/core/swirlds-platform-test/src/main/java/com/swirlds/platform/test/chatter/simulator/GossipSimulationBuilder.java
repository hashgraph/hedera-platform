...
public class GossipSimulationBuilder {
    ...
    /**
     * The connection status between specific nodes, overrides default. True = connected, false =
     * disconnected.
     */
    ...
    private long seed = 0;
    /**
     * If set to true then print extra debug information to the console. Quite spammy for large
     * simulations.
     */
    private boolean debugEnabled = false;
    /**
     * The maximum number of messages that may be enqueued at a destination before messages start
     * throttled.
     */
    ...
    /**
     * The number of threads to use when simulating. If unset, creates one thread per node. Does not
     * influence result of the simulation.
     */
     ...
     *
     * @param outgoingBandwidthDefault the default outgoing bandwidth
     * @return this object
     */
    ...
    /**
     * Get the outgoing bandwidth for a particular node. If no bandwidth has been specified then the
     * default is used.
     *
     ...
     * @param outgoingBandwidth the node's new bandwidth in bytes/second
     * @return this object
     */
    public GossipSimulationBuilder setOutgoingBandwidth(
            final Long nodeId, final long outgoingBandwidth) {
     ...
     *
     * @param incomingBandwidthDefault bandwidth in bytes/second
     * @return this object
     */
    public GossipSimulationBuilder setIncomingBandwidthDefault(
            final long incomingBandwidthDefault) {
     ...
     *
     * @param nodeId the destination node
     * @param incomingBandwidth bandwidth in bytes/second
     * @return this object
     */
    public GossipSimulationBuilder setIncomingBandwidth(
            final long nodeId, final long incomingBandwidth) {
     ...
     *
     * @param averageEventsCreatedPerSecondDefault the default value
     * @return this object
     */
    ...
    public double getAverageEventsCreatedPerSecond(final long nodeId) {
        return averageEventsCreatedPerSecondMap.getOrDefault(
                nodeId, averageEventsCreatedPerSecondDefault);
    }

    /**
     * Set the average number of events created per second for a particular node. Overrides the
     * default.
     *
     * @param nodeId the node in question
     * @param averageEventsCreatedPerSecondAverage the node's average number of events per second
     * @return this object
     */
     ...
     *
     * @param averageEventSizeInBytes the average event size
     * @return this object
     */
    public GossipSimulationBuilder setAverageEventSizeInBytes(
            final double averageEventSizeInBytes) {
     ...
     *
     * @param eventSizeInBytesStandardDeviation the standard deviation
     * @return this object
     */
     ...
     *
     * @param latencyDefault the default latency
     * @return this object
     */
     ...
     *
     * @param source the source node for a message
     * @param destination the destination node for a message
    ...
    public Duration getLatency(final Long source, final long destination) {
        return latencyMap.getOrDefault(
                new SourceDestinationPair(source, destination), latencyDefault);
    }
     ...
     * @param source the source node for a message
     * @param destination the destination node for a message
     * @param latency the time required for a message to travel from the source to the destination
     * @return this object
     */
    public GossipSimulationBuilder setLatency(
            final long source, final long destination, final Duration latency) {
     ...
     * Set debug mode.
     *
     * @param debugEnabled true if debug mode should be enabled, false if it should be disabled
     * @return this object
     */
    ...
    /**
     * Get the maximum number of incoming messages that may be enqueued at a node before messages
    ...
    /**
     * Set the maximum number of incoming messages that may be enqueued at a node before messages
     * start getting dropped.
     *
     * @param incomingMessageQueueSize the queue size
     * @return this object
     */
     ...
     *
     * @param csvGenerationEnabled true if CSV generation is enabled
     * @return this object
     */
     ...
     *
     * @param timeReportPeriod the period between time reports, if null then time is never reported
     * @return this object
     */
     ...
     *
     * @param dropProbabilityDefault a probability as a fraction of 1.0
     * @return this object
     */
     ...
     *
     * @param source the sending node ID
     * @param destination the receiving node ID
     * @param dropProbability a probability as a fraction of 1.0
     * @return this object
     */
     ...
     *
     * @param source the sending node
     * @param destination the receiving node
     * @return a probability as a fraction of 1.0
     */
    public double getDropProbability(final long source, final long destination) {
        return dropProbabilityMap.getOrDefault(
                new SourceDestinationPair(source, destination), dropProbabilityDefault);
    }
     ...
     *
     * @param connectionStatusDefault true = connected, false = disconnected
     * @return this object
     */
    public GossipSimulationBuilder setConnectionStatusDefault(
            final boolean connectionStatusDefault) {
     ...
     *
     * @param source the source of a message
     * @param destination the destination of a message
     * @param connectionStatus true if the source can send a message to the destination
     * @return this object
     */
    ...
    /**
     * @param chatterFactory factory for constructing {@link SimulatedChatter} instances
     * @return this object
     */
    ...
    /**
     * @param singleThreaded whether to run the simulation in a single thread
     * @return this object
     */

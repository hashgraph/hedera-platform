 ...
 *
 * @param <X> the type of the x-coordinate value
 * @param <Y> the type of the y-coordinate value
 */
public class TimingGridGraph<X extends Comparable<X>, Y extends Comparable<Y>>
        extends GridGraph<X, Y> {
    ...
    /**
     * Construct a TimingGridGraph from a test panel name and axis label strings. The values are
     * string-ized using the default format specifier
     *
     * @param graphName the test panel name
     ...
     * @param xAxisLabel the x-axis label
     * @param yAxisLabel the y-axis label
     * @param formatSpec the format specifier, applied to every grid value
     */
    protected TimingGridGraph(
    ...
    /**
     * Construct a new Promise instance for one value entry, which will hold a timing value when
     * either its `stop` or `close` method is called.
     *
     * @param x the x-coordinate of the value current being generated
     * @param y the y-coordinate of the value current being generated
     ...
     * @param <Y> the type of the y-coordinate value
     */
    public static class Promise<X extends Comparable<X>, Y extends Comparable<Y>>
         ...
         *
         * @param parent the grid graph to update
         * @param x the x-coordinate of the value current being generated
         * @param y the y-coordinate of the value current being generated
         */

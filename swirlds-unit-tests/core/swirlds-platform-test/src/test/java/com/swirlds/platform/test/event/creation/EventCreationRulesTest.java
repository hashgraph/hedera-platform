...
class EventCreationRulesTest {
    ...
    private static final ParentBasedCreationRule CREATE_2 =
            (s, o) -> EventCreationRuleResponse.CREATE;
    private static final ParentBasedCreationRule DONT_2 =
            (s, o) -> EventCreationRuleResponse.DONT_CREATE;

    private static void check(
            final EventCreationRules rules, final EventCreationRuleResponse expectedResponse) {
    ...
    void pass() {
        check(
                List.of(PASS_1, PASS_1, PASS_1),
                List.of(PASS_2, PASS_2),
    ...
    void create() {
        check(
                List.of(PASS_1, CREATE_1, PASS_1),
                List.of(CREATE_2, PASS_2),
                EventCreationRuleResponse.CREATE);
    }

    @Test
    void dontCreate() {
        check(
                List.of(PASS_1, PASS_1, DONT_1),
                List.of(DONT_2, PASS_2),
    ...
    void nullOtherParent() {
        Assertions.assertEquals(
                EventCreationRuleResponse.DONT_CREATE,
                StaticCreationRules.nullOtherParent(null, null));
        Assertions.assertEquals(
                EventCreationRuleResponse.PASS,

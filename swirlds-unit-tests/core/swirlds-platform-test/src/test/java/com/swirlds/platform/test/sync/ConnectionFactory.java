...
public interface ConnectionFactory {
    ...
    static Pair<Connection, Connection> createLocalConnections(
            final NodeId nodeA, final NodeId nodeB) throws IOException {
    ...
    static Pair<Connection, Connection> createSocketConnections(
            final NodeId nodeA, final NodeId nodeB) throws IOException {
    ...
    Pair<Connection, Connection> createConnections(final NodeId nodeA, final NodeId nodeB)
            throws IOException;
}

...
public class GridGraphResult<X extends Comparable<X>, Y extends Comparable<Y>>
     ...
     * @param value the value with the given coordinates
     */
     ...
     * @param y the y-coordinate
     * @param value the value with the given coordinates
     * @param formatSpec the string format specifier
     */
    protected GridGraphResult(final X x, final Y y, final Object value, final String formatSpec) {
        ...
        this.value = value;
        this.formatSpec =
                (formatSpec == null || formatSpec.isBlank()) ? DEFAULT_FORMAT_SPEC : formatSpec;
    }
    ...
    public int compareTo(final GridGraphResult<X, Y> o) {
        ...
        return new CompareToBuilder().append(getX(), o.getX()).append(getY(), o.getY()).build();
    }

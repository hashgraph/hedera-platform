...
public class GridTest<X extends Comparable<X>, Y extends Comparable<Y>>
     ...
     *
     * @param graphName the name of the graph (typically the name of the property to be displayed)
     * @param xAxisLabel the x-axis label
     * @param yAxisLabel the y-axis label
     * @param valueLabel the name of the value
     * @return a GridGraph
     */
    public GridGraph<X, Y> graphFor(
        ...
        return graphs.computeIfAbsent(
                graphName, (n) -> new GridGraph<>(n, xAxisLabel, yAxisLabel, valueLabel));
    }
    ...
    public TimingGridGraph<X, Y> timingGraphFor(
        ...
        return (TimingGridGraph<X, Y>)
                graphs.computeIfAbsent(
                        graphName, (n) -> new TimingGridGraph<>(n, xAxisLabel, yAxisLabel));
    }
    ...
    public int compareTo(final GridTest<X, Y> o) {
        ...
        return new CompareToBuilder().append(this.getTestName(), o.getTestName()).build();
    }
}

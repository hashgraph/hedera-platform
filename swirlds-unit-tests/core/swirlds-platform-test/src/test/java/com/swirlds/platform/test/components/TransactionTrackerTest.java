...
class TransactionTrackerTest {
    ...
    void test() {
        ...
        assertEquals(
                0, transactionTracker.getNumUserTransEvents(), "a new tracker should be set to 0");
        ...
        assertEquals(
                ...
                "there was no round received at the end of which there were no non-consensus"
                        + " transactions");
        ...
        assertEquals(
                0, transactionTracker.getNumUserTransEvents(), "reset should revert back to 0");
    }
}

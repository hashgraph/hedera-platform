...
class CommunicationStateTest {
    ...
    private void assertSyncState(
            final boolean expectedChatter, final boolean expectedSync, final String message) {
        Assertions.assertEquals(expectedChatter, state.shouldChatter(), message);
        Assertions.assertEquals(expectedSync, state.shouldPerformChatterSync(), message);
    }

    private void assertCommState(
            final boolean expectedChatter, final boolean expectedSync, final String message) {
        ...
        Assertions.assertEquals(
                expectedChatter || expectedSync, state.isAnyProtocolRunning(), message);
    }
}

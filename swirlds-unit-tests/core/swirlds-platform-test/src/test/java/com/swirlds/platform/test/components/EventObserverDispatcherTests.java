...
class EventObserverDispatcherTests {
    ...
    EventObserverDispatcher dispatcher =
            new EventObserverDispatcher(preCons, added, stale, consRound, addedStale);
    ...
    void test() {
        ...
        dispatchAndCheckConsensus(
                new ConsensusRound(List.of(e1, e2), Generations.GENESIS_GENERATIONS));
    }

    private void dispatchAndCheckConsensus(
            final ConsensusRound consensusRound, final SimpleEventTracker... yes) {

...
public class ConsensusTestArgs {
        ...
        return Stream.of(
                Arguments.of(
                        new ConsensusTestParams(
                                ...
                                -2230677537676013594L // used to reproduce second minTimestamp
                                // issue))
                                )),
    ...
    static Stream<Arguments> staleEvent() {
        return Stream.of(
                Arguments.of(
                        new ConsensusTestParams(
                                6, INCREMENTING, BALANCED_STAKE_DESC, 2524451583646241601L)),
                Arguments.of(new ConsensusTestParams(6, INCREMENTING, INCREMENTAL_NODE_STAKE_DESC)),
                Arguments.of(
                        new ConsensusTestParams(
                                6, SINGLE_NODE_STRONG_MINORITY, SINGLE_NODE_STRONG_MINORITY_DESC)),
                Arguments.of(
                        new ConsensusTestParams(
    ...
    static Stream<Arguments> partitionTests() {
        return Stream.of(
                ...
                Arguments.of(
                        new ConsensusTestParams(4, BALANCED_REAL_STAKE, BALANCED_REAL_STAKE_DESC)),

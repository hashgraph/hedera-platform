...
public class EventMocks {
    ...
    public static EventImpl createMockEvent(
            final long nodeId, final long generation, final EventImpl otherParent) {
     ...
     * Create a mock event
     *
     * @param hashedData the hashed data inside {@link EventImpl}

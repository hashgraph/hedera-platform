...
/**
 * A simple, factory for Hashes, to create a Hash with random bytes, or a Hash which encodes an
 * integer value as a sequence of bytes. This type is only a convenience, for unit testing.
 */

...
class EventStringsTest {
    ...
    void testCopy() {
        printAssert(
                EventStrings.toShortString((EventImpl) null),
                "null",
                "should indicate that the object is null");
        printAssert(
                EventStrings.toShortString((GossipEvent) null),
                "null",
                "should indicate that the object is null");
        printAssert(
                EventStrings.toShortString(new EventImpl()),
                "null",
                "should indicate that the object is null");

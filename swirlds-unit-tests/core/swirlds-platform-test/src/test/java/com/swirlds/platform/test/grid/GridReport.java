...
/**
 * A type which emits a string to stdout that displays a grid of test results. A header and a footer
 * for the results table is also printed.
 */
public class GridReport implements GridRenderer {
    ...
    /**
     * Get the GridTest object for the given test name, if it exists, else create a new one and
     * return it.
     *
    ...
    public <X extends Comparable<X>, Y extends Comparable<Y>> GridTest<X, Y> testFor(

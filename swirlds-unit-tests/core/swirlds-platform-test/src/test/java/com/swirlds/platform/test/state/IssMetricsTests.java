...
import static com.swirlds.platform.test.NoOpMetricsFactory.noOpMetrics;
...
class IssMetricsTests {
    ...
    void updateNonExistentNode() {
        ...
        final AddressBook addressBook = new RandomAddressBookGenerator().setSize(100).build();

        final IssMetrics issMetrics = new IssMetrics(noOpMetrics(), addressBook);
    ...
    void updateTest() {
        ...
        final AddressBook addressBook = new RandomAddressBookGenerator(random).setSize(100).build();

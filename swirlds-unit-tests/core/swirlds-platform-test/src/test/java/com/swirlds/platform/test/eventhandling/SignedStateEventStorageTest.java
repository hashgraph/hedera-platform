...
class SignedStateEventStorageTest {
    ...
    void test() {
        ...
        assertArrayEquals(
                new EventImpl[0], events.getEventsForLatestRound(), "new object should be empty");
        ...
        assertEquals(
                ...
                "There should be 1 event for each node");
        currentRoundGen = 2;
        ...
        // we expire everything added in the first round which is the only round where the last node
        // created any events
        ...
        assertEquals(
                events,
                reconnected,
                "after a reconnect, the new instance should be the same as the original");

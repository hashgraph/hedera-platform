...
class MerkleMapBenchmark {
    ...
    void standardMerkleMapBenchmark() throws InterruptedException {
        ...
        final List<
                        BenchmarkOperation<
                                MerkleMap<BenchmarkKey, BenchmarkAccount>,
                                MerkleMapBenchmarkMetadata>>
                mutableOperations =
                        List.of(
                                new CreateAccountOperation<>(
                                        createAccountWeight, DATA_SIZE, BenchmarkAccount::new),
        ...
        final Benchmark<MerkleMap<BenchmarkKey, BenchmarkAccount>, MerkleMapBenchmarkMetadata>
                benchmark =

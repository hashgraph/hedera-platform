...
public class FCQValue<T extends FastCopyable & SerializableHashable>
        extends PartialNaryMerkleInternal implements Iterable<T>, Keyed<Key>, MerkleInternal {
    ...
    public static FCQValue<TransactionRecord> build(
            final long index, final long balance, final byte[] content) {
        final TransactionRecord record =
                new TransactionRecord(index, balance, content, DEFAULT_EXPIRATION_TIME);
        ...
        final T newFromTransactionRecord =
                (T)
                        new TransactionRecord(
                                getRecords().size(), balance, content, DEFAULT_EXPIRATION_TIME);

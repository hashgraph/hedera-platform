...
public enum TransactionType {
    ...
    Create,
    /**
     * When a transaction is CreateAccount or CreateAccountFCQ, but the account already exists in
     * state.
     */
    ...
    Update,
    /**
     * When a transaction is UpdateAccount or UpdateAccountFCQ, and the account does not belong to
     * state.
     */
    ...
    Delete,
    /**
     * When a transaction is DeleteAccount or DeleteAccountFCQ, and the account does not belong to
     * state.
     */

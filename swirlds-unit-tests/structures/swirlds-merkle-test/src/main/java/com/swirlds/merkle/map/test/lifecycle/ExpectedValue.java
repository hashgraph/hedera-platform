...
public class ExpectedValue implements Serializable {
    /** type of this entity */
    @JsonProperty private EntityType entityType;

    /** Hash of the corresponding MapValue in MerkleMap */
    @JsonProperty private Hash hash;

    /**
     * It is set to true, if any error occurs while handling transactions for corresponding MapKey
     */
    @JsonProperty private boolean isErrored;

    /**
     * Last modified LifecycleStatus by handling a transaction. This will also be updated during
     * reconnect/restart/when account expires
     */
    @JsonProperty private LifecycleStatus latestHandledStatus;

    /** Last modified LifecycleStatus by submitting or initializing a transaction. */
    @JsonProperty private LifecycleStatus latestSubmitStatus;

    /**
     * History of previous latestHandledStatus, which will help to look-back the cause if any error
     * happens while handling transactions
     */
    @JsonProperty private LifecycleStatus historyHandledStatus;

    @JsonProperty private long uid;
    ...
    @JsonIgnore // Ignored because it serializes isErrored twice as jackson removes "is" prefix for
    // boolean
    ...
    public boolean isHandleRejected() {
        return this.latestHandledStatus != null
                && this.latestHandledStatus.getTransactionState()

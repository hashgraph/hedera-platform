...
/**
 * A state in a Transaction's lifecycle. TransactionState and TransactionType together denotes an
 * entity's status in the Entity's lifecycle
 */
public enum TransactionState {
    ...
    SUBMISSION_FAILED,
    /**
     * when the transaction is handled successfully, or when the entity is expired. In this case,
     * corresponding TransactionType should be Expire.
     */
    HANDLED,
    ...
    /**
     * When handling a transaction after the entity is deleted or expired; or handling a transaction
     * which performs operation, except creating, on a non-existing entity
     */
    HANDLE_REJECTED,

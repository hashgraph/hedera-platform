...
public class BenchmarkKey implements SelfSerializable {
    ...
    /**
     * Not really used for anything, but makes this key more similar in size to a real key in
     * hedera.
     */
    private long key2;
    ...
    /**
     * For the purpose of the benchmark, we ensure that key1 is unique across all keys, so it is
     * safe to use key1 as a unique identifier for a key.
     */

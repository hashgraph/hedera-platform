...
public class LifecycleStatus implements Serializable {
    ...
    /**
     * The timestamp of corresponding transactionState. for INITIALIZED, it is the timestamp when
     * initializing; for SUBMITTED and SUBMISSION_FAILED, it is the timestamp when submitting; for
     * HANDLE* and *INVALID_SIG, it is the consensus timestamp when handling the transaction for
     * RECONNECT_ORIGIN and RESTART_ORIGIN, it is the consensus timestamp of signed state
     */

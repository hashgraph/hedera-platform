...
/**
 * An intentionally broken teacher tree view. Throws an IO exception after a certain number of nodes
...
public class BrokenVirtualMapTeacherView implements TeacherTreeView<Long> {
     ...
     *
     * @param baseView a functional view for a virtual map
     * @param permittedInternals the number of internal nodes to allow to be serialized, if to many
     *     are encountered an IO exception is thrown.
     * @param permittedLeaves the number of leaf nodes to allow to be serialized, if to many are
     *     encountered an IO exception is thrown
     */
    public BrokenVirtualMapTeacherView(
            final TeacherTreeView<Long> baseView,
    ...
    @Override
    public void serializeLeaf(final SerializableDataOutputStream out, final Long leaf)
            throws IOException {
        leafCount++;
    ...
    @Override
    public void serializeInternal(final SerializableDataOutputStream out, final Long internal)
            throws IOException {
        internalCount++;

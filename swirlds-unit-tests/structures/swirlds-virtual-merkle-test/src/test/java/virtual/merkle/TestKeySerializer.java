...
public class TestKeySerializer
        implements KeySerializer<TestKey>, SelfSerializableSupplier<TestKey> {
    ...
    @Override
    public int serialize(final TestKey data, final SerializableDataOutputStream outputStream)
            throws IOException {
    ...
    public boolean equals(
            final ByteBuffer buffer, final int dataVersion, final TestKey keyToCompare)
            throws IOException {

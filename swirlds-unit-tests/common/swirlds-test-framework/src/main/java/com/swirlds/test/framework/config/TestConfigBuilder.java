...
public class TestConfigBuilder {
    ...
    /**
     * Creates a new instance and automatically registers all config data records on classpath (see
     * {@link ConfigData})
     */
    ...
    /**
     * Creates a new instance and add all records on classpath that are annotated with {@link
     * ConfigData} as config data types if the {@code registerAllTypes} param is true.
     *

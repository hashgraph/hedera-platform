...
public abstract class TestTypeTags {
    ...
    /**
     * Marks a test which asserts functionally correct behavior under stress/loads with many
     * repeated iterations.
     */
    public static final String HAMMER = "HAMMER";

    /**
     * Marks a test which should only be executed manually with an attached debugger or profiler.
     * These tests may need to be manually stopped by a developer.
     */

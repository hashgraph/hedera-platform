...
public abstract class ResourceLoader {
     ...
     *
     * <p>TODO: can this method be unified with the other methods in this class?
     *
     ...
     *
     * @param path the resource that was supposed to be loaded
     */
     ...
     *
     * @param fileName he name of the file to look for
     * @param possibleLocations possible locations where the file may be found
     * @return the first file found with the given name
     * @throws FileNotFoundException if the file is in none of the possible locations
     */
    public static File searchForFile(String fileName, List<String> possibleLocations)
        ...
        StringBuilder sb =
                new StringBuilder("Unable to find file ")
                        .append(fileName)

...
class ExpiringStreamExtensionTests {
        ...
        StreamSanityChecks.inputStreamSanityCheck(
                (final InputStream base) ->
                        new ExtendableInputStream(
                                base, new ExpiringStreamExtension(Duration.ofHours(1), 100)));
    }
    ...
    void inputStreamTest(final int bytesPerSample) throws IOException, InterruptedException {
        ...
        final ExpiringStreamExtension extension =
                new ExpiringStreamExtension(Duration.ofMillis(100), bytesPerSample);
    ...
    void outputStreamTest(final int bytesPerSample) throws InterruptedException, IOException {
        ...
        assertThrows(
                ...
                "stream is expired, write should throw");
        assertThrows(
                IOException.class, () -> out.write(1), "stream is expired, write should throw");

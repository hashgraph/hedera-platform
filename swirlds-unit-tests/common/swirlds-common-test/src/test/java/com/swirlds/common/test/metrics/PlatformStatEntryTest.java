...
class PlatformStatEntryTest {
    ...
    void testConstructor() {
        ...
        final StatEntry.Config config =
                new StatEntry.Config(CATEGORY, NAME, Object.class, getter)
        ...
        assertEquals(
                CATEGORY,
                statEntry.getCategory(),
                "The category was not set correctly in the constructor");
        assertEquals(
                NAME, statEntry.getName(), "The name was not set correctly in the constructor");
        assertEquals(
                DESCRIPTION,
                statEntry.getDescription(),
                "The description was not set correctly in the constructor");
        assertEquals(
                UNIT, statEntry.getUnit(), "The unit was not set correctly in the constructor");
        assertEquals(
                FORMAT,
                statEntry.getFormat(),
        ...
        assertEquals(
                buffered,
                statEntry.getBuffered(),
                "StatsBuffered was not set correctly in the constructor");
        assertEquals(
                reset,
                statEntry.getReset(),
                "The reset-lambda was not set correctly in the constructor");
        assertEquals(
                getter,
                statEntry.getStatsStringSupplier(),
                "The get-lambda was not set correctly in the constructor");
        assertEquals(
                getAndReset,
    ...
    void testResetWithoutResetLambdaAndBuffer() {
        ...
        // when
        assertDoesNotThrow(
                statEntry::reset, "Calling reset() should have been a no-op, but was not.");
    }
    ...
    void testSnapshotWithBuffered() {
        ...
        final List<SnapshotValue> snapshot = statEntry.takeSnapshot();
    ...
    void testSnapshotWithoutBuffered() {
        ...
        assertThat(snapshot).containsExactly(new SnapshotValue(VALUE, "Hello World"));
    }
    ...
    void testInvalidGetsWithBuffered() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> statEntry.get(Metric.ValueType.COUNTER),
    ...
    void testEquals() {
        ...
        final StatEntry.Config config1 =
                new StatEntry.Config(CATEGORY, NAME, Object.class, getter1);
        final StatEntry statEntry1 = new PlatformStatEntry(config1);
        final Supplier<Object> getter2 = mock(Supplier.class);
        final StatEntry.Config config2 =
                new StatEntry.Config(CATEGORY, NAME, Object.class, getter2);
        ...
        assertThat(statEntry1)
                ...
                .isNotEqualTo(
                        new PlatformStatEntry(
                                new StatEntry.Config("Other", NAME, Object.class, getter1)))
                .isNotEqualTo(
                        new PlatformStatEntry(
                                new StatEntry.Config(CATEGORY, "Other", Object.class, getter1)))
    ...
    void testToString() {
        ...
        // then
        assertThat(statEntry.toString())
                .contains(CATEGORY, NAME, DESCRIPTION, UNIT, FORMAT, STRING.toString());
    }
}

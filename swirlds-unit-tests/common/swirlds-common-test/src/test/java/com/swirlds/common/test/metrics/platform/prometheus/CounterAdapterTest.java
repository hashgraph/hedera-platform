...
class CounterAdapterTest {
    ...
    void testCreateGlobalMetric() {
        ...
        final Metric metric =
                new DefaultCounter(
                        new Counter.Config(CATEGORY, NAME)
    ...
    void testConstructorWithNullParameters() {
        ...
        final CollectorRegistry registry = new CollectorRegistry();
        final Metric metric =
                new DefaultCounter(new Counter.Config(CATEGORY, NAME).withDescription(DESCRIPTION));

        // then
        assertThatThrownBy(() -> new CounterAdapter(null, metric, GLOBAL))
    ...
    void testUpdateGlobalMetric() {
        ...
        // then
        assertThat(registry.getSampleValue(MAPPING_NAME + "_total"))

...
public class SemanticVersionTest {
    ...
    private static final String EXPECTED_NOT_NULL =
            "Expected %s to be non-null, but was a null reference";
    private static final String VALUES_NOT_EQUAL =
            "Expected %s to be equal to the reference value, but was not equal";
    private static final String DOES_NOT_THROW =
            "Expected %s to not throw an exception, but an exception was thrown";
    ...
    void testValidSemanticVersionParsing(
        ...
        assertEquals(
                ...
                String.format(VALUES_NOT_EQUAL, "calculatedVersion.major()"));
        assertEquals(
                minor,
                calculatedVersion.minor(),
                String.format(VALUES_NOT_EQUAL, "calculatedVersion.minor()"));
        assertEquals(
                patch,
                calculatedVersion.patch(),
                String.format(VALUES_NOT_EQUAL, "calculatedVersion.patch()"));
        assertEquals(
                prerelease,
        ...
        assertEquals(
                build,
                calculatedVersion.build(),
                String.format(VALUES_NOT_EQUAL, "calculatedVersion.build()"));
    }
    ...
    void testSemanticVersionToString(
        ...
        assertEquals(
                ...
                String.format(VALUES_NOT_EQUAL, "semanticVersion.toString()"));
    }
    ...
    void testSerialization(
        ...
        assertEquals(
                ...
                String.format(VALUES_NOT_EQUAL, "semanticVersion.compareTo(copy)"));
    }

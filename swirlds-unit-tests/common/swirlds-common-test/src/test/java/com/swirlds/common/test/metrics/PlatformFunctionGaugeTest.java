...
class PlatformFunctionGaugeTest {
    ...
    void testConstructor() {
        ...
        final FunctionGauge.Config<String> config =
                new FunctionGauge.Config<>(CATEGORY, NAME, String.class, supplier)
    ...
    void testEquals() {
        ...
        assertThat(gauge1)
                ...
                .isNotEqualTo(
                        new PlatformFunctionGauge<>(
                                new FunctionGauge.Config<>("Other", NAME, String.class, supplier1)))
                .isNotEqualTo(
                        new PlatformFunctionGauge<>(
                                new FunctionGauge.Config<>(
                                        CATEGORY, "Other", String.class, supplier1)))

...
class SpeedometerMetricConfigTest {
	...
	void testConstructorWithIllegalParameters() {
		...
		assertThatThrownBy(() -> new SpeedometerMetric.Config(CATEGORY, null)).isInstanceOf(IllegalArgumentException.class);
		assertThatThrownBy(() -> new SpeedometerMetric.Config(CATEGORY, "")).isInstanceOf(IllegalArgumentException.class);
	...
	void testSetters() {
		...
		// when
		final SpeedometerMetric.Config result = config

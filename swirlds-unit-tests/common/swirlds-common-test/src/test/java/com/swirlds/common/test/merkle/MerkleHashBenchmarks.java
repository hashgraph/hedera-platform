...
public class MerkleHashBenchmarks {
    ...
    private long timeHash(DummyMerkleNode root, boolean sync)
    ...
    private double benchmarkHashesWithParameters(
        ...
        for (int i = 0; i < numberOfIterations; i++) {
            ...
            DummyMerkleNode tree =
                    MerkleTestUtils.generateRandomTree(
    ...
    public void hashSmallTrees() throws IOException, InterruptedException, ExecutionException {
        ...
        double asyncTime =
                benchmarkHashesWithParameters(1337, 3, 1, 64, 10, 3, 1, 0.15, 1000, false);

...
public class MerkleHashBenchmarks {
	...
	private double benchmarkHashesWithParameters(
			...
			boolean sync) throws IOException, InterruptedException, ExecutionException {
		...
		for (int i = 0; i < numberOfIterations; i++) {
			...
			DummyMerkleNode tree = MerkleTestUtils.generateRandomTree(
					seedGenerator.nextLong(), numberOfLeavesAverage, numberOfLeavesStandardDeviation, leafSizeAverage,
	...
	public void hashSmallTrees() throws IOException, InterruptedException, ExecutionException {
		...
		double syncTime = benchmarkHashesWithParameters(1337, 3,
				1, 64, 10, 3,
				1, 0.15, 1000, true);
		System.out.println("--- Asynchronous hashing ---");
		double asyncTime = benchmarkHashesWithParameters(1337, 3,
				1, 64, 10, 3,
				1, 0.15, 1000,
				false);

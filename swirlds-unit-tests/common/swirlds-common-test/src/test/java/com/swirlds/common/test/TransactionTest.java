...
public class TransactionTest {
     ...
     *     <p>Note: This routine is copied directly from
            ...
            if (system) {
                ...
                list.add(
                        new StateSignatureTransaction(
                                random.nextLong(), sigature, randomHash(random)));
            } else {
    ...
    public void serializeDeserialize() throws IOException {
        ...
        final List<Transaction> original =
                generateTransactions(MAX_TRANSACTIONS, MAX_TRANSACTION_BYTES, random);

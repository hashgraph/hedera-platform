...
import com.swirlds.common.metrics.platform.PlatformLongGauge;
...
class PlatformLongGaugeTest {
    ...
    void testConstructor() {
        final LongGauge.Config config =
                new LongGauge.Config(CATEGORY, NAME)
                        .withDescription(DESCRIPTION)
                        .withUnit(UNIT)
                        .withFormat(FORMAT)
                        .withInitialValue(42L);
        final LongGauge gauge = new PlatformLongGauge(config);
    ...
    void testSnapshot() {
        // given
        final LongGauge.Config config = new LongGauge.Config(CATEGORY, NAME).withInitialValue(2L);
        final PlatformLongGauge gauge = new PlatformLongGauge(config);
        ...
        assertThat(snapshot).containsExactly(new SnapshotValue(VALUE, 2L));
    }
    ...
    void testEquals() {
        // given
        final LongGauge.Config config = new LongGauge.Config(CATEGORY, NAME);
        final LongGauge gauge1 = new PlatformLongGauge(config);
        final LongGauge gauge2 = new PlatformLongGauge(config);
        gauge2.set(42L);
        ...
        assertThat(gauge1)
                ...
                .isNotEqualTo(new PlatformLongGauge(new LongGauge.Config("Other", NAME)))
                .isNotEqualTo(new PlatformLongGauge(new LongGauge.Config(CATEGORY, "Other")))

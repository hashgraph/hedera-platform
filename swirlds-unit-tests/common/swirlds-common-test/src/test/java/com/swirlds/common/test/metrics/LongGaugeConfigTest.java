...
class LongGaugeConfigTest {
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(() -> new LongGauge.Config(null, NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new LongGauge.Config("", NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new LongGauge.Config(" \t\n", NAME))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> new LongGauge.Config(CATEGORY, null))
                .isInstanceOf(IllegalArgumentException.class);

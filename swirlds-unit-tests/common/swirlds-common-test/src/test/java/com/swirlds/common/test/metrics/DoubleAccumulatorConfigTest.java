...
class DoubleAccumulatorConfigTest {
    ...
    void testConstructor() {
        ...
        assertThat(config.getAccumulator().applyAsDouble(2.0, 3.0))
                .isEqualTo(Double.max(2.0, 3.0), within(EPSILON));
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(() -> new DoubleAccumulator.Config(null, NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new DoubleAccumulator.Config("", NAME))
                .isInstanceOf(IllegalArgumentException.class);
    ...
    void testSetters() {
        ...
        // when
        final DoubleAccumulator.Config result =
    ...
    void testSettersWithIllegalParameters() {
        ...
        assertThatThrownBy(() -> config.withAccumulator(null))
                .isInstanceOf(IllegalArgumentException.class);
    }

...
class LongAccumulatorConfigTest {
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(() -> new LongAccumulator.Config(null, NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new LongAccumulator.Config("", NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new LongAccumulator.Config(" \t\n", NAME))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> new LongAccumulator.Config(CATEGORY, null))
                .isInstanceOf(IllegalArgumentException.class);
    ...
    void testSetters() {
        ...
        // when
        final LongAccumulator.Config result =

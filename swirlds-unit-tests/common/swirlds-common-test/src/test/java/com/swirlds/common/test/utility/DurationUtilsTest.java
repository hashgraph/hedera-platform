...
class DurationUtilsTest {
    ...
    void isLongerTest() {
        Assertions.assertTrue(
                DurationUtils.isLonger(Duration.ofSeconds(2), Duration.ofSeconds(1)),
                "2 should be bigger than 1");
        Assertions.assertFalse(
                DurationUtils.isLonger(Duration.ofSeconds(1), Duration.ofSeconds(1)),
                "1==1, so not longer");
        Assertions.assertFalse(
                DurationUtils.isLonger(Duration.ofSeconds(1), Duration.ofSeconds(2)),
                "1 < 2, so not longer");
    }

...
class PlatformDoubleAccumulatorTest {
    ...
    void testConstructor() {
        ...
        final DoubleAccumulator.Config config =
                new DoubleAccumulator.Config(CATEGORY, NAME)
        ...
        assertEquals(
                Math.PI, accumulator.get(), EPSILON, "The value was not initialized correctly");
        assertEquals(
                Math.PI,
                accumulator.get(VALUE),
                EPSILON,
                "The value was not initialized correctly");
    ...
    void testEquals() {
        ...
        assertThat(accumulator1)
                ...
                .isNotEqualTo(
                        new PlatformDoubleAccumulator(new DoubleAccumulator.Config("Other", NAME)))
                .isNotEqualTo(
                        new PlatformDoubleAccumulator(
                                new DoubleAccumulator.Config(CATEGORY, "Other")))

...
class SelfHashingDummyMerkleLeafTest {
    ...
    void isImmutableAfterCopy() {
        final SelfHashingDummyMerkleLeaf leaf =
                new SelfHashingDummyMerkleLeaf("This is a copy test");
        leaf.copy();
    ...
    void serializeAndDeserialize() throws IOException {
        final SelfHashingDummyMerkleLeaf leaf =
                new SelfHashingDummyMerkleLeaf("This is a serialize test");
    ...
    void equalsMatchesHashCode() {
        final SelfHashingDummyMerkleLeaf leaf = new SelfHashingDummyMerkleLeaf("This is a leaf");
        final SelfHashingDummyMerkleLeaf anotherLeaf =
                new SelfHashingDummyMerkleLeaf("This is a leaf");
        assertEquals(leaf, anotherLeaf, "The leaves have the same content");
        assertEquals(
                leaf.hashCode(),
                anotherLeaf.hashCode(),
                "The leaves should have the same hash code");
    }
    ...
    void releaseInternalNode() {
        ...
        final Exception exception =
                assertThrows(
                        ...
                        leaf::destroyNode,
                        "destroyNode is only allowed once");

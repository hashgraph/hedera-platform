...
public class PlatformVersionTest {
    ...
    void testValidVersionFromJarFile(
        ...
        final SemanticVersion expectedSemVer =
        ...
        assertEquals(
                commitId, version.commit(), String.format(VALUES_NOT_EQUAL, "version.commit()"));
    ...
    void testSerialization(
        ...
        final PlatformVersion original =
                new PlatformVersion(
                        new SemanticVersion(major, minor, patch, prerelease, build), commitId);
    ...
    static Stream<Arguments> invalidInputStreamSupplier() {
        ...
        final InputStream stream =
                loader.getResourceAsStream("platform/version/bad.git.properties");
        assertNotNull(stream);
    ...
    static Stream<Arguments> validJarFileSupplier() throws URISyntaxException {
        ...
        final URL resourceUrl =
                loader.getResource("platform/version/example-version-descriptor.jar");
        assertNotNull(resourceUrl);

        return Stream.of(
                Arguments.of(
                        Path.of(resourceUrl.toURI()),
                        0,
                        27,
                        0,
                        "SNAPSHOT",

...
class PlatformIntegerPairAccumulatorTest {
    ...
    void testConstructor() {
        ...
        final IntegerPairAccumulator.Config<String> config =
                new IntegerPairAccumulator.Config<>(CATEGORY, NAME, String.class, resultFunction)
                        .withDescription(DESCRIPTION)
                        .withUnit(UNIT)
                        .withFormat(FORMAT);
        final IntegerPairAccumulator<String> accumulator =
                new PlatformIntegerPairAccumulator<>(config);
        ...
        assertEquals(
                "Hello World", accumulator.get(VALUE), "The value was not initialized correctly");
    ...
    void testGetAndUpdate() {
        ...
        final IntegerPairAccumulator<Long> accumulator =
                new PlatformIntegerPairAccumulator<>(config);
    ...
    void testPositiveOverflow() {
        ...
        assertEquals(
                expected,
                accumulator.get(),
                "Value should be the same as if regular ints overflows");
    }
    ...
    void testSnapshot() {
        ...
        final PlatformIntegerPairAccumulator<Double> accumulator =
                new PlatformIntegerPairAccumulator<>(config);
        accumulator.update(2, 3);
    ...
    void testInvalidGets() {
        ...
        final IntegerPairAccumulator.Config<Double> config =
                new IntegerPairAccumulator.Config<>(CATEGORY, NAME, Double.class, AVERAGE);
        final IntegerPairAccumulator<Double> accumulator =
                new PlatformIntegerPairAccumulator<>(config);
    ...
    void testEquals() {
        ...
        final IntegerPairAccumulator.Config<Double> config =
                new IntegerPairAccumulator.Config<>(CATEGORY, NAME, Double.class, AVERAGE);
        final IntegerPairAccumulator<Double> accumulator1 =
                new PlatformIntegerPairAccumulator<>(config);
        final IntegerPairAccumulator<Double> accumulator2 =
                new PlatformIntegerPairAccumulator<>(config);
        ...
        assertThat(accumulator1)
                ...
                .isNotEqualTo(
                        new PlatformIntegerPairAccumulator<>(
                                new IntegerPairAccumulator.Config<>(
                                        "Other", NAME, Double.class, AVERAGE)))
                .isNotEqualTo(
                        new PlatformIntegerPairAccumulator<>(
                                new IntegerPairAccumulator.Config<>(
                                        CATEGORY, "Other", Double.class, AVERAGE)))

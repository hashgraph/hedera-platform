...
class StreamingPerformanceTest {
    ...
    void performanceTest(final int payLoadSize) throws InterruptedException {
        ...
        final TestStreamManager streamManager =
                new TestStreamManager(countDownLatch, OBJECTS_COUNT);
        ...
        assertTrue(
                actualTimeInTotal < 2_800,
                String.format("actualTime %d < 2800 ms.", actualTimeInTotal));
    }
}

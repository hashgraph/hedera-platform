...
class DoubleGaugeConfigTest {
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(() -> new DoubleGauge.Config(null, NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new DoubleGauge.Config("", NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new DoubleGauge.Config(" \t\n", NAME))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> new DoubleGauge.Config(CATEGORY, null))
                .isInstanceOf(IllegalArgumentException.class);
    ...
    void testSetters() {
        ...
        // when
        final DoubleGauge.Config result =

...
class DefaultSpeedometerMetricTest {
    ...
    void testDistributionForIncreasedRate() {
        ...
        // when
        sendCycles(metric, time, 0, 1000, 1000);
        sendCycles(metric, time, 1000, 1000 + (int) SettingsCommon.halfLife, 2000);
    ...
    void testDistributionForTwiceIncreasedRate() {
        ...
        // when
        sendCycles(metric, time, 0, 1000, 1000);
        sendCycles(metric, time, 1000, 1000 + (int) SettingsCommon.halfLife, 5000);
        sendCycles(
                metric,
                time,
    ...
    void testDistributionForDecreasedRate() {
        ...
        // when
        sendCycles(metric, time, 0, 1000, 1000);
        sendCycles(metric, time, 1000, 1000 + (int) SettingsCommon.halfLife, 500);
        time.set(Duration.ofSeconds(1000 + (int) SettingsCommon.halfLife));
        double rate = metric.get();
    ...
    void testEquals() {
        ...
        assertThat(metric1)
                ...
                .isNotEqualTo(
                        new DefaultSpeedometerMetric(new SpeedometerMetric.Config("Other", NAME)))
                .isNotEqualTo(
                        new DefaultSpeedometerMetric(

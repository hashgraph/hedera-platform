...
/**
 * For testing streaming performance; takes objects from {@link ObjectForTestStreamGenerator}, sends
...
public class TestStreamManager {
    ...
    /**
     * receives {@link ObjectForTestStream}s from hashQueueThread, calculates this object's Hash,
     * then passes to runningHashCalculator
     */
    ...
    public TestStreamManager(final CountDownLatch countDownLatch, final int expectedCount) {
        ...
        // receives {@link ObjectForTestStream}s from hashCalculator, calculates and set runningHash
        // for this object
    ...
    /**
     * receives a object each time, sends it to multiStream which then sends to two queueThread for
     * calculating runningHash and writing to file
     *
     * @param recordStreamObject the {@link ObjectForTestStream} object to be added
     */
     ...
     *
     * @param initialHash current runningHash of all {@link ObjectForTestStream}s
     */

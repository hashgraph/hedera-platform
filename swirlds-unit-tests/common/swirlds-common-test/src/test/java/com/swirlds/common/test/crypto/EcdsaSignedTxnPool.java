...
/**
 * Provides pre-generated random transactions that are optionally pre-signed with ECDSA(secp256k1)
 * signatures.
 */
    ...
    void generateActiveKeyPair() {
        try {
            ...
            throw new IllegalStateException(
                    "Tests cannot be trusted without working key-pair generation", fatal);
        }
    }
}

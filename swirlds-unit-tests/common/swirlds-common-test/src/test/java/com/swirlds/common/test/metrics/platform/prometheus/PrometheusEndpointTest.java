...
class PrometheusEndpointTest {
    ...
    void testMethodsWithIllegalParameters() throws IOException {
        ...
        // then
        assertThatThrownBy(() -> new PrometheusEndpoint(null))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> endpoint.handleMetricsChange(null))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> endpoint.handleSnapshots(null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testFilteringOfTimeMetric() throws IOException {
        // given
        final FunctionGauge<String> time =
                new DefaultFunctionGauge<>(
                        new FunctionGauge.Config<>(
                                Metrics.INFO_CATEGORY, "time", String.class, () -> ""));
    ...
    void testRemoveMetric() throws IOException {
        ...
        try (final PrometheusEndpoint endpoint = new PrometheusEndpoint(httpServer, registry)) {
            ...
            // when
            final MetricsEvent removeEvent =
                    new MetricsEvent(MetricsEvent.Type.REMOVED, null, metric);
    ...
    void testSnapshotOfUnregisteredMetric() throws IOException {
        ...
        try (final PrometheusEndpoint endpoint = new PrometheusEndpoint(httpServer, registry)) {
            ...
            final SnapshotEvent snapshotEvent =
                    new SnapshotEvent(NODE_ID_1, List.of(Snapshot.of(metric)));
            assertThatCode(() -> endpoint.handleSnapshots(snapshotEvent))
    ...
    void testGlobalCounter() throws IOException {
        ...
        try (final PrometheusEndpoint endpoint = new PrometheusEndpoint(httpServer, registry)) {
            ...
            final MetricsEvent metricsEvent =
                    new MetricsEvent(MetricsEvent.Type.ADDED, null, metric);
            ...
            final io.prometheus.client.Counter collector =
                    (io.prometheus.client.Counter) captor.getValue();
            ...
            metric.add(42L);
            final SnapshotEvent snapshotEvent =
                    new SnapshotEvent(null, List.of(Snapshot.of(metric)));
    ...
    void testPlatformCounter() throws IOException {
        ...
        try (final PrometheusEndpoint endpoint = new PrometheusEndpoint(httpServer, registry)) {
            ...
            // when
            final MetricsEvent metricsEvent1 =
                    new MetricsEvent(MetricsEvent.Type.ADDED, NODE_ID_1, metric1);
            endpoint.handleMetricsChange(metricsEvent1);
            final MetricsEvent metricsEvent2 =
                    new MetricsEvent(MetricsEvent.Type.ADDED, NODE_ID_2, metric1);
            ...
            metric1.add(3L);
            metric2.add(5L);
            final SnapshotEvent snapshotEvent1 =
                    new SnapshotEvent(NODE_ID_1, List.of(Snapshot.of(metric1)));
            endpoint.handleSnapshots(snapshotEvent1);
            final SnapshotEvent snapshotEvent2 =
                    new SnapshotEvent(NODE_ID_2, List.of(Snapshot.of(metric2)));
    ...
    void testGlobalDurationGauge() throws IOException {
        // given
        final DurationGauge.Config config =
    ...
    void testPlatformDurationGauge() throws IOException {
        ...
        try (final PrometheusEndpoint endpoint = new PrometheusEndpoint(httpServer, registry)) {
            ...
            assertThat(collector.labels(LABEL_1).get())
                    .isEqualTo(Units.MICROSECONDS_TO_MILLISECONDS, within(EPSILON));
            assertThat(collector.labels(LABEL_2).get())
                    .isEqualTo(Units.NANOSECONDS_TO_MILLISECONDS, within(EPSILON));
        }
    }
    ...
    void testGlobalBooleanIntegerPairAccumulator() throws IOException {
        ...
        final DefaultIntegerPairAccumulator<Boolean> metric =
                new DefaultIntegerPairAccumulator<>(config);
    ...
    void testPlatformBooleanIntegerPairAccumulator() throws IOException {
        ...
        final IntegerPairAccumulator.Config<Boolean> config1 =
                new IntegerPairAccumulator.Config<>(CATEGORY, NAME, Boolean.class, (a, b) -> a < b);
        final DefaultIntegerPairAccumulator<Boolean> metric1 =
                new DefaultIntegerPairAccumulator<>(config1);
        final IntegerPairAccumulator.Config<Boolean> config2 =
                new IntegerPairAccumulator.Config<>(CATEGORY, NAME, Boolean.class, (a, b) -> a > b);
        final DefaultIntegerPairAccumulator<Boolean> metric2 =
                new DefaultIntegerPairAccumulator<>(config2);
    ...
    void testGlobalNumberIntegerPairAccumulator() throws IOException {
        ...
        final IntegerPairAccumulator.Config<Double> config =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, Double.class, (a, b) -> (double) a / b);
        final DefaultIntegerPairAccumulator<Double> metric =
                new DefaultIntegerPairAccumulator<>(config);
    ...
    void testPlatformNumberIntegerPairAccumulator() throws IOException {
        ...
        final IntegerPairAccumulator.Config<Double> config1 =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, Double.class, (a, b) -> (double) a / b);
        final DefaultIntegerPairAccumulator<Double> metric1 =
                new DefaultIntegerPairAccumulator<>(config1);
        final IntegerPairAccumulator.Config<Double> config2 =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, Double.class, (a, b) -> (double) a * b);
        final DefaultIntegerPairAccumulator<Double> metric2 =
                new DefaultIntegerPairAccumulator<>(config2);
    ...
    void testGlobalStringIntegerPairAccumulator() throws IOException {
        // given
        final IntegerPairAccumulator.Config<String> config =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, String.class, (a, b) -> String.format("%d.%d", a, b));
        final DefaultIntegerPairAccumulator<String> metric =
                new DefaultIntegerPairAccumulator<>(config);
    ...
    void testPlatformStringIntegerPairAccumulator() throws IOException {
        // given
        final IntegerPairAccumulator.Config<String> config1 =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, String.class, (a, b) -> String.format("%d.%d", a, b));
        final DefaultIntegerPairAccumulator<String> metric1 =
                new DefaultIntegerPairAccumulator<>(config1);
        final IntegerPairAccumulator.Config<String> config2 =
                new IntegerPairAccumulator.Config<>(
                        CATEGORY, NAME, String.class, (a, b) -> String.format("%d|%d", a, b));
        final DefaultIntegerPairAccumulator<String> metric2 =
                new DefaultIntegerPairAccumulator<>(config2);
    ...
    void testPlatformBooleanStatEntry() throws IOException {
        ...
        final StatEntry.Config<Boolean> config2 =
                new StatEntry.Config<>(CATEGORY, NAME, Boolean.class, () -> false);
    ...
    void testGlobalNumberStatEntry() throws IOException {
        ...
        final StatEntry.Config<Double> config =
                new StatEntry.Config<>(CATEGORY, NAME, Double.class, () -> Math.PI);
        final DefaultStatEntry metric = new DefaultStatEntry(config);
    ...
    void testPlatformNumberStatEntry() throws IOException {
        ...
        final StatEntry.Config<Double> config1 =
                new StatEntry.Config<>(CATEGORY, NAME, Double.class, () -> Math.E);
        final DefaultStatEntry metric1 = new DefaultStatEntry(config1);
    ...
    void testGlobalStringStatEntry() throws IOException {
        ...
        final StatEntry.Config<String> config =
                new StatEntry.Config<>(CATEGORY, NAME, String.class, () -> "Hello");
        final DefaultStatEntry metric = new DefaultStatEntry(config);
    ...
    void testPlatformStringStatEntry() throws IOException {
        ...
        final StatEntry.Config<String> config2 =
                new StatEntry.Config<>(CATEGORY, NAME, String.class, () -> "Goodbye");
        final DefaultStatEntry metric2 = new DefaultStatEntry(config2);

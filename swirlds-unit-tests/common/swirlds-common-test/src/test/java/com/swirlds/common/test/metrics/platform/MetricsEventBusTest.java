 ...
 */
package com.swirlds.common.test.metrics.platform;
...
class MetricsEventBusTest {
    ...
    @Mock private Consumer<Object> subscriber;
    ...
    void testConstructorWithNull() {
        assertThatThrownBy(() -> new MetricsEventBus<>(null))
    ...
    void testSubscribeWithIllegalArguments() {
        ...
        assertThatThrownBy(() -> eventBus.subscribe(null, () -> Stream.of(1)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> eventBus.subscribe(it -> {}, null))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> eventBus.subscribe(it -> {}, () -> null))
    ...
    void testSubmitWithIllegalArguments() {
        ...
        // then
        assertThatThrownBy(() -> eventBus.submit(null))
                .isInstanceOf(IllegalArgumentException.class);
    }
}

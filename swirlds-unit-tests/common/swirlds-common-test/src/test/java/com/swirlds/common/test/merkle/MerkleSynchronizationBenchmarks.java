...
public class MerkleSynchronizationBenchmarks {
	...
	private double benchmarkWithParameters(
		...
		for (int i = 0; i < numberOfIterations; i++) {
			...
			MerkleTestUtils.randomlyMutateTree(
					desiredTree, leafMutationProbability, 0, mutationSeed, 0,
					0, leafSizeAverage, leafSizeStandardDeviation,
					0, 0, 0);
		...
		System.out.println("Average number of leaf nodes shared between trees: " +
	...
	public void syncSmallTrees() {
		benchmarkWithParameters(
				1234, 15, 2, 0.1, 100, 10,
				100, false, 0);
	}

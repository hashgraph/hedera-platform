    ...
    private double benchmarkWithParameters(
        ...
        for (int i = 0; i < numberOfIterations; i++) {
            ...
            if (!fullSync) {
                ...
                startingTree =
                        MerkleTestUtils.generateRandomBalancedTree(
                                treeSeed,
                                depth,
                                childCount,
                                leafSizeAverage,
        ...
        // Time is stored internally as microseconds, but it is easier for a human to read in
        // seconds.
        System.out.println(
                "Average time to synchronize: " + (averageTime * MICROSECONDS_TO_SECONDS) + "s");
        ...
        System.out.println(
                "Average number of leaf nodes shared between trees: "
                        + (sumOfSimilarities / numberOfIterations));

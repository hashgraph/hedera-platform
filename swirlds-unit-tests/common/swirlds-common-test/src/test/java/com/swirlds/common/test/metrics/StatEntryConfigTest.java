...
class StatEntryConfigTest {
	...
	void testConstructor() {
		...
		// when
		final StatEntry.Config config = new StatEntry.Config(CATEGORY, NAME, getter);
	...
	void testConstructorWithIllegalParameter() {
		...
		// when
		assertThatThrownBy(() -> new StatEntry.Config(null, NAME, getter)).isInstanceOf(IllegalArgumentException.class);
		assertThatThrownBy(() -> new StatEntry.Config("", NAME, getter)).isInstanceOf(IllegalArgumentException.class);
		assertThatThrownBy(() -> new StatEntry.Config(" \t\n", NAME, getter)).isInstanceOf(IllegalArgumentException.class);

		assertThatThrownBy(() -> new StatEntry.Config(CATEGORY, null, getter)).isInstanceOf(IllegalArgumentException.class);
		assertThatThrownBy(() -> new StatEntry.Config(CATEGORY, "", getter)).isInstanceOf(IllegalArgumentException.class);
		assertThatThrownBy(() -> new StatEntry.Config(CATEGORY, " \t\n", getter)).isInstanceOf(IllegalArgumentException.class);

		assertThatThrownBy(() -> new StatEntry.Config(CATEGORY, NAME, null)).isInstanceOf(IllegalArgumentException.class);
	}
	...
	void testSetters() {
		...
		// when
		final StatEntry.Config result = config
	...
	void testSettersWithIllegalParameters() {
		...
		assertThatThrownBy(() -> config.withResetStatsStringSupplier(null)).isInstanceOf(IllegalArgumentException.class);
	}

...
public class DetRandomTests {
    ...
    private static final String MSG_VALUES_MUST_MATCH =
            "The original and generated values must match exactly";
    private static final String MSG_RANDOM_ARG_NOT_NULL =
            "The supplied random argument must not be null";
    private static final String MSG_DUP_RANDOM_ARG_NOT_NULL =
            "The supplied duplicateRandom argument must not be null";
    private static final String MSG_SEQUENCE_ARG_NOT_NULL =
            "The supplied desiredSequence argument must not be null";
    ...
    void verifyDeterministicLongValues(
            ...
            final RandomGenerator duplicateRandom) {

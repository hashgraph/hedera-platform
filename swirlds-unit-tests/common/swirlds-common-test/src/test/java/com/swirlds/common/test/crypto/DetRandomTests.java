...
public class DetRandomTests {
	...
	void verifyDeterministicLongValues(final String name, final long seed, final RandomGenerator random,
	...
	void verifyDeterministicByteValues(final String name, final long seed, final RandomGenerator random,
			final RandomGenerator duplicateRandom) {
		assertNotNull(random, MSG_RANDOM_ARG_NOT_NULL);
		assertNotNull(duplicateRandom, MSG_DUP_RANDOM_ARG_NOT_NULL);
	...
	void verifyKnownDeterministicSequence(final String name, final long seed, final RandomGenerator random,

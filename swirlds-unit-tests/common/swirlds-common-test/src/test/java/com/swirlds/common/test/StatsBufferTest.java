...
class StatsBufferTest {
	...
	void recordOneValueTest() {
		...
		assertEquals(1, statsBuffer.numBins(),
		...
		assertEquals(statsBuffer.yMax(), statsBuffer.yMax(0),
		...
		assertEquals(statsBuffer.yMin(), statsBuffer.yMin(0),
		...
		assertEquals(statsBuffer.yStd(0), statsBuffer.yStdMostRecent(),
				"when only one value is recorded, yStd(0) should be equal to yStdMostRecent()");

		assertEquals(statsBuffer.xMax(), statsBuffer.xMin(),
	...
	void recordMultipleValueTest() {
		...
		assertEquals(MAX_BINS - 1, statsBuffer.numBins(),
		...
		assertEquals(MAX_BINS / 2, statsBuffer.numBins(),

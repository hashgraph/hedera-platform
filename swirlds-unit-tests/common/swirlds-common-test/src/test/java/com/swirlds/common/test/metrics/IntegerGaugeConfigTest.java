...
class IntegerGaugeConfigTest {
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(() -> new IntegerGauge.Config(null, NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new IntegerGauge.Config("", NAME))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> new IntegerGauge.Config(" \t\n", NAME))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> new IntegerGauge.Config(CATEGORY, null))
                .isInstanceOf(IllegalArgumentException.class);
    ...
    void testSetters() {
        ...
        // when
        final IntegerGauge.Config result =

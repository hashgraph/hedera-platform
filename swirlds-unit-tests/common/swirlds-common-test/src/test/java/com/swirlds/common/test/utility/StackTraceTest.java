...
class StackTraceTest {
    ...
    void stackTraceTest() {
        ...
        assertEquals(
                "com.swirlds.common.test.utility.StackTraceTest.stackTraceTest(StackTraceTest.java:32)",
                firstLine,
                "first line of stack trace doesn't match expected. This may fail if the line number"
                        + " of 'getStackTrace()' changes, or if the package/name of this class"
                        + " changes.");
    }
}

...
class MetricsTest {
    ...
    private void setupFactory() {
        ...
        when(factory.createCounter(any()))
                .thenReturn(
                        counter_1_1,
                        counter_1a_1,
                        counter_1b_1,
    ...
    void testConstructorWithNullParameter() {
        ...
        assertThatThrownBy(() -> new Metrics(null, factory))
                .isInstanceOf(IllegalArgumentException.class);
        SettingsCommon.metricsUpdatePeriodMillis = -1;
        assertThatCode(() -> new Metrics(null, factory)).doesNotThrowAnyException();
        assertThatThrownBy(() -> new Metrics(executor, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testGetSingleMetricWithNullParameter() {
        assertThatThrownBy(() -> metrics.getMetric(null, NAME_1))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> metrics.getMetric(CATEGORY_1, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testGetMetricsOfCategoryAfterMetricWasAdded() {
        ...
        // when
        final Counter newCreated =
                metrics.getOrCreate(new Counter.Config(CATEGORY_1, "New Counter"));

        // then
        assertThat(newCreated).isSameAs(newCounter);
        assertThat(actual)
                .containsExactly(counter_1_1, counter_1_2, newCounter, counter_1a_1, counter_1b_1);
    }
    ...
    void testGetMetricsOfCategoryWithNullParameter() {
        assertThatThrownBy(() -> metrics.findMetricsByCategory(null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testRemoveByNameAndCategoryWithNullParameter() {
        assertThatThrownBy(() -> metrics.remove(null, NAME_1))
                .isInstanceOf(IllegalArgumentException.class);
    ...
    void testUpdaterWithNullParameter() {
        assertThatThrownBy(() -> metrics.addUpdater(null))
                .isInstanceOf(IllegalArgumentException.class);
    }

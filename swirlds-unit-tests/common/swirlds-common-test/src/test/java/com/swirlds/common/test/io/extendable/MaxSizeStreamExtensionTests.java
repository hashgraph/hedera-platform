...
class MaxSizeStreamExtensionTests {
	...
	void inputStreamTest() throws IOException {
		...
		extension.reset();
		assertThrows(IOException.class, () -> in.read(new byte[1025], 0, 1025),
				"too many bytes read");

		extension.reset();
		assertThrows(IOException.class, () -> in.readNBytes(1025),
				"too many bytes read");

		extension.reset();
		assertThrows(IOException.class, () -> in.readNBytes(new byte[1025], 0, 1025),
				"too many bytes read");
	...
	void outputStreamTest() throws IOException {
		...
		extension.reset();
		assertThrows(IOException.class, () -> out.write(new byte[1025], 0, 1025),
				"too many bytes written");

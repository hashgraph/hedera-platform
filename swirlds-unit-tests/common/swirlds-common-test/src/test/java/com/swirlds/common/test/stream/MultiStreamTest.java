...
class MultiStreamTest {
    ...
    void addTest() throws InterruptedException {
        ObjectForTestStream object =
                ObjectForTestStream.getRandomObjectForTestStream(PAY_LOAD_SIZE_4);
    ...
    void addNullNextStreamsTest() {
        ...
        assertTrue(
                exception.getMessage().contains(NOT_ENOUGH_NEXT_STREAMS),
                "nextStreams should not be null");
    }
    ...
    void addZeroNextStreamTest() {
        ...
        Exception exception =
                assertThrows(
                        ...
                        "should throw exception when setting nextStreams with zero element to"
                                + " multiStream");
        assertTrue(
                exception.getMessage().contains(NOT_ENOUGH_NEXT_STREAMS),
                "nextStreams should have at least 1 element");
    }
    ...
    void addNullNextStreamTest() {
        ...
        assertTrue(
                exception.getMessage().contains(NEXT_STREAM_NULL), "nextStream should not be null");
    }
}

...
public class TransactionSignatureTests {
	...
	public static void startup() throws NoSuchAlgorithmException, NoSuchProviderException {
		...
		signaturePool = new SignaturePool(engineSettings.computeCpuVerifierThreadCount() * PARALLELISM, 4096, true);
	}
	...
	public void signatureSizeUnderThreads()
			throws ExecutionException, InterruptedException, NoSuchProviderException, NoSuchAlgorithmException {
		final TransactionSignature[] signatures = new TransactionSignature[engineSettings.computeCpuVerifierThreadCount() - 1];
	...
	public void signatureSizeOverThreads()
			throws ExecutionException, InterruptedException, NoSuchProviderException, NoSuchAlgorithmException {
		final TransactionSignature[] signatures = new TransactionSignature[(engineSettings.computeCpuVerifierThreadCount() * 2) - 1];
	...
	public void signatureHalfQueueSize()
			throws ExecutionException, InterruptedException, NoSuchProviderException, NoSuchAlgorithmException {
		final TransactionSignature[] signatures = new TransactionSignature[engineSettings.getCpuVerifierQueueSize() / 2];
	...
	public void signatureExactQueueSize()
		...
		final TransactionSignature[] signatures = new TransactionSignature[engineSettings.getCpuVerifierQueueSize()];

...
class IntegerPairAccumulatorConfigTest {
    ...
    void testConstructorWithIllegalParameter() {
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
                                        null, NAME, Double.class, AVERAGE))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(
                        () -> new IntegerPairAccumulator.Config<>("", NAME, Double.class, AVERAGE))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
        ...
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
                                        CATEGORY, null, Double.class, AVERAGE))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
                                        CATEGORY, "", Double.class, AVERAGE))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
        ...
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
                                        CATEGORY, CATEGORY, null, AVERAGE))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(
                        () ->
                                new IntegerPairAccumulator.Config<>(
                                        CATEGORY, CATEGORY, Double.class, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testSetters() {
        ...
        // when
        final IntegerPairAccumulator.Config<Integer> result =
    ...
    void testSettersWithIllegalParameters() {
        ...
        assertThatThrownBy(() -> config.withLeftAccumulator(null))
                .isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() -> config.withRightAccumulator(null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testToString() {
        ...
        assertThat(config.toString())
                .contains(CATEGORY, NAME, DESCRIPTION, UNIT, FORMAT, "java.lang.Integer");
    }
}

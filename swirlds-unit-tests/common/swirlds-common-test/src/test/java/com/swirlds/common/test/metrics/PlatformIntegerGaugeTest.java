...
class PlatformIntegerGaugeTest {
    ...
    void testConstructor() {
        final IntegerGauge.Config config =
                new IntegerGauge.Config(CATEGORY, NAME)
                        .withDescription(DESCRIPTION)
                        .withUnit(UNIT)
                        .withFormat(FORMAT)
                        .withInitialValue(42);
        final IntegerGauge gauge = new PlatformIntegerGauge(config);
    ...
    void testGetAndSet() {
        // given
        final IntegerGauge.Config config =
                new IntegerGauge.Config(CATEGORY, NAME).withInitialValue(2);
        final IntegerGauge gauge = new PlatformIntegerGauge(config);
    ...
    void testSnapshot() {
        ...
        final IntegerGauge.Config config =
                new IntegerGauge.Config(CATEGORY, NAME).withInitialValue(2);
        final PlatformIntegerGauge gauge = new PlatformIntegerGauge(config);
        ...
        assertThat(snapshot).containsExactly(new SnapshotValue(VALUE, 2));
    }
    ...
    void testEquals() {
        // given
        final IntegerGauge.Config config = new IntegerGauge.Config(CATEGORY, NAME);
        final IntegerGauge gauge1 = new PlatformIntegerGauge(config);
        final IntegerGauge gauge2 = new PlatformIntegerGauge(config);
        gauge2.set(42);
        ...
        assertThat(gauge1)
                ...
                .isNotEqualTo(new PlatformIntegerGauge(new IntegerGauge.Config("Other", NAME)))
                .isNotEqualTo(new PlatformIntegerGauge(new IntegerGauge.Config(CATEGORY, "Other")))
                .isNotEqualTo(new PlatformCounter(new Counter.Config(CATEGORY, NAME)));
    }

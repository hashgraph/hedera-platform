...
class PlatformIntegerGaugeTest {
	...
	void testConstructor() {
		final IntegerGauge.Config config = new IntegerGauge.Config(CATEGORY, NAME)
				.withDescription(DESCRIPTION).withUnit(UNIT).withFormat(FORMAT).withInitialValue(42);
	...
	void testToString() {
		...
		// then
		assertThat(gauge.toString()).contains(CATEGORY, NAME, DESCRIPTION, UNIT, FORMAT, "42");
	}
}

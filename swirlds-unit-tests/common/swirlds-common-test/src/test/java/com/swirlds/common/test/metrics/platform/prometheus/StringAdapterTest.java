...
class StringAdapterTest {
        ...
        final Metric metric =
                new DefaultFunctionGauge<>(
                        new FunctionGauge.Config<>(
                                        CATEGORY, NAME, String.class, () -> "Hello World")
    ...
    void testCreateBrokenNamesMetric() {
        ...
        final Metric metric =
                new DefaultFunctionGauge<>(
                        new FunctionGauge.Config<>(
                                brokenName, brokenName, String.class, () -> "Hello World"));
    ...
    void testConstructorWithNullParameters() {
        ...
        // then
        assertThatThrownBy(() -> new StringAdapter(null, metric, GLOBAL))
    ...
    void testUpdateGlobalMetric() {
        ...
        assertThat(
                        registry.getSampleValue(
                                MAPPING_NAME + "_info", GLOBAL_LABEL, new String[] {"Hello World"}))

 ...
 *
 * @param <M> the type of the merkle node state
 * @param <B> the type of the benchmark state
 */
public class BenchmarkConfiguration<M extends MerkleNode, B extends BenchmarkMetadata> {
    ...
    public Benchmark<M, B> build() {
        ...
        // These are modified by the benchmark, we must set them again if the configuration object
        // is reused
        initialState = null;

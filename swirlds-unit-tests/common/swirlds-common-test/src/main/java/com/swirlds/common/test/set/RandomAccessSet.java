...
public interface RandomAccessSet<T> extends Set<T> {
    ...
    /**
     * Get a random element. Element is chosen with even probability of selecting any element in the
     * set. O(1) time.
     *
    ...
    /**
     * Get an element at a given index. Element returned is guaranteed to be deterministic. Mutating
     * the set in any way may cause a different element to be returned for the same index. O(1)
     * time.
     *

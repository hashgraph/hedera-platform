...
public class BenchmarkStatistic {
	...
	public String toString() {
		...
		sb.append("    total number of operations: ").append(totalOperationCount).append("\n");
		sb.append("    latency: ").append(humanReadableDuration(getAverageLatency())).append("\n");
		sb.append("    throughput: ").append(String.format("%.1f", getAverageThroughput())).append(" hz\n");

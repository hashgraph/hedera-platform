...
public class RandomUtils {
    ...
    public static Signature randomSignature(final Random random) {
        return new Signature(
                SignatureType.RSA, randomByteArray(random, SignatureType.RSA.signatureLength()));
    }
    ...
    public static boolean randomBooleanWithProbability(
            final Random random, final double trueProbability) {

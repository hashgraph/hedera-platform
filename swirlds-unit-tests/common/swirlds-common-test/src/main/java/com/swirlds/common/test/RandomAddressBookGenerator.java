...
public class RandomAddressBookGenerator {
	...
	public static Address addressWithRandomData(
		...
		return new Address(id, nickname, selfName, stake, ownHost, addressInternalIpv4, portInternalIpv4,
				addressExternalIpv4, portExternalIpv4, addressInternalIpv6, portInternalIpv6, addressExternalIpv6,
				portExternalIpv6, sigPublicKey, encPublicKey, agreePublicKey, memo);
	}

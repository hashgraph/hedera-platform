...
public class DummySwirldState2 extends AbstractDummySwirldState implements SwirldState2 {
    ...
    /**
     * In this version, serialization was performed by copyTo/copyToExtra and deserialization was
     * performed by copyFrom/copyFromExtra. This version is not supported by later deserialization
     * methods and must be handled specially by the platform.
     */
    ...
    /**
     * If called, the next serialization attempt will block until {@link #unblockSerialization()}
     * has been called.
     */

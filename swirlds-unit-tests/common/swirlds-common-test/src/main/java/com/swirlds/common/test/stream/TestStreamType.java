...
/**
 * Contains properties related to EventStream file type; Its constructor is private. Users need to
...
public final class TestStreamType implements StreamType {
     ...
     * Version. the int in fileHeader denotes version 5
     */
    private static final int[] TEST_FILE_HEADER = new int[] {5};
    /**
     * Header which is written in the beginning of a stream signature file, before writing the
     * Object Stream Signature Version. the byte in sigFileHeader denotes version 5
     */

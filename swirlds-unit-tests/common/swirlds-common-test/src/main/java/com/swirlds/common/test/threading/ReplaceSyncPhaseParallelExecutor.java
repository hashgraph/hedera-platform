...
/**
 * Executes two tasks simultaneously and replacing a specified task at a specified phase. Only one
 * instance of this class should be used at a time, i.e. either the caller or listener in a sync but
 * not both.
 */
public class ReplaceSyncPhaseParallelExecutor implements ParallelExecutor {
    ...
    /**
     * Executes two tasks in parallel, skipping one of the tasks if it is the phase defined in
     * {@link ReplaceSyncPhaseParallelExecutor#phaseToReplace}.
     *

...
/**
 * This stream contains a CountDownLatch(1) object. Once this stream receives expected number of
 * objects from its upper stream, the CountDownLatch.countDown will be called.
 *
 * @param <T> RunningHashable
 */

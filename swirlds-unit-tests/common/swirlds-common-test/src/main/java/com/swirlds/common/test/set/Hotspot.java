...
public class Hotspot {
     ...
     *
     * @param weight the weight of this hotspot. A weight of 2 will cause this hotspot to be chosen
     *     twice as often as a hotspot with a weight of 1.
     * @param size the number of elements in this hotspot
     */

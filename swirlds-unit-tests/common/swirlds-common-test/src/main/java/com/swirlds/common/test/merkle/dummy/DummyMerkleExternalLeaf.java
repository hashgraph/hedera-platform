 ...
 */
public class DummyMerkleExternalLeaf extends PartialMerkleLeaf
    ...
    /**
     * @param seed The seed used to generate the value of this leaf.
     */
    ...
    public void deserialize(
        ...
        try (final SerializableDataInputStream fileIn =
            ...
            assertEquals(
                    generateValue(),
                    fileIn.readNormalisedString(Integer.MAX_VALUE),

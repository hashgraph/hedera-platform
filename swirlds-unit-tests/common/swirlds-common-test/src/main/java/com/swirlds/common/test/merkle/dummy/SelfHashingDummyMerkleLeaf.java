...
public class SelfHashingDummyMerkleLeaf extends PartialMerkleLeaf
        implements DummyMerkleNode, MerkleLeaf {
    ...
    /**
     * If true then this node will intentionally return an illegal null hash. Used for debugging
     * error pathways.
     */
    ...
    public Hash getHash() {
        if (returnNullForHash) {
            // A hash of null is not illegal, but "null" is not allowed for self hashing nodes like
            // this one.
            return null;
        }

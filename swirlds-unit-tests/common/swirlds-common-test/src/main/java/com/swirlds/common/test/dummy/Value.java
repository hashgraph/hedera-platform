...
public class Value extends PartialMerkleLeaf implements Keyed<Key>, MerkleLeaf {
    ...
    public int hashCode() {
        return Objects.hash(
                balance, sendThresholdValue, receiveThresholdValue, receiverSignatureRequired);
    }
    ...
    @Override
    public void deserialize(final SerializableDataInputStream inStream, final int version)
            throws IOException {

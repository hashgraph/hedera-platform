...
public class Value
		...
		implements Keyed<Key>, MerkleLeaf {
	...
	public Value(final long balance, final long sendThresholdValue, final long receiveThresholdValue,
	...
	public String toString() {
		return "Value{" +
				"balance=" + balance +
				", sendThresholdValue=" + sendThresholdValue +
				", receiveThresholdValue=" + receiveThresholdValue +

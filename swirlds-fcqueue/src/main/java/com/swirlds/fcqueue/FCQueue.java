 ...
 * fast copyable. A fast copy of a queue is mutable and the original queue becomes immutable. A
...
public class FCQueue<E extends FastCopyable & SerializableHashable> extends PartialMerkleLeaf
    ...
    private static class ClassVersion {
        /**
         * In this version, serialization was performed by copyTo/copyToExtra and deserialization
         * was performed by copyFrom/copyFromExtra. This version is not supported by later
         * deserialization methods and must be handled specially by the platform.
         */
     ...
     * throw an exception if these two do not match.
     */
    ...
    /**
     * Returns an iterator over the elements in this queue, in insertion order (head first, tail
     * last).
     *
    ...
    /**
     * Returns an iterator over the elements in this queue in reverse insertion order (tail first,
     * head last).
     *
     ...
     * of the collection is set to {@code null}. (This is useful in determining the length of this
     * collection <i>only</i> if the caller knows that this collection does not contain any {@code
     * null} elements.)
     *
    ...
    /**
     * This operation is not supported, and will throw an exception. The FCQueue is fast to copy
     * because it ensures that no element will ever be removed from the middle of the queue.
     *
     * @throws UnsupportedOperationException always thrown because the {@code remove} operation is
     *     not supported by this collection
     */
    @Override
    public boolean remove(final Object o) {
        throw new UnsupportedOperationException(
                "FCQueue allows removal only from the head, not arbitrary removals");
    }
     ...
     *     are incompatible with this collection (<a
     *     href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     ...
     *     href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>), or if
     ...
     * @throws UnsupportedOperationException always thrown because the {@code removeAll} operation
     ...
     * @throws UnsupportedOperationException always thrown because the {@code retainAll} operation
     *     is not supported by this collection
     */
    @Override
    ...
    /**
     * Removes all of the elements from this queue. The queue will be empty and the hash reset to
     * the null value after this method returns. This does not delete the FCQueue object. It just
     * empties the queue.
     */
    @Override
     ...
     *
     * @param dos the {@link java.io.DataOutputStream} to which the object's binary form should be
     *     written

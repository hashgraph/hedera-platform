 ...
 */
public class FCQueueNodeIterator<E extends FCQueueElement> implements Iterator<FCQueueNode<E>> {
	 ...
	 */
	public FCQueueNodeIterator(final FCQueue<E> queue, final FCQueueNode<E> head, final FCQueueNode<E> tail) {
		this.queue = queue;

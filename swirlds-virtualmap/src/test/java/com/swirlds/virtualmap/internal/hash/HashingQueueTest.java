...
abstract class HashingQueueTest extends VirtualTestBase {
    ...
    void addingItems() {
        ...
        final List<HashJob<TestKey, TestValue>> streamContents =
    ...
    void copyOfQueueFullSourceEmptyDest() {
        ...
        for (int i = 0; i < 10; i++) {
            source.appendHashJob()
                    .dirtyLeaf(
                            i, new VirtualLeafRecord<>(i, null, new TestKey(i), new TestValue(i)));
        }
    ...
    void copyOfQueueFullSourceFullDest() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            dest.appendHashJob()
                    .dirtyLeaf(
                            j, new VirtualLeafRecord<>(j, null, new TestKey(j), new TestValue(j)));
        }

...
public class VirtualHasherTestBase extends VirtualTestBase {
    /**
     * Helper method for computing a list of {@link Arguments} of length {@code num}, each of which
     * contains a random list of dirty leave paths between {@code firstLeafPath} and {@code
     * lastLeafPath}.
     *
     * @param num The number of different random lists to create
     * @param firstLeafPath The firstLeafPath
     * @param lastLeafPath The lastLeafPath
     * @return A non-null list of {@link Arguments} of random lists of paths.
     */
    ...
    protected static void hashSubTree(
            ...
            final VirtualInternalRecord internalNode) {

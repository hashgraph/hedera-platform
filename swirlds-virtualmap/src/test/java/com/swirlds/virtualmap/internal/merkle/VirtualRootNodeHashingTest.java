...
class VirtualRootNodeHashingTest {
    ...
    void hashMapWithManyEntries() {
        ...
        root1.postInit(new DummyStateAccessor());
        ...
        root2.postInit(new DummyStateAccessor());
    ...
    void embeddedAtRootAsync() throws ExecutionException, InterruptedException {
        ...
        final VirtualRootNode<TestKey, TestValue> copyB = rootB.copy();
        final Hash hashB = MerkleCryptoFactory.getInstance().digestTreeAsync(rootA).get();
    ...
    private static class InternalWithBasicHash extends PartialBinaryMerkleInternal

...
public class VirtualTestBase {
    protected static final Cryptography CRYPTO = CryptoFactory.getInstance();
    ...
    protected static final TestValue CUTTLEFISH =
            (TestValue) new TestValue("Cuttlefish").asReadOnly();
    ...
    protected static final TestValue ASTRONAUT =
            (TestValue) new TestValue("Astronaut").asReadOnly();
    ...
    protected static final TestValue EXOPLANET =
            (TestValue) new TestValue("Exoplanet").asReadOnly();
    ...
    protected static final TestValue ASTRONOMY =
            (TestValue) new TestValue("Astronomy").asReadOnly();
    protected static final TestValue BIOLOGY = (TestValue) new TestValue("Biology").asReadOnly();
    protected static final TestValue CHEMISTRY =
            (TestValue) new TestValue("Chemistry").asReadOnly();
    protected static final TestValue DISCIPLINE =
            (TestValue) new TestValue("Discipline").asReadOnly();
    ...
    protected static final TestValue AUSTRALIA =
            (TestValue) new TestValue("Australia").asReadOnly();
    ...
    static void globalSetup() throws Exception {
        ...
        ConstructableRegistry.registerConstructable(
                new ClassConstructorPair(TestKey.class, () -> new TestKey(0L)));
        ConstructableRegistry.registerConstructable(
                new ClassConstructorPair(TestValue.class, () -> new TestValue("")));
        ConstructableRegistry.registerConstructable(
                new ClassConstructorPair(TestInternal.class, TestInternal::new));
        ConstructableRegistry.registerConstructable(
                new ClassConstructorPair(TestLeaf.class, TestLeaf::new));
    ...
    // NOTE: If nextRound automatically causes hashing, some tests in VirtualNodeCacheTest will fail
    // or be invalid.
    ...
    protected VirtualInternalRecord rootInternal() {
        rootInternal =
                rootInternal == null ? new VirtualInternalRecord(ROOT_PATH) : copy(rootInternal);
        return rootInternal;
    }

    protected VirtualInternalRecord leftInternal() {
        leftInternal =
                leftInternal == null ? new VirtualInternalRecord(LEFT_PATH) : copy(leftInternal);
        return leftInternal;
    }

    protected VirtualInternalRecord rightInternal() {
        rightInternal =
                rightInternal == null ? new VirtualInternalRecord(RIGHT_PATH) : copy(rightInternal);
        return rightInternal;
    }

    protected VirtualInternalRecord leftLeftInternal() {
        leftLeftInternal =
                leftLeftInternal == null
                        ? new VirtualInternalRecord(LEFT_LEFT_PATH)
    ...
    protected VirtualInternalRecord leftRightInternal() {
        leftRightInternal =
                leftRightInternal == null
                        ? new VirtualInternalRecord(LEFT_RIGHT_PATH)
    ...
    protected VirtualInternalRecord rightLeftInternal() {
        rightLeftInternal =
                rightLeftInternal == null
                        ? new VirtualInternalRecord(RIGHT_LEFT_PATH)
    ...
    protected VirtualLeafRecord<TestKey, TestValue> hash(
    ...
    public static final class TestInternal extends PartialBinaryMerkleInternal

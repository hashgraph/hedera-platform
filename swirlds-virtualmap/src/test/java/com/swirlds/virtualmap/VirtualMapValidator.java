...
/**
 * Proxy for a {@link VirtualMap} that maintains a separate map to track changes and validate data
 * consistency.
 *
...
public class VirtualMapValidator<K extends VirtualKey<? super K>, V extends VirtualValue> {
     ...
     *
     * <p>This call will also trigger a snapshot of the reference and virtualmap values to be
     * stored.
     *
    ...
    private void verifyMatch(
            final int round, final VirtualMap<K, V> snapshot, final Map<K, V> reference) {

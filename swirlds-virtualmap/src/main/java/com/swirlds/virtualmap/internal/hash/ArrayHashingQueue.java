...
/**
 * A {@link HashingQueue} implementation based on an array. This implementation is the main data
 * structure used for holding {@link HashJob}s in the {@link VirtualHasher} implementation. An
 * important performance tradeoff that was explicitly made in this class is to favor low-garbage
 * generate over memory usage.
 *
 * @param <K> The key.
 * @param <V> The value.
 */
final class ArrayHashingQueue<K extends VirtualKey<? super K>, V extends VirtualValue>
    ...
    // Loses all data but sizes correctly. Could use multiple queue's like Jasper does elsewhere so
    // these

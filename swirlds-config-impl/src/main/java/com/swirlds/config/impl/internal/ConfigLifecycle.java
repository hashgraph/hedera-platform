...
/**
 * Basic lifecycle definition for the config. This will be replaced with a general interface once we
 * have a platform context API
 */
public interface ConfigLifecycle {

    /**
     * Inits the component. Calling this on a component that is already initialized might result in
     * an exception.
     */
    void init();

    /**
     * Disposes the component. This can be called on any state and must be able to be called on an

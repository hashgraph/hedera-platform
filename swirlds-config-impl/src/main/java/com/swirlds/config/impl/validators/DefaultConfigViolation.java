 ...
 * @param exists definies of the property that causes the violation exists
 * @param message message of the violation
 */
public record DefaultConfigViolation(
        String propertyName, String value, boolean exists, String message)
    ...
    public static ConfigViolation of(final PropertyMetadata<?> metadata, String message) {
        ...
        return new DefaultConfigViolation(
                metadata.getName(), metadata.getRawValue(), metadata.exists(), message);
    }

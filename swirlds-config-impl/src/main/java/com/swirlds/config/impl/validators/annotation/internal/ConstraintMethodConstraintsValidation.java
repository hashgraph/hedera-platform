...
/**
 * A {@link ConfigValidator} implementation taht checks all config data objects for the constraints
 * annotation {@link ConstraintMethod}
 */
        ...
        try {
            ...
            final Method method =
                    annotatedProperty
                            .component()
                            .getDeclaringRecord()
                            .getMethod(methodName, Configuration.class);
            ...
            throw new IllegalStateException(
                    "Validation failed since method '"
                            + methodName
                            + " in record '"
                            + recordType
                            + "' does not "
                            + "follow"
                            + " "
                            + "the definition pattern 'public "
                            + ConfigViolation.class.getName()
                            + " method("

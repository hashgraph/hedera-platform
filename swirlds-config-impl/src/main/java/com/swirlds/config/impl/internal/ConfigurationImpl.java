...
class ConfigurationImpl implements Configuration, ConfigLifecycle {
    ...
    @Override
    public <T> T getValue(
            final String propertyName, final Class<T> propertyType, final T defaultValue) {
        CommonUtils.throwArgBlank(propertyName, "propertyName");
        CommonUtils.throwArgNull(propertyType, "propertyType");
    ...
    public <T> List<T> getValues(
            final String propertyName, final Class<T> propertyType, final List<T> defaultValue) {
        CommonUtils.throwArgBlank(propertyName, "propertyName");
        CommonUtils.throwArgNull(propertyType, "propertyType");
        if (!exists(propertyName)) {
            return defaultValue;
    ...
    public String getValue(final String propertyName) {
        ...
        if (!exists(propertyName)) {
            throw new NoSuchElementException(
                    "Property '" + propertyName + "' not defined in configuration");
        }

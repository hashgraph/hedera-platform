 ...
 * {@link com.swirlds.config.api.ConfigProperty}). The validation of the annotation is automatically
 * executed at the initialization of the configuration (see {@link ConfigurationProvider#init()}).
 * The annotated property should not be used for floating point values.
 */
@Documented
